import{initializeApp as Xt}from"https://www.gstatic.com/firebasejs/10.14.1/firebase-app.js";import{getFirestore as te,onSnapshot as nt,query as ee,collection as Y,orderBy as ae,doc as T,deleteDoc as H,setDoc as V,addDoc as gt,serverTimestamp as yt}from"https://www.gstatic.com/firebasejs/10.14.1/firebase-firestore.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const r of s.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&a(r)}).observe(document,{childList:!0,subtree:!0});function o(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function a(n){if(n.ep)return;n.ep=!0;const s=o(n);fetch(n.href,s)}})();const Tt=document.createElement("script");Tt.src="https://cdn.jsdelivr.net/npm/chart.js@4.4.7/dist/chart.umd.min.js";document.head.appendChild(Tt);const Ct=document.createElement("script");Ct.src="https://unpkg.com/html5-qrcode@2.3.8/html5-qrcode.min.js";document.head.appendChild(Ct);const oe={apiKey:"AIzaSyANpFnEIkyN1XCT6qbtmVR9wx7sQHEsyrE",authDomain:"comprasmercado-23913.firebaseapp.com",projectId:"comprasmercado-23913",storageBucket:"comprasmercado-23913.firebasestorage.app",messagingSenderId:"317518149234",appId:"1:317518149234:web:94f38624d68a2b9a6634eb",measurementId:"G-2XP88EK37S"},ne=Xt(oe),I=te(ne),ft="compras",st="entradas",ot="faturas",K="boletos",Mt="reservas",X="estimativas";let O=[],j=[],k=[],z=[],Z=[],N={valorAtualGuardado:0},ht=null,J=null,Q=[],dt=0,ct=!1,et=[];function i(t){return Number(t||0).toLocaleString("pt-BR",{style:"currency",currency:"BRL"})}function S(t){if(typeof t=="number")return t;if(!t)return 0;const e=parseFloat(String(t).replace(/R\$\s?/gi,"").replace(/\s/g,"").replace(/\./g,"").replace(",","."));return isNaN(e)?0:e}function mt(t){if(!t)return"—";try{return new Date(t).toLocaleString("pt-BR",{dateStyle:"short",timeStyle:"short"})}catch{return t}}function $(t,e=3500){const o=document.getElementById("toast");o.textContent=t,o.classList.add("show"),setTimeout(()=>o.classList.remove("show"),e)}function U(t,e="var(--accent-amber)"){const o=document.getElementById("status-msg");o&&(o.textContent=t,o.style.color=e)}function se(t){if(!t)return new Date().toISOString().slice(0,16);try{const e=new Date(t);if(isNaN(e.getTime()))return new Date().toISOString().slice(0,16);const o=a=>String(a).padStart(2,"0");return`${e.getFullYear()}-${o(e.getMonth()+1)}-${o(e.getDate())}T${o(e.getHours())}:${o(e.getMinutes())}`}catch{return new Date().toISOString().slice(0,16)}}function re(t,e){let o=0;const a=new Date(t,e+1,0).getDate();for(let n=1;n<=a;n++){const s=new Date(t,e,n).getDay();s!==0&&s!==6&&o++}return o}window.goTab=function(t){document.querySelectorAll(".tab-content").forEach(o=>o.classList.remove("active")),document.querySelectorAll(".desktop-nav .nav-item").forEach(o=>o.classList.remove("active")),document.querySelectorAll(".mobile-nav .mob-btn").forEach(o=>o.classList.remove("active"));const e=document.getElementById("tab-"+t);e&&e.classList.add("active"),document.querySelectorAll(`[data-tab="${t}"]`).forEach(o=>o.classList.add("active"))};document.querySelectorAll("[data-tab]").forEach(t=>{t.addEventListener("click",()=>goTab(t.getAttribute("data-tab")))});document.querySelectorAll(".sub-item").forEach(t=>{t.addEventListener("click",()=>{document.querySelectorAll(".sub-item").forEach(o=>o.classList.remove("active")),document.querySelectorAll(".sub-tab-content").forEach(o=>o.style.display="none"),t.classList.add("active");const e=document.getElementById("sub-"+t.getAttribute("data-sub"));e&&(e.style.display="block")})});function St(){document.getElementById("modal-add-nota").classList.add("active")}function Dt(){ct&&$t(),document.getElementById("modal-add-nota").classList.remove("active")}var It;(It=document.getElementById("btn-open-modal-home"))==null||It.addEventListener("click",St);var wt;(wt=document.getElementById("btn-mercado-add-nota"))==null||wt.addEventListener("click",St);var At;(At=document.getElementById("btn-close-modal-add"))==null||At.addEventListener("click",Dt);nt(ee(Y(I,ft),ae("dataEmissao","desc")),t=>{O=t.docs.map(e=>({id:e.id,...e.data()})),W()},t=>console.error("Firestore Mercado:",t));nt(Y(I,st),t=>{j=t.docs.map(e=>({id:e.id,...e.data()})),W()},t=>console.error("Firestore Entradas:",t));nt(Y(I,ot),t=>{k=t.docs.map(e=>({id:e.id,...e.data()})),W()},t=>console.error("Firestore Faturas:",t));nt(Y(I,K),t=>{z=t.docs.map(e=>({id:e.id,...e.data()})),W()},t=>console.error("Firestore Boletos:",t));nt(T(I,Mt,"config"),t=>{t.exists()&&(N=t.data()),W()},t=>console.error("Firestore Reservas:",t));nt(Y(I,X),t=>{Z=t.docs.map(e=>({id:e.id,...e.data()})),W()},t=>console.error("Firestore Estimativas:",t));let b=new Date().toISOString().slice(0,7);const Lt=new Set;function rt(){const t=new Set,e=new Date().toISOString().slice(0,7);t.add(e);const o=new Date,a=new Date(o.getFullYear(),o.getMonth()+1,1),n=r=>String(r).padStart(2,"0"),s=`${a.getFullYear()}-${n(a.getMonth()+1)}`;return t.add(s),b&&t.add(b),j.forEach(r=>{r.mesAno&&t.add(r.mesAno)}),k.forEach(r=>{r.mesAno&&t.add(r.mesAno)}),z.forEach(r=>{r.mesAno&&t.add(r.mesAno)}),O.forEach(r=>{r.mesAno&&t.add(r.mesAno)}),Z.forEach(r=>{r.mesAno&&t.add(r.mesAno)}),Array.from(t).filter(r=>!Lt.has(r)).sort().reverse()}window.excluirMesSelecionadoAtual=function(){window.excluirDadosDoMes(b)};window.selecionarMesGlobal=function(t){if(!t)return;b=t;const e=document.getElementById("inp-seletor-mes-global");e&&(e.value=t);const o=document.getElementById("inp-entradas-mes-ano");o&&(o.value=t);const a=document.getElementById("inp-fatura-vencimento");a&&(a.value=`${t}-10`,typeof atualizarMesRefFatura=="function"&&atualizarMesRefFatura());const n=document.getElementById("inp-boleto-vencimento");n&&(n.value=`${t}-10`,typeof atualizarMesRefBoleto=="function"&&atualizarMesRefBoleto()),W()};window.verMesEIrParaControle=function(t){selecionarMesGlobal(t),typeof goTab=="function"&&goTab("mensal")};function ie(){const t=document.getElementById("seletor-meses-bar"),e=document.getElementById("seletor-meses-bar-salarios"),o=document.getElementById("seletor-meses-bar-estimativa"),a=rt();a.includes(b)||(b=a[0]||new Date().toISOString().slice(0,7));const n=document.getElementById("inp-seletor-mes-global");n&&n.value!==b&&(n.value=b);const s=document.getElementById("inp-entradas-mes-ano");s&&s.value!==b&&(s.value=b);const r=a.map(l=>{const[m,d]=l.split("-"),c=new Date(parseInt(m),parseInt(d)-1,1).toLocaleString("pt-BR",{month:"short"}).toUpperCase().replace(".",""),E=l===b;return`
      <button class="sub-item ${E?"active":""}" onclick="selecionarMesGlobal('${l}')" style="${E?"background:var(--secondary);color:#fff;border-color:var(--secondary);box-shadow:0 0 10px rgba(99,102,241,0.4);font-weight:700":"background:rgba(15,23,42,.6);color:var(--text-muted);border:1px solid var(--border-color)"}; display:inline-flex;align-items:center;gap:.35rem">
        📅 ${c}/${m}
      </button>
    `}).join("");t&&(t.innerHTML=r),e&&(e.innerHTML=r),o&&(o.innerHTML=r)}window.switchMensalSub=function(t){document.querySelectorAll("[data-mensal-sub]").forEach(a=>a.classList.remove("active")),document.querySelectorAll(".mensal-sub-content").forEach(a=>a.style.display="none");const e=document.querySelector(`[data-mensal-sub="${t}"]`);e&&e.classList.add("active");const o=document.getElementById(t);o&&(o.style.display="block")};function W(){ie(),ce(),le(),Rt(),he(),$e(),we(),Ae(),Se(),De(),Le(),xe()}function le(){const t=b,e=j.filter(h=>h.mesAno===t),o=k.filter(h=>h.mesAno===t),a=z.filter(h=>h.mesAno===t),n=O.filter(h=>h.mesAno===t),s=e.reduce((h,x)=>h+(x.valor||0),0),r=o.reduce((h,x)=>h+(x.valorTotal!==void 0?x.valorTotal:x.valor||0),0),l=a.reduce((h,x)=>h+(x.valorTotal!==void 0?x.valorTotal:x.valor||0),0);let m=0;n.forEach(h=>{h.formasPagamento&&(m+=h.formasPagamento.cartaoDebito||0)});const d=s-r-l-m,u=document.getElementById("m-total-entradas");u&&(u.textContent=i(s));const c=document.getElementById("m-total-cartoes");c&&(c.textContent=i(r));const E=document.getElementById("m-total-boletos");E&&(E.textContent=i(l));const p=document.getElementById("m-mercado-debito");p&&(p.textContent=i(m));const v=document.getElementById("m-saldo-liquido");v&&(v.textContent=i(d),v.style.color=d>=0?"#60a5fa":"#fb7185");const[f,L]=t.split("-"),q=new Date(parseInt(f),parseInt(L)-1,1).toLocaleString("pt-BR",{month:"long"}),w=q.charAt(0).toUpperCase()+q.slice(1),B=document.getElementById("m-lbl-saldo-liquido");B&&(B.textContent=`Saldo Líquido (${w}/${f})`),de(e,o,a,n)}function de(t,e,o,a){const n=document.getElementById("content-salarios-mes");n&&(n.innerHTML=`
    ...
    `);const s=document.getElementById("content-cartoes-mes");if(s){const m=e.reduce((u,c)=>u+(c.valorTotal||0),0),d=e.length?Ut(e,"mes_"+b):"";s.innerHTML=`
      ${d}
      <div class="card" style="margin-bottom:1.5rem">
        <div class="card-header">
    ...
    `}const r=document.getElementById("content-boletos-mes");if(r){const m=o.reduce((d,u)=>d+(u.valorTotal||0),0);r.innerHTML=`
      <div class="card" style="margin-bottom:1.5rem">
        <div class="card-header">
    ...
    `}const l=document.getElementById("content-mercado-mes");if(l){let m=0,d=0,u=0;a.forEach(c=>{c.formasPagamento?(m+=c.formasPagamento.valeAlimentacao||0,d+=c.formasPagamento.cartaoCredito||0,u+=c.formasPagamento.cartaoDebito||0):u+=c.valorAPagar||0}),l.innerHTML=`
      <div class="card" style="margin-bottom:1.5rem">
    ...
    `}}function ce(){const t=rt();let e=0,o=0,a=0,n=0,s=0;t.forEach(p=>{const v=j.filter(w=>w.mesAno===p).reduce((w,B)=>w+(B.valor||0),0),f=k.filter(w=>w.mesAno===p).reduce((w,B)=>w+(B.valorTotal!==void 0?B.valorTotal:B.valor||0),0),L=z.filter(w=>w.mesAno===p).reduce((w,B)=>w+(B.valorTotal!==void 0?B.valorTotal:B.valor||0),0);let F=0;O.filter(w=>w.mesAno===p).forEach(w=>{w.formasPagamento&&(F+=w.formasPagamento.cartaoDebito||0)});const q=v-f-L-F;e+=v,o+=f,a+=L,n+=F,s+=q});let r=0,l=0;const m={};O.forEach(p=>{const v=p.valorAPagar||0;p.formasPagamento&&(r+=p.formasPagamento.valeAlimentacao||0,l+=p.formasPagamento.cartaoCredito||0);const f=p.mesAno||"Outros";m[f]=(m[f]||0)+v});const d=N&&N.valorAtualGuardado!==void 0?N.valorAtualGuardado:3e3,u=s+d;document.getElementById("fin-total-entradas").textContent=i(e);const c=document.getElementById("fin-subtext-entradas");c&&(c.textContent="Soma Total das Entradas da Tabela Mensal"),document.getElementById("fin-total-cartoes").textContent=i(o),document.getElementById("fin-total-boletos").textContent=i(a),document.getElementById("fin-mercado-debito").textContent=i(n),document.getElementById("fin-saldo-liquido").textContent=i(s),document.getElementById("fin-saldo-liquido").style.color=s>=0?"#60a5fa":"#fb7185";const E=document.getElementById("fin-subtext-saldo");E&&(E.innerHTML=`Saldo Líquido + Reserva Guardada (${i(d)}): <strong style="color:#34d399">${i(u)}</strong>`),document.getElementById("dash-alimentacao").textContent=i(r),document.getElementById("dash-credito").textContent=i(l),document.getElementById("dash-debito").textContent=i(n),me(),Ft(m)}function me(){const t=document.getElementById("tabela-resumo-mensal");if(!t)return;const e=rt();if(!e.length){t.innerHTML='<div class="empty-state">Nenhum dado cadastrado ainda.</div>';return}const o=e.map(a=>{const n=j.filter(v=>v.mesAno===a).reduce((v,f)=>v+(f.valor||0),0),s=k.filter(v=>v.mesAno===a).reduce((v,f)=>v+(f.valorTotal!==void 0?f.valorTotal:f.valor||0),0),r=z.filter(v=>v.mesAno===a).reduce((v,f)=>v+(f.valorTotal!==void 0?f.valorTotal:f.valor||0),0);let l=0;O.filter(v=>v.mesAno===a).forEach(v=>{v.formasPagamento&&(l+=v.formasPagamento.cartaoDebito||0)});const m=n-s-r-l,[d,u]=a.split("-"),E=new Date(parseInt(d),parseInt(u)-1,1).toLocaleString("pt-BR",{month:"short"}).toUpperCase().replace(".","");return`
  ...
  `}window.excluirDadosDoMes=async function(t){const e=t||b;if(!e)return;const[o,a]=e.split("-"),s=new Date(parseInt(o),parseInt(a)-1,1).toLocaleString("pt-BR",{month:"long"}),r=`${s.charAt(0).toUpperCase()+s.slice(1)} de ${o}`,l=j.filter(p=>p.mesAno===e),m=k.filter(p=>p.mesAno===e),d=z.filter(p=>p.mesAno===e),u=O.filter(p=>p.mesAno===e),c=Z.filter(p=>p.id===e),E=`⚠️ TEM CERTEZA QUE DESEJA EXCLUIR O MÊS ${r.toUpperCase()} (${e})?
...
Esta ação é irreversível. Confirmar exclusão do mês?`;if(confirm(E))try{const p=[];l.forEach(f=>p.push(H(T(I,st,f.id)))),m.forEach(f=>p.push(H(T(I,ot,f.id)))),d.forEach(f=>p.push(H(T(I,K,f.id)))),u.forEach(f=>p.push(H(T(I,ft,f.id)))),c.forEach(f=>p.push(H(T(I,X,f.id)))),p.length>0&&await Promise.all(p),Lt.add(e),$(`🗑️ O mês ${r} e todos os seus dados foram excluídos com sucesso!`),b=rt()[0]||new Date().toISOString().slice(0,7),W()}catch(p){alert("Erro ao excluir dados do mês: "+p.message)}};function Ft(t){var s;if(typeof Chart>"u")return setTimeout(()=>Ft(t),300);const e=(s=document.getElementById("chart-barras"))==null?void 0:s.getContext("2d");if(!e)return;const o=Object.keys(t).sort(),a=o.map(r=>{const[l,m]=r.split("-");return`${m}/${l}`}),n=o.map(r=>t[r]);ht&&ht.destroy(),ht=new Chart(e,{type:"bar",data:{labels:a.length?a:["Sem compras"],datasets:[{label:"Gasto Mercado R$",data:n.length?n:[0],backgroundColor:"rgba(16,185,129,0.78)",borderColor:"#10b981",borderWidth:2,borderRadius:8}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1},tooltip:{callbacks:{label:r=>` ${i(r.raw)}`}}},scales:{y:{beginAtZero:!0,grid:{color:"rgba(255,255,255,.05)"},ticks:{color:"#94a3b8",callback:r=>"R$"+r}},x:{grid:{display:!1},ticks:{color:"#94a3b8"}}}}})}function qt(t){if(!t)return 0;const e=t.match(/L[íi]quido(?:\s*a\s*receber)?\s*[:\s]*R?\$\s*([\d\.,]+)/i)||t.match(/TOTAL\s*L[IÍ]QUIDO\s*[:\s]*R?\$\s*([\d\.,]+)/i)||t.match(/SAL[ÁA]RIO\s*L[IÍ]QUIDO\s*[:\s]*R?\$\s*([\d\.,]+)/i)||t.match(/VALOR\s*L[IÍ]QUIDO\s*[:\s]*R?\$\s*([\d\.,]+)/i);return e?S(e[1]):0}function ue(){const t=document.getElementById("inp-entradas-mes-ano");if(t&&!t.value){const e=new Date,o=e.getFullYear(),a=String(e.getMonth()+1).padStart(2,"0");t.value=`${o}-${a}`}}setTimeout(ue,300);let tt="mes";window.toggleFiltroEntradasTabela=function(t){tt=t,Rt()};document.getElementById("form-holerite-victor").addEventListener("submit",async t=>{t.preventDefault();const e=b||document.getElementById("inp-entradas-mes-ano").value||new Date().toISOString().slice(0,7),o=document.getElementById("inp-holerite-txt-victor").value;let a=parseFloat(document.getElementById("inp-salario-val-victor").value)||0;if(!a&&o&&(a=qt(o)),!a){$("⚠️ Digite ou cole um holerite válido com valor.");return}const n=`salario_victor_${e}`;await V(T(I,st,n),{pessoa:"Victor",tipo:"holerite",descricao:`Salário Líquido Victor (${e})`,valor:a,mesAno:e,data:new Date().toISOString()}),document.getElementById("inp-holerite-txt-victor").value="",document.getElementById("inp-salario-val-victor").value="",$(`✅ Salário do Victor (${e}) salvo com sucesso!`)});document.getElementById("form-holerite-maria").addEventListener("submit",async t=>{t.preventDefault();const e=b||document.getElementById("inp-entradas-mes-ano").value||new Date().toISOString().slice(0,7),o=document.getElementById("inp-holerite-txt-maria").value;let a=parseFloat(document.getElementById("inp-salario-val-maria").value)||0;if(!a&&o&&(a=qt(o)),!a){$("⚠️ Digite ou cole um holerite válido com valor.");return}const n=`salario_maria_${e}`;await V(T(I,st,n),{pessoa:"Maria",tipo:"holerite",descricao:`Salário Líquido Maria (${e})`,valor:a,mesAno:e,data:new Date().toISOString()}),document.getElementById("inp-holerite-txt-maria").value="",document.getElementById("inp-salario-val-maria").value="",$(`✅ Salário da Maria (${e}) salvo com sucesso!`)});document.getElementById("form-entrada-manual").addEventListener("submit",async t=>{t.preventDefault();const e=b||document.getElementById("inp-entradas-mes-ano").value||new Date().toISOString().slice(0,7),o=document.getElementById("inp-ent-desc").value.trim(),a=parseFloat(document.getElementById("inp-ent-val").value)||0,n=document.getElementById("inp-ent-pessoa").value;!o||!a||(await gt(Y(I,st),{pessoa:n,tipo:"manual",descricao:o,valor:a,mesAno:e,data:new Date().toISOString()}),t.target.reset(),$(`🎉 Entrada manual (${e}) registrada!`))});function Rt(){var m,d,u;const t=b||((m=document.getElementById("inp-entradas-mes-ano"))==null?void 0:m.value)||new Date().toISOString().slice(0,7),e=document.getElementById("lbl-entradas-mes-ref");if(e){const[c,E]=t.split("-"),v=new Date(parseInt(c),parseInt(E)-1,1).toLocaleString("pt-BR",{month:"long"}),f=v.charAt(0).toUpperCase()+v.slice(1);e.textContent=`Visualizando e inserindo entradas para: ${f} de ${c}`}const o=((d=j.find(c=>c.pessoa==="Victor"&&c.tipo==="holerite"&&c.mesAno===t))==null?void 0:d.valor)||0,a=((u=j.find(c=>c.pessoa==="Maria"&&c.tipo==="holerite"&&c.mesAno===t))==null?void 0:u.valor)||0,n=j.filter(c=>c.mesAno===t),s=n.reduce((c,E)=>c+(E.valor||0),0);document.getElementById("val-salario-victor").textContent=i(o),document.getElementById("val-salario-maria").textContent=i(a),document.getElementById("val-entradas-combinado").textContent=`${i(s)}`;const r=document.getElementById("lista-entradas-registradas");if(!r)return;const l=tt==="mes"?n:j;if(!l.length){r.innerHTML=`
  ...
  `}window.excluirEntrada=async function(t){confirm("Excluir esta entrada?")&&(await H(T(I,st,t)),$("🗑️ Entrada removida."))};let Et="Nubank",M=null;function pe(){const t=document.getElementById("inp-fatura-vencimento");if(t&&!t.value){const e=new Date,o=e.getFullYear(),a=String(e.getMonth()+1).padStart(2,"0");t.value=`${o}-${a}-10`,atualizarMesRefFatura()}}setTimeout(pe,300);window.atualizarMesRefFatura=function(){const t=document.getElementById("inp-fatura-vencimento"),e=document.getElementById("lbl-fatura-mes-ref");if(!(!t||!e))if(t.value){const[o,a]=t.value.split("-"),s=new Date(parseInt(o),parseInt(a)-1,1).toLocaleString("pt-BR",{month:"long"});e.textContent=`Fatura ${s.charAt(0).toUpperCase()+s.slice(1)}/${o}`}else e.textContent="Mês da Fatura"};window.selecionarCartaoFatura=function(t){Et=t,document.querySelectorAll(".btn-card-select").forEach(o=>o.classList.remove("active"));const e=document.querySelector(`.btn-card-select[data-card="${t}"]`);e&&e.classList.add("active"),$(`Cartão selecionado: ${t}`)};window.handleFileFaturaSelect=async function(t){const e=t.target.files[0];if(!e)return;const o=document.getElementById("txt-file-fatura");o&&(o.textContent=`📄 Arquivo: ${e.name}`),$(`⏳ Lendo arquivo da fatura (${e.name})...`);let a="";if(e.type==="application/pdf"||e.name.endsWith(".pdf"))a=await Ot(e);else try{a=await e.text()}catch{a=""}a?(document.getElementById("inp-fatura-txt").value=a,await zt(a,Et)):$("❌ Não foi possível ler o texto do arquivo da fatura.")};async function Ot(t){try{const e=await t.arrayBuffer();if(typeof pdfjsLib>"u")return $("⚠️ Aguarde a biblioteca de PDF carregar..."),"";pdfjsLib.GlobalWorkerOptions.workerSrc="https://cdnjs.cloudflare.com/ajax/libs/pdf.js/3.11.174/pdf.worker.min.js";let o=pdfjsLib.getDocument({data:e});o.onPassword=(s,r)=>{let l=prompt(`🔒 Este PDF de fatura está protegido por senha.
Digite a senha para abrir (ex: CPF ou Data de Nascimento):`);l?s(l):$("⚠️ Senha não informada. Leitura do PDF cancelada.")};const a=await o.promise;let n="";for(let s=1;s<=a.numPages;s++){const l=await(await a.getPage(s)).getTextContent();let m=null,d="";for(const u of l.items){if(!u.str)continue;const c=u.transform?u.transform[5]:null;m!==null&&Math.abs(c-m)>3?d+=`
`:d.length>0&&!d.endsWith(`
`)&&!d.endsWith(" ")&&(d+=" "),d+=u.str,m=c}n+=d+`
`}return n}catch(e){return e.name==="PasswordException"?$("🔒 O PDF precisa de senha válida para ser aberto."):console.error("Erro ao ler PDF:",e),""}}function ve(t){if(!t)return null;const e=t.match(/Total\s*a\s*Pagar\s*[:\s]*R?\$\s*([\d\.,]+)/i)||t.match(/no\s*valor\s*de\s*R?\$\s*([\d\.,]+)/i)||t.match(/Valor\s*total\s*da\s*fatura\s*[:\s]*R?\$\s*([\d\.,]+)/i)||t.match(/Total\s*da\s*fatura\s*[:\s]*R?\$\s*([\d\.,]+)/i);if(e){const o=S(e[1]);if(o>0)return o}return null}function ge(t){if(!t)return null;const e=t.match(/Vencimento\s*[:\s]*(\d{2}[\/\.-]\d{2}[\/\.-]\d{4})/i)||t.match(/Data\s*de\s*vencimento\s*[:\s]*(\d{2})\s+([A-Za-z]{3})\s+(\d{4})/i)||t.match(/FATURA\s+(\d{2})\s+([A-Za-z]{3})\s+(\d{4})/i);if(e){if(e[2]&&e[3]){const o=e[1],a=e[2].toUpperCase(),n=e[3],r={JAN:"01",FEB:"02",MAR:"03",ABR:"04",APR:"04",MAI:"05",MAY:"05",JUN:"06",JUL:"07",AGO:"08",AUG:"08",SET:"09",SEP:"09",OUT:"10",OCT:"10",NOV:"11",DEZ:"12",DEC:"12"}[a]||"07";return`${n}-${r}-${o.padStart(2,"0")}`}else if(e[1]){const[o,a,n]=e[1].split(/[\/\.-]/);return`${n}-${a.padStart(2,"0")}-${o.padStart(2,"0")}`}}return null}window.importarFaturaManualOuArquivo=async function(){const t=document.getElementById("inp-fatura-txt").value.trim();if(!t){$("⚠️ Selecione o arquivo da fatura (.pdf, .csv) ou cole o texto da fatura.");return}await zt(t,Et)};async function zt(t,e){const o=ge(t);o&&(document.getElementById("inp-fatura-vencimento").value=o,atualizarMesRefFatura());const a=ve(t),n=fe(t),s=document.getElementById("inp-fatura-vencimento").value||new Date().toISOString().slice(0,10),r=s.slice(0,7),l=n.reduce((E,p)=>E+p.valor,0),m=a||l||0,d=e?`Cartão ${e}`:"Fatura Cartão";M={cartao:e||"Nubank",descricao:d,dataVencimento:s,mesAno:r,valorTotal:m,qtdItens:n.length,itens:n};const u=document.getElementById("inp-revisao-fatura-desc");u&&(u.value=d);const c=document.getElementById("inp-revisao-fatura-val");c&&(c.value=m?m.toFixed(2):""),Pt(),n.length>0?$(`✅ ${n.length} compras encontradas! Fatura total: ${i(m)}.`):$("ℹ️ Fatura pronta para revisão. Confirme o valor total e o cartão abaixo.")}window.atualizarValorTotalRevisaoFatura=function(){var e;if(!M)return;const t=parseFloat((e=document.getElementById("inp-revisao-fatura-val"))==null?void 0:e.value)||0;M.valorTotal=t,document.getElementById("badge-total-preview-fatura").textContent=i(t)};function Pt(){if(!M)return;const{valorTotal:t,itens:e,cartao:o,descricao:a}=M;document.getElementById("badge-total-preview-fatura").textContent=i(t);const n=document.getElementById("inp-revisao-fatura-desc");n&&(!n.value||n.value==="Fatura Cartão")&&(n.value=a||`Cartão ${o||"Nubank"}`);const s=document.getElementById("inp-revisao-fatura-val");s&&(!s.value||parseFloat(s.value)===0)&&(s.value=t?t.toFixed(2):"");const r=document.getElementById("lista-preview-fatura-itens");!e||!e.length?r.innerHTML='<div class="empty-state">Nenhum item individual extraído. O valor total acima será considerado.</div>':r.innerHTML=e.map((m,d)=>`
...
`).forEach(n=>{const s=n.trim();if(!s||/EMISS[ÃA]O|TRANSA[ÇC][ÕO]ES|RESUMO|PAGAMENTO DE FATURA|TOTAL DA FATURA|FATURA ANTERIOR|SALDO ANTERIOR|LIMITE DISPON[ÍI]VEL|OPÇÕES DE PAGAMENTO|ALTERNATIVAS DE PAGAMENTO|PAGAMENTO E DEMAIS|PARCELAMENTOS|DESPESAS|HISTÓRICO DE FATURAS|SUPERCRÉDITO|SAQUE À CRÉDITO|COMPRA DATA DESCRIÇÃO/i.test(s))return;const r=/(?:[@\)\(\*•\s]+)?(\d{2}[\/\.-]\d{2}(?:[\/\.-]\d{2,4})?|\d{2}\s+[A-Za-z]{3})\s+(.+?)\s+(?:(\d{2}\/\d{2})\s+)?(-?R?\$\s*[\d\.]+,\d{2}|-?[\d\.]+,\d{2})$/i,l=s.match(r)||s.match(/(?:[@\)\(\*•\s]+)?(\d{2}[\/\.-]\d{2}(?:[\/\.-]\d{2,4})?|\d{2}\s+[A-Za-z]{3})\s+(.+?)\s+(?:(\d{2}\/\d{2})\s+)?(-?R?\$\s*[\d\.]+,\d{2}|-?[\d\.]+,\d{2})/i);if(l){const m=l[1];let d=l[2].trim();const u=l[3],c=l[4];if(c.includes("-")||/DEB AUTOM|PAGAMENTO|PAGTO|CR[ÉE]DITO FATURA/i.test(d))return;const E=S(c);u&&(d+=` (${u})`),d&&E>0&&d.length>2&&!/fatura|limite|pagamento|saldo|alternativas|opções|período|emissão|vencimento/i.test(d)&&e.push({dataCompra:m,descricao:d,valor:E})}}),e.length===0){let n;for(;(n=o.exec(t))!==null;){const s=n[1];let r=n[2].trim();const l=n[3],m=n[4];if(m.includes("-")||/DEB AUTOM|PAGAMENTO|PAGTO|CR[ÉE]DITO FATURA/i.test(r))continue;const d=S(m);l&&(r+=` (${l})`),r&&d>0&&r.length>2&&!/fatura|limite|pagamento|saldo|alternativas|opções|período|emissão|vencimento/i.test(r)&&e.push({dataCompra:s,descricao:r,valor:d})}}return e}window.ultimosLocaisAnalisados={};function be(t){if(!t)return"DIVERSOS";let e=t.replace(/\(\d{1,2}\/\d{1,2}\)/gi,"").replace(/\b\d{1,2}\/\d{1,2}\b/gi,"").replace(/\b\d{1,2}x\b/gi,"").trim();return e=e.replace(/\s+/g," "),e.toUpperCase()}function kt(t){const e={};(Array.isArray(t)?t:[t]).forEach(n=>{!n||!n.itens||!Array.isArray(n.itens)||n.itens.forEach(s=>{if(!s.descricao||!s.valor)return;const r=be(s.descricao);e[r]||(e[r]={nome:r,qtd:0,valorTotal:0,compras:[]}),e[r].qtd+=1,e[r].valorTotal+=s.valor||0,e[r].compras.push({dataCompra:s.dataCompra||"—",descricao:s.descricao,valor:s.valor||0,cartao:n.cartao||"Cartão",mesAno:n.mesAno||"—"})})});const a=Object.values(e).filter(n=>n.qtd>=2);return a.sort((n,s)=>s.valorTotal-n.valorTotal),a}function Ut(t,e="geral"){const o=kt(t);if(o.forEach(n=>{window.ultimosLocaisAnalisados[`${e}_${n.nome}`]=n}),!o.length)return`
  ...
  `,o.style.display="flex"};window.fecharModalEstabelecimento=function(){const t=document.getElementById("modal-detalhes-estabelecimento");t&&(t.style.display="none")};function he(){const t=k.reduce((a,n)=>a+(n.valorTotal!==void 0?n.valorTotal:n.valor||0),0);document.getElementById("badge-total-cartoes").textContent=`${i(t)} total`;const e=document.getElementById("lista-faturas-registradas");if(!k.length){e.innerHTML='<div class="empty-state">Nenhuma fatura cadastrada ainda.</div>';return}const o=Ut(k,"geral");e.innerHTML=o+k.map(a=>{var c;const n=a.valorTotal!==void 0?a.valorTotal:a.valor||0,s=a.cartao||"Cartão",r=s.toLowerCase().includes("nubank"),l=r?"purple":"red",m=r?"🟣":"🔴",d=a.dataVencimento?mt(a.dataVencimento).split(",")[0]:"—",u=a.mesAno||"—";return`
      <div class="purchase-card" style="margin-bottom:1rem">
        <div class="purchase-header" onclick="toggleDetail('fat-${a.id}')">
          <div class="purchase-info">
            <h3><span class="badge ${l}">${m} ${s}</span> — Vencimento: ${d}</h3>
            <p>📅 Mês Referência: <strong>${u}</strong> &nbsp;•&nbsp; 🛒 ${a.qtdItens||((c=a.itens)==null?void 0:c.length)||1} itens contemplados</p>
          </div>
          <div class="purchase-values" style="display:flex;align-items:center;gap:.75rem">
            <div style="text-align:right">
...
`).forEach(d=>{const u=d.trim();if(!u||/vencimento|beneficiário|cedente|nosso\s*número|agência|código|autenticação|instruções/i.test(u))return;const c=u.match(/(\d{2}[\/\.-]\d{2}(?:[\/\.-]\d{2,4})?|\b[A-Za-z]{3}\b)?\s*(.+?)\s+R?\$\s*([\d\.]+,\d{2})$/i);if(c){const E=c[1]||"Boleto",p=c[2].trim(),v=S(c[3]);p&&v>0&&p.length>2&&!/valor|total|documento|cobrado/i.test(p)&&n.push({dataBoleto:E,descricao:p,valor:v})}}),{beneficiario:e,valorTotal:o,vencimento:a,itens:n}}function $e(){const t=z.reduce((a,n)=>a+(n.valorTotal!==void 0?n.valorTotal:n.valor||0),0);document.getElementById("badge-total-boletos").textContent=`${i(t)} total`;const e=document.getElementById("lista-boletos-registrados");if(!z.length){e.innerHTML='<div class="empty-state">Nenhum boleto cadastrado ainda.</div>';return}const o=[...z].sort((a,n)=>{const s=a.dataVencimento?new Date(a.dataVencimento).getTime():a.mesAno?new Date(a.mesAno+"-01").getTime():0;return(n.dataVencimento?new Date(n.dataVencimento).getTime():n.mesAno?new Date(n.mesAno+"-01").getTime():0)-s});e.innerHTML=o.map(a=>{var m;const n=a.valorTotal!==void 0?a.valorTotal:a.valor||0,s=a.dataVencimento?mt(a.dataVencimento).split(",")[0]:"—",r=a.mesAno||"—",l=Ht(a);return`
  ...
  </table></div>`}window.editarValorBoletoDocumento=async function(t){const e=z.find(s=>s.id===t);if(!e)return;const o=e.valorTotal!==void 0?e.valorTotal:e.valor||0,a=prompt(`✏️ Editar valor do boleto "${e.descricao||"Boleto"}":`,o.toFixed(2));if(a===null)return;const n=typeof S=="function"?S(a):parseFloat(a.replace(",","."));if(isNaN(n)||n<=0){alert("Por favor, informe um valor numérico válido maior que zero.");return}try{const s=T(I,K,t),r={valorTotal:n,valor:n,dataAtualizacao:new Date().toISOString()};if(e.itens&&e.itens.length>0){const l=[...e.itens];l[0]={...l[0],valor:n},r.itens=l}await V(s,r,{merge:!0}),$(`✏️ Valor do boleto atualizado para ${i(n)} em todo o sistema!`)}catch(s){alert("Erro ao atualizar valor do boleto: "+s.message)}};window.editarItemBoleto=async function(t,e){const o=z.find(l=>l.id===t);if(!o||!o.itens||!o.itens[e])return;const a=o.itens[e],n=a.valor||0,s=prompt(`✏️ Editar valor do item "${a.descricao}":`,n.toFixed(2));if(s===null)return;const r=typeof S=="function"?S(s):parseFloat(s.replace(",","."));if(isNaN(r)||r<=0){alert("Por favor, informe um valor numérico válido maior que zero.");return}try{const l=[...o.itens];l[e]={...l[e],valor:r};const m=l.reduce((d,u)=>d+(u.valor||0),0);await V(T(I,K,t),{...o,itens:l,valorTotal:m,valor:m,dataAtualizacao:new Date().toISOString()},{merge:!0}),$(`✏️ Item do boleto atualizado para ${i(r)} em todo o sistema!`)}catch(l){alert("Erro ao atualizar item do boleto: "+l.message)}};window.removerItemBoletoCadastrado=async function(t,e){const o=z.find(s=>s.id===t);if(!o||!o.itens||!confirm("Remover este item do boleto?"))return;const a=[...o.itens];a.splice(e,1);const n=a.reduce((s,r)=>s+(r.valor||0),0);a.length===0?(await H(T(I,K,t)),$("🗑️ Boleto excluído pois todos os itens foram removidos.")):(await V(T(I,K,t),{...o,itens:a,valorTotal:n,qtdItens:a.length}),$("🗑️ Item removido do boleto."))};window.excluirBoletoDocumento=async function(t){const e=z.find(n=>n.id===t),o=e?e.descricao||"Boleto / Conta":"este boleto",a=e?i(e.valorTotal!==void 0?e.valorTotal:e.valor||0):"";confirm(`⚠️ Deseja realmente excluir ${o} ${a?"("+a+")":""}?

Este boleto será removido permanentemente de todos os meses, resumos e relatórios do sistema.`)&&(await H(T(I,K,t)),$("🗑️ Boleto removido de todo o sistema com sucesso."))};document.getElementById("form-config-reservas").addEventListener("submit",async t=>{t.preventDefault();const e=parseFloat(document.getElementById("inp-meta-anual").value)||0,o=parseFloat(document.getElementById("inp-saldo-guardado").value)||0;N.metaAnual=e,N.valorAtualGuardado=o,await V(T(I,Mt,"config"),{metaAnual:e,valorAtualGuardado:o,dataAtualizacao:new Date().toISOString()}),$("✅ Reservas e configurações de economias salvas!"),W()});function xe(){const t=N&&N.metaAnual!==void 0?N.metaAnual:15e3,e=N&&N.valorAtualGuardado!==void 0?N.valorAtualGuardado:3e3,o=document.getElementById("inp-meta-anual");o&&document.activeElement!==o&&(o.value=t);const a=document.getElementById("inp-saldo-guardado");a&&document.activeElement!==a&&(a.value=e);const s=new Date().getMonth()+1,r=Math.max(1,12-s+1),l=Math.max(0,t-e),m=l>0?l/r:0;document.getElementById("val-meta-reserva").textContent=i(m);const d=document.getElementById("subtext-meta-reserva");d&&(d.textContent=`Faltam ${i(l)} p/ Meta Anual de ${i(t)} (${r} mês(es) até o fim do ano)`),document.getElementById("val-real-guardado").textContent=i(e);const u=rt();let c=0,E=0,p=0,v=0;u.forEach(C=>{const G=j.filter(y=>y.mesAno===C).reduce((y,A)=>y+(A.valor||0),0),P=k.filter(y=>y.mesAno===C).reduce((y,A)=>y+(A.valorTotal!==void 0?A.valorTotal:A.valor||0),0),R=z.filter(y=>y.mesAno===C).reduce((y,A)=>y+(A.valorTotal!==void 0?A.valorTotal:A.valor||0),0);let g=0;O.filter(y=>y.mesAno===C).forEach(y=>{y.formasPagamento&&(g+=y.formasPagamento.cartaoDebito||0)}),c+=G,E+=P,p+=R,v+=g});const f=E+p+v,L=c-f,F=Math.max(1,u.length),q=L/F,w=q>0?q*.5:0,B=w*12;document.getElementById("val-recomendacao-reserva").textContent=i(B);const h=document.getElementById("subtext-recomendacao");h&&(h.textContent=`Sugerido poupar ${i(w)}/mês (${i(B)} no ano)`);const x=document.getElementById("box-analise-reserva-detalhes");if(x)if(c===0)x.innerHTML='<p class="empty-state">Cadastre seus salários e entradas na aba "Salários & Entradas" para gerar o diagnóstico inteligente de economias.</p>';else{const C=t>0?Math.min(100,e/t*100).toFixed(1):0;x.innerHTML=`
      ...
      `}Ie()}function Ie(){const t=document.getElementById("container-analise-mensal-lista");if(!t)return;const e=rt();if(!e.length){t.innerHTML='<div class="empty-state">Nenhum mês registrado para gerar a análise mensal.</div>';return}const o=e.map(a=>{const s=j.filter(h=>h.mesAno===a).reduce((h,x)=>h+(x.valor||0),0),r=k.filter(h=>h.mesAno===a),l=r.reduce((h,x)=>h+(x.valorTotal!==void 0?x.valorTotal:x.valor||0),0),m=z.filter(h=>h.mesAno===a),d=m.reduce((h,x)=>h+(x.valorTotal!==void 0?x.valorTotal:x.valor||0),0),u=O.filter(h=>h.mesAno===a);let c=0;u.forEach(h=>{h.formasPagamento&&(c+=h.formasPagamento.cartaoDebito||0)});const E=l+d+c,p=s-E,v=p>=0,[f,L]=a.split("-"),q=new Date(parseInt(f),parseInt(L)-1,1).toLocaleString("pt-BR",{month:"long"}),w=q.charAt(0).toUpperCase()+q.slice(1);let B="";if(v){const h=p*.5;B=`
      ...
      `}else{const h=Math.abs(p);let x="Cartão de Crédito",C=l;d>C&&(x="Boletos & Contas",C=d),c>C&&(x="Mercado no Débito",C=c);const G=E>0?(C/E*100).toFixed(1):0;let P="",R=0;r.forEach(g=>{const y=g.valorTotal!==void 0?g.valorTotal:g.valor||0;y>R&&(R=y,P=`Fatura do ${g.cartao||"Cartão"}`)}),m.forEach(g=>{const y=g.valorTotal!==void 0?g.valorTotal:g.valor||0;y>R&&(R=y,P=`Boleto ${g.descricao||"de Conta"}`)}),B=`
  ...
  `}const vt=[{id:"est_1",nome:"Corte de Cabelo Victor",quantidade:2,valorUnitario:70},{id:"est_2",nome:"Compra Programada Tunico",quantidade:1,valorUnitario:150},{id:"est_3",nome:"Sobrancelha Maria",quantidade:1,valorUnitario:50},{id:"est_4",nome:"Unha Maria",quantidade:1,valorUnitario:90},{id:"est_5",nome:"Banho Tunico",quantidade:1,valorUnitario:65},{id:"est_6",nome:"Saída Simples",quantidade:2,valorUnitario:100},{id:"est_7",nome:"Saída Premiun",quantidade:1,valorUnitario:150},{id:"est_8",nome:"Saída Premiun Plus",quantidade:1,valorUnitario:200},{id:"est_9",nome:"Mercado Pontual",quantidade:4,valorUnitario:70},{id:"est_10",nome:"Farmacia",quantidade:2,valorUnitario:35},{id:"est_11",nome:"Padaria 3D",quantidade:10,valorUnitario:10}];window.abrirModalAddEstimativa=function(t=null){const e=document.getElementById("modal-add-estimativa");if(e){if(document.getElementById("inp-est-id").value=t||"",t){document.getElementById("titulo-modal-estimativa").textContent="✏️ Editar Gastos Previsto";const o=Z.find(n=>n.id===b),a=((o==null?void 0:o.itens)||[]).find(n=>n.id===t);a&&(document.getElementById("inp-est-nome").value=a.nome||"",document.getElementById("inp-est-qtd").value=a.quantidade||1,document.getElementById("inp-est-val").value=a.valorUnitario||0)}else document.getElementById("titulo-modal-estimativa").textContent="➕ Adicionar Gastos Previsto",document.getElementById("inp-est-nome").value="",document.getElementById("inp-est-qtd").value=1,document.getElementById("inp-est-val").value="";e.classList.add("active")}};window.fecharModalAddEstimativa=function(){var t;(t=document.getElementById("modal-add-estimativa"))==null||t.classList.remove("active")};var Bt;(Bt=document.getElementById("form-item-estimativa"))==null||Bt.addEventListener("submit",async t=>{t.preventDefault();const e=document.getElementById("inp-est-id").value,o=document.getElementById("inp-est-nome").value.trim(),a=parseFloat(document.getElementById("inp-est-qtd").value)||1,n=parseFloat(document.getElementById("inp-est-val").value)||0;if(!o){alert("Preencha a descrição do gasto.");return}const s=Z.find(l=>l.id===b);let r=s?[...s.itens||[]]:[...vt];e?r=r.map(l=>l.id===e?{...l,nome:o,quantidade:a,valorUnitario:n}:l):r.push({id:"est_"+Date.now(),nome:o,quantidade:a,valorUnitario:n}),await V(T(I,X,b),{mesAno:b,itens:r,ultimaAtualizacao:new Date().toISOString()}),fecharModalAddEstimativa(),$("✅ Estimativa atualizada!")});window.atualizarQtdItemEstimativa=async function(t,e){const o=Z.find(s=>s.id===b);if(!o)return;const a=Math.max(1,parseInt(e)||1),n=(o.itens||[]).map(s=>s.id===t?{...s,quantidade:a}:s);await V(T(I,X,b),{mesAno:b,itens:n,ultimaAtualizacao:new Date().toISOString()})};window.atualizarValorItemEstimativa=async function(t,e){const o=Z.find(s=>s.id===b);if(!o)return;const a=Math.max(0,parseFloat(e)||0),n=(o.itens||[]).map(s=>s.id===t?{...s,valorUnitario:a}:s);await V(T(I,X,b),{mesAno:b,itens:n,ultimaAtualizacao:new Date().toISOString()})};window.excluirItemEstimativa=async function(t){if(!confirm("Remover este item da estimativa do mês?"))return;const e=Z.find(a=>a.id===b);if(!e)return;const o=(e.itens||[]).filter(a=>a.id!==t);await V(T(I,X,b),{mesAno:b,itens:o,ultimaAtualizacao:new Date().toISOString()}),$("🗑️ Item removido da estimativa.")};window.resetarItensEstimativaPadrao=async function(){confirm(`Deseja carregar/resetar os 11 itens padrão de previsão para ${b}?`)&&(await V(T(I,X,b),{mesAno:b,itens:vt,ultimaAtualizacao:new Date().toISOString()}),$("🔄 Itens padrão de estimativa carregados!"))};function we(){const t=document.getElementById("container-lista-estimativa");if(!t)return;const e=Z.find(p=>p.id===b);let o=[];e&&Array.isArray(e.itens)?o=e.itens:(o=vt,V(T(I,X,b),{mesAno:b,itens:vt,ultimaAtualizacao:new Date().toISOString()}).catch(p=>console.error("Auto init estimativa error:",p)));let a=0;o.forEach(p=>{a+=(p.quantidade||0)*(p.valorUnitario||0)});const n=document.getElementById("val-total-estimativa-mes");n&&(n.textContent=i(a));const[s,r]=b.split("-"),m=new Date(parseInt(s),parseInt(r)-1,1).toLocaleString("pt-BR",{month:"long"}),d=m.charAt(0).toUpperCase()+m.slice(1),u=document.getElementById("subtext-estimativa-mes");u&&(u.textContent=`Total previsto para ${d} de ${s} (${o.length} itens cadastrados)`);const c=document.getElementById("badge-count-estimativa");if(c&&(c.textContent=`${o.length} itens previstos`),!o.length){t.innerHTML=`
  ...
  `;t.innerHTML=E}function Ae(){const t=document.getElementById("lista-mensal-container");if(!t)return;const e=new Date,o=new Date(e.getFullYear(),e.getMonth()+1,1),a=o.toLocaleString("pt-BR",{month:"long"}),n=o.getFullYear(),s=`${a.charAt(0).toUpperCase()+a.slice(1)} de ${n}`,r=re(o.getFullYear(),o.getMonth()),l=31.8,m=20,d=r*l,u=r*m,c={};let E=0;O.forEach(g=>{const y=g.valorAPagar||0;E+=y;const A=g.mesAno||"Outros";c[A]=(c[A]||0)+y});const p=Math.max(1,Object.keys(c).length),v=E/p,f={};O.forEach(g=>{(g.itens||[]).forEach(y=>{const A=(y.nome||"").toLowerCase().trim();A&&(f[A]||(f[A]={nome:y.nome,marca:y.marca||"Geral",qtdTotal:0,frequenciaNotas:0,valoresUnitarios:[]}),f[A].qtdTotal+=y.quantidade||1,f[A].frequenciaNotas+=1,y.valorUnitario&&f[A].valoresUnitarios.push(y.valorUnitario))})});const L=Object.values(f).map(g=>{const y=g.valoresUnitarios.length>0?g.valoresUnitarios.reduce((lt,pt)=>lt+pt,0)/g.valoresUnitarios.length:0,A=g.qtdTotal/p,at=p/Math.max(1,g.frequenciaNotas),ut=g.frequenciaNotas/p;let _=0;ut>=.35||A>=.7?_=Math.ceil(A):_=Math.round(A),_<1&&g.frequenciaNotas>=p&&(_=1);const it=_*y;return{nome:g.nome,marca:g.marca,frequenciaNotas:g.frequenciaNotas,intervaloMeses:at,qtdMensalTaxa:A,totalEstimadoUnidades:_,valorUnitario:y,subtotalCalculado:it}}).filter(g=>g.totalEstimadoUnidades>0);L.sort((g,y)=>y.frequenciaNotas-g.frequenciaNotas);const F=L.reduce((g,y)=>g+y.subtotalCalculado,0),q=v>0?v*1.05:F;let w=1;F>q&&v>0&&(w=q/F);const B=L.map(g=>({...g,subtotalFinal:g.subtotalCalculado*w})),h=v>0?Math.min(F,q):F;let x=h;const C=Math.min(x,d);x-=C;const G=Math.min(x,u);x-=G;const P=x>0?x:0;let R=`
  ...
  `;window.dadosListaMensalCache={mesAnoStr:s,diasUteis:r,totalGeralEstimado:h,cobertoAlim:C,cobertoCred:G,cobertoDeb:P,alimDisponivel:d,credDisponivel:u,lista:B},B.length===0?R+='<div class="empty-state">Adicione notas fiscais para que o sistema gere automaticamente sua lista mensal de compras.</div></div>':R+=`
      <div class="table-responsive">
        <table class="custom-table">
          <thead>
            <tr>
          ...
          <tbody>
            ${B.map(g=>{const y=g.intervaloMeses>1.2?`A cada ${g.intervaloMeses.toFixed(1)} meses`:`Todo mês (${g.frequenciaNotas}x)`,A=g.qtdMensalTaxa<1?g.qtdMensalTaxa.toFixed(2):g.qtdMensalTaxa.toFixed(1),at=g.totalEstimadoUnidades.toFixed(1);return`
                <tr>
  ...
  `;l.document.open(),l.document.write(m),l.document.close()};document.getElementById("btn-start-cam").addEventListener("click",_t);document.getElementById("btn-switch-cam").addEventListener("click",Be);document.getElementById("btn-stop-cam").addEventListener("click",$t);async function _t(){if(typeof Html5Qrcode>"u")return U("Carregando biblioteca de câmera, aguarde..."),setTimeout(_t,600);try{J||(J=new Html5Qrcode("qr-reader")),Q=await Html5Qrcode.getCameras();let t;if(Q&&Q.length>0){const e=Q.findIndex(o=>/back|traseira|rear|environment/i.test(o.label));dt=e>=0?e:0,t=Q[dt].id}else t={facingMode:"environment"};await J.start(t,{fps:10,qrbox:{width:240,height:240}},Qt,()=>{}),ct=!0,document.getElementById("btn-start-cam").style.display="none",document.getElementById("btn-switch-cam").style.display=Q.length>1?"inline-flex":"none",document.getElementById("btn-stop-cam").style.display="inline-flex"}catch(t){U("❌ Não foi possível acessar a câmera. Verifique as permissões do navegador."),console.error(t)}}async function Be(){if(!(!J||!ct))try{await J.stop(),Q.length>1&&(dt=(dt+1)%Q.length,await J.start(Q[dt].id,{fps:10,qrbox:{width:240,height:240}},Qt,()=>{}))}catch(t){console.error("switchCam:",t)}}async function $t(){if(J&&ct)try{await J.stop()}catch{}ct=!1,document.getElementById("btn-start-cam").style.display="inline-flex",document.getElementById("btn-switch-cam").style.display="none",document.getElementById("btn-stop-cam").style.display="none"}async function Qt(t){$t(),document.getElementById("inp-url").value=t,U("✅ QR Code lido! Processando..."),await Zt(t)}document.getElementById("btn-carregar-dados").addEventListener("click",async()=>{const t=document.getElementById("inp-url").value.trim(),e=document.getElementById("inp-html").value.trim();if(!t&&!e){U("⚠️ Cole a URL do QR Code ou o conteúdo da página para ler a nota fiscal.");return}if(t&&!e){U("⏳ Consultando nota fiscal..."),await Zt(t);return}if(e){U("⏳ Processando conteúdo..."),await Wt(e);return}});document.getElementById("btn-preencher-manual").addEventListener("click",()=>{Yt({nomeMercado:"",dataEmissao:new Date().toISOString(),valorTotal:0,descontoTotal:0,valorAPagar:0,qtdTotalItens:0,formasPagamento:{valeAlimentacao:0,cartaoCredito:0,cartaoDebito:0},itens:[]}),U("✍️ Preencha os dados da compra abaixo e clique em Salvar Nota Fiscal.","var(--accent-cyan)")});function Yt(t){var s,r,l;document.getElementById("inp-mercado").value=t.nomeMercado||"",document.getElementById("inp-data").value=se(t.dataEmissao),document.getElementById("inp-vtotal").value=t.valorTotal!==void 0?t.valorTotal:0,document.getElementById("inp-desconto").value=t.descontoTotal!==void 0?t.descontoTotal:0,document.getElementById("inp-pagar").value=t.valorAPagar!==void 0?t.valorAPagar:0,document.getElementById("inp-qtd").value=t.qtdTotalItens!==void 0?t.qtdTotalItens:0,document.getElementById("inp-alim").value=((s=t.formasPagamento)==null?void 0:s.valeAlimentacao)||0,document.getElementById("inp-cred").value=((r=t.formasPagamento)==null?void 0:r.cartaoCredito)||0,document.getElementById("inp-deb").value=((l=t.formasPagamento)==null?void 0:l.cartaoDebito)||0,et=t.itens||[];const e=document.getElementById("form-nfce");e.style.display="block";const o=document.getElementById("preview-itens-box"),a=document.getElementById("count-preview-itens"),n=document.getElementById("lista-preview-itens");et.length>0?(o.style.display="block",a.textContent=et.length,n.innerHTML=et.map(m=>`
    ...
    `).join("")):o.style.display="none",e.scrollIntoView({behavior:"smooth"})}document.getElementById("form-nfce").addEventListener("submit",async t=>{t.preventDefault();const e=document.getElementById("inp-mercado").value.trim()||"Mercado",o=document.getElementById("inp-data").value||new Date().toISOString(),a=parseFloat(document.getElementById("inp-vtotal").value)||0,n=parseFloat(document.getElementById("inp-desconto").value)||0,s=parseFloat(document.getElementById("inp-pagar").value)||0,r=parseInt(document.getElementById("inp-qtd").value)||0,l=parseFloat(document.getElementById("inp-alim").value)||0,m=parseFloat(document.getElementById("inp-cred").value)||0,d=parseFloat(document.getElementById("inp-deb").value)||0,u=new Date(o).toISOString().slice(0,16),c=O.find(v=>{const f=new Date(v.dataEmissao).toISOString().slice(0,16),L=Math.abs((v.valorAPagar||0)-s)<.05,F=(v.nomeMercado||"").toLowerCase().trim()===e.toLowerCase().trim();return f===u&&L&&F});if(c){U(`⚠️ Esta nota fiscal já existe no sistema (Cadastrada em ${mt(c.dataEmissao)} no valor de ${i(c.valorAPagar)}). Nota não adicionada!`,"#fb7185"),$("⚠️ Nota fiscal já cadastrada! Operação cancelada.");return}const E=new Date(o),p=`${E.getFullYear()}-${String(E.getMonth()+1).padStart(2,"0")}`;U("⏳ Salvando nota fiscal no banco...");try{await gt(Y(I,ft),{nomeMercado:e,dataEmissao:o,mesAno:p,qtdTotalItens:r||et.length,valorTotal:a,descontoTotal:n,valorAPagar:s,formasPagamento:{valeAlimentacao:l,cartaoCredito:m,cartaoDebito:d},itens:et,createdAt:yt()}),U("✅ Nota salva com sucesso!","#34d399"),document.getElementById("form-nfce").style.display="none",document.getElementById("form-nfce").reset(),document.getElementById("inp-url").value="",document.getElementById("inp-html").value="",et=[],Dt(),goTab("dashboard"),$("🎉 Nota fiscal registrada no Firebase!")}catch(v){U("❌ Erro ao salvar: "+v.message,"#fb7185")}});async function Zt(t){const e=[o=>`https://api.allorigins.win/raw?url=${encodeURIComponent(o)}`,o=>`https://corsproxy.io/?${encodeURIComponent(o)}`];for(const o of e)try{const a=await fetch(o(t),{signal:AbortSignal.timeout(8e3)});if(a.ok){const n=await a.text();if(n&&n.length>200){await Wt(n);return}}}catch{}Te(t)}function Te(t){document.getElementById("modal-link").href=t,document.getElementById("modal-cors").classList.add("active"),U("⚠️ Abra o link, copie o conteúdo da página e cole no campo de texto abaixo.")}async function Wt(t){const e=Ce(t);Yt(e),U("✅ Nota lida com sucesso! Confira os valores abaixo e altere se necessário antes de Salvar.","#34d399")}function Ce(t){var C,G,P;const o=new DOMParser().parseFromString(t,"text/html"),a=((C=o.body)==null?void 0:C.textContent)||t;let n=((P=(G=o.querySelector(".txtTopo, .nomeEmit, h1"))==null?void 0:G.textContent)==null?void 0:P.trim())||"Mercado",s=new Date().toISOString();const r=a.match(/Emiss[ãa]o\s*[:\-]?\s*(\d{2}\/\d{2}\/\d{4})\s+(\d{2}:\d{2}:\d{2})?/i)||a.match(/(\d{2}\/\d{2}\/\d{4})\s+(\d{2}:\d{2}:\d{2})/);if(r){const[R,g,y]=r[1].split("/");s=`${y}-${g}-${R}T${r[2]||"12:00:00"}`}const l=a.match(/Qtd\.?\s*total\s*de\s*itens\s*[:\s]*([\d,\.]+)/i),m=a.match(/Valor\s*total\s*R\$\s*[:\s]*([\d\.,]+)/i),d=a.match(/Descontos?\s*R\$\s*[:\s]*([\d\.,]+)/i),u=a.match(/Valor\s*a\s*pagar\s*R\$\s*[:\s]*([\d\.,]+)/i)||a.match(/VALOR\s*PAGO\s*R\$\s*[:\s]*([\d\.,]+)/i),c=a.match(/(?:Vale\s*)?Alimenta[çc][ãa]o\s*[:\s]*([\d\.,]+)/i),E=a.match(/(?:Cart[ãa]o\s*de\s*)?Cr[eé]dito\s*[:\s]*([\d\.,]+)/i),p=a.match(/(?:Cart[ãa]o\s*de\s*)?D[eé]bito\s*[:\s]*([\d\.,]+)/i),v=l?S(l[1]):0,f=m?S(m[1]):0,L=d?S(d[1]):0;let F=u?S(u[1]):f-L;const q={valeAlimentacao:c?S(c[1]):0,cartaoCredito:E?S(E[1]):0,cartaoDebito:p?S(p[1]):0},w=[];o.querySelectorAll("tr, .item, .itemNota").forEach(R=>{var xt;const g=R.textContent;if(!/Vl\.\s*Unit|valorUnitario|Qtde?\./i.test(g))return;const y=R.querySelector(".txtTit, .txtTit2, .nomeProd"),A=((xt=y==null?void 0:y.textContent)==null?void 0:xt.trim())||"",at=g.match(/Qtde?\.\s*[:\s]*([\d,\.]+)/i),ut=g.match(/Vl\.\s*Unit\.\s*[:\s]*([\d,\.]+)/i),_=g.match(/Vl\.\s*Total\s*([\d,\.]+)/i),it=g.match(/C[oó]digo\s*[:\s]*(\d+)/i),lt=g.match(/UN\s*[:\s]*([A-Za-z]+)/i),pt=at?S(at[1]):1,bt=ut?S(ut[1]):0,Kt=_?S(_[1]):bt*pt;A&&bt>0&&w.push({codigo:(it==null?void 0:it[1])||"",nome:A,marca:Me(A),quantidade:pt,unidade:(lt==null?void 0:lt[1])||"Un",valorUnitario:bt,valorTotal:Kt})});const h=new Date(s),x=`${h.getFullYear()}-${String(h.getMonth()+1).padStart(2,"0")}`;return{nomeMercado:n,dataEmissao:s,mesAno:x,qtdTotalItens:v,valorTotal:f,descontoTotal:L,valorAPagar:F,formasPagamento:q,itens:w}}function Me(t){const e=["BAUDUCCO","BAUD","PANCO","DANONE","NESTLE","QUALITA","SADIA","PERDIGAO","SEARA","CAMIL","TIO JOAO","URBANO","LIZA","SOYA","YPE","PILAO","MELITTA","3 CORACOES","VIGOR","PARMALAT","ITALAC","HEINZ","KRAFT"],o=t.toUpperCase();for(const a of e)if(o.includes(a))return a;return o.split(" ")[0]||"Genérica"}function Se(){const t=document.getElementById("lista-historico");if(!O.length){t.innerHTML='<div class="empty-state">📭 Nenhuma compra cadastrada ainda.</div>';return}t.innerHTML=O.map(e=>{var o,a,n;return`
    <div class="purchase-card">
    ...
    <tbody>${o.map(a=>{const n=Object.keys(a.hist).sort();let s=n.map(l=>`${l}: <strong>${i(a.hist[l])}</strong>`).join(" → "),r='<span class="badge cyan">Estável</span>';if(n.length>=2){const l=a.hist[n[n.length-2]],d=a.hist[n[n.length-1]]-l,u=(d/l*100).toFixed(1);d>.01?r=`<span class="badge red">+${u}% ↑</span>`:d<-.01&&(r=`<span class="badge green">${u}% ↓</span>`)}return`<tr><td><strong>${a.nome}</strong></td><td><span class="badge amber">${a.marca||"—"}</span></td><td>${s}</td><td>${r}</td></tr>`}).join("")}</tbody>
      ...
      </table></div>`:'<div class="empty-state">Adicione notas para ver a recorrência de itens.</div>';const s=Object.entries(a).filter(([,r])=>Object.keys(r).length>1).map(([r,l])=>{let m=1/0,d="";const u=Object.entries(l).map(([c,E])=>{const p=E.reduce((v,f)=>v+f,0)/E.length;return p<m&&(m=p,d=c),{marca:c,med:p}});return`<div class="brand-card">
