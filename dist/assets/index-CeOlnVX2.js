import{initializeApp as Kt}from"https://www.gstatic.com/firebasejs/10.14.1/firebase-app.js";import{getFirestore as Xt,onSnapshot as nt,query as te,collection as Y,orderBy as ee,doc as T,deleteDoc as H,setDoc as V,addDoc as gt,serverTimestamp as yt}from"https://www.gstatic.com/firebasejs/10.14.1/firebase-firestore.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const r of s.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&a(r)}).observe(document,{childList:!0,subtree:!0});function o(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function a(n){if(n.ep)return;n.ep=!0;const s=o(n);fetch(n.href,s)}})();const Tt=document.createElement("script");Tt.src="https://cdn.jsdelivr.net/npm/chart.js@4.4.7/dist/chart.umd.min.js";document.head.appendChild(Tt);const Ct=document.createElement("script");Ct.src="https://unpkg.com/html5-qrcode@2.3.8/html5-qrcode.min.js";document.head.appendChild(Ct);const ae={apiKey:"AIzaSyANpFnEIkyN1XCT6qbtmVR9wx7sQHEsyrE",authDomain:"comprasmercado-23913.firebaseapp.com",projectId:"comprasmercado-23913",storageBucket:"comprasmercado-23913.firebasestorage.app",messagingSenderId:"317518149234",appId:"1:317518149234:web:94f38624d68a2b9a6634eb",measurementId:"G-2XP88EK37S"},oe=Kt(ae),I=Xt(oe),ft="compras",st="entradas",ot="faturas",K="boletos",Mt="reservas",X="estimativas";let O=[],j=[],P=[],z=[],Z=[],N={valorAtualGuardado:0},ht=null,J=null,Q=[],dt=0,ct=!1,et=[];function l(t){return Number(t||0).toLocaleString("pt-BR",{style:"currency",currency:"BRL"})}function S(t){if(typeof t=="number")return t;if(!t)return 0;const e=parseFloat(String(t).replace(/R\$\s?/gi,"").replace(/\s/g,"").replace(/\./g,"").replace(",","."));return isNaN(e)?0:e}function mt(t){if(!t)return"—";try{return new Date(t).toLocaleString("pt-BR",{dateStyle:"short",timeStyle:"short"})}catch{return t}}function $(t,e=3500){const o=document.getElementById("toast");o.textContent=t,o.classList.add("show"),setTimeout(()=>o.classList.remove("show"),e)}function U(t,e="var(--accent-amber)"){const o=document.getElementById("status-msg");o&&(o.textContent=t,o.style.color=e)}function ne(t){if(!t)return new Date().toISOString().slice(0,16);try{const e=new Date(t);if(isNaN(e.getTime()))return new Date().toISOString().slice(0,16);const o=a=>String(a).padStart(2,"0");return`${e.getFullYear()}-${o(e.getMonth()+1)}-${o(e.getDate())}T${o(e.getHours())}:${o(e.getMinutes())}`}catch{return new Date().toISOString().slice(0,16)}}function se(t,e){let o=0;const a=new Date(t,e+1,0).getDate();for(let n=1;n<=a;n++){const s=new Date(t,e,n).getDay();s!==0&&s!==6&&o++}return o}window.goTab=function(t){document.querySelectorAll(".tab-content").forEach(o=>o.classList.remove("active")),document.querySelectorAll(".desktop-nav .nav-item").forEach(o=>o.classList.remove("active")),document.querySelectorAll(".mobile-nav .mob-btn").forEach(o=>o.classList.remove("active"));const e=document.getElementById("tab-"+t);e&&e.classList.add("active"),document.querySelectorAll(`[data-tab="${t}"]`).forEach(o=>o.classList.add("active"))};document.querySelectorAll("[data-tab]").forEach(t=>{t.addEventListener("click",()=>goTab(t.getAttribute("data-tab")))});document.querySelectorAll(".sub-item").forEach(t=>{t.addEventListener("click",()=>{document.querySelectorAll(".sub-item").forEach(o=>o.classList.remove("active")),document.querySelectorAll(".sub-tab-content").forEach(o=>o.style.display="none"),t.classList.add("active");const e=document.getElementById("sub-"+t.getAttribute("data-sub"));e&&(e.style.display="block")})});function St(){document.getElementById("modal-add-nota").classList.add("active")}function Dt(){ct&&$t(),document.getElementById("modal-add-nota").classList.remove("active")}var It;(It=document.getElementById("btn-open-modal-home"))==null||It.addEventListener("click",St);var wt;(wt=document.getElementById("btn-mercado-add-nota"))==null||wt.addEventListener("click",St);var At;(At=document.getElementById("btn-close-modal-add"))==null||At.addEventListener("click",Dt);nt(te(Y(I,ft),ee("dataEmissao","desc")),t=>{O=t.docs.map(e=>({id:e.id,...e.data()})),W()},t=>console.error("Firestore Mercado:",t));nt(Y(I,st),t=>{j=t.docs.map(e=>({id:e.id,...e.data()})),W()},t=>console.error("Firestore Entradas:",t));nt(Y(I,ot),t=>{P=t.docs.map(e=>({id:e.id,...e.data()})),W()},t=>console.error("Firestore Faturas:",t));nt(Y(I,K),t=>{z=t.docs.map(e=>({id:e.id,...e.data()})),W()},t=>console.error("Firestore Boletos:",t));nt(T(I,Mt,"config"),t=>{t.exists()&&(N=t.data()),W()},t=>console.error("Firestore Reservas:",t));nt(Y(I,X),t=>{Z=t.docs.map(e=>({id:e.id,...e.data()})),W()},t=>console.error("Firestore Estimativas:",t));let b=new Date().toISOString().slice(0,7);const Lt=new Set;function rt(){const t=new Set,e=new Date().toISOString().slice(0,7);t.add(e);const o=new Date,a=new Date(o.getFullYear(),o.getMonth()+1,1),n=r=>String(r).padStart(2,"0"),s=`${a.getFullYear()}-${n(a.getMonth()+1)}`;return t.add(s),b&&t.add(b),j.forEach(r=>{r.mesAno&&t.add(r.mesAno)}),P.forEach(r=>{r.mesAno&&t.add(r.mesAno)}),z.forEach(r=>{r.mesAno&&t.add(r.mesAno)}),O.forEach(r=>{r.mesAno&&t.add(r.mesAno)}),Z.forEach(r=>{r.mesAno&&t.add(r.mesAno)}),Array.from(t).filter(r=>!Lt.has(r)).sort().reverse()}window.excluirMesSelecionadoAtual=function(){window.excluirDadosDoMes(b)};window.selecionarMesGlobal=function(t){if(!t)return;b=t;const e=document.getElementById("inp-seletor-mes-global");e&&(e.value=t);const o=document.getElementById("inp-entradas-mes-ano");o&&(o.value=t);const a=document.getElementById("inp-fatura-vencimento");a&&(a.value=`${t}-10`,typeof atualizarMesRefFatura=="function"&&atualizarMesRefFatura());const n=document.getElementById("inp-boleto-vencimento");n&&(n.value=`${t}-10`,typeof atualizarMesRefBoleto=="function"&&atualizarMesRefBoleto()),W()};window.verMesEIrParaControle=function(t){selecionarMesGlobal(t),typeof goTab=="function"&&goTab("mensal")};function re(){const t=document.getElementById("seletor-meses-bar"),e=document.getElementById("seletor-meses-bar-salarios"),o=document.getElementById("seletor-meses-bar-estimativa"),a=rt();a.includes(b)||(b=a[0]||new Date().toISOString().slice(0,7));const n=document.getElementById("inp-seletor-mes-global");n&&n.value!==b&&(n.value=b);const s=document.getElementById("inp-entradas-mes-ano");s&&s.value!==b&&(s.value=b);const r=a.map(i=>{const[c,d]=i.split("-"),m=new Date(parseInt(c),parseInt(d)-1,1).toLocaleString("pt-BR",{month:"short"}).toUpperCase().replace(".",""),E=i===b;return`
    ...
    `);const s=document.getElementById("content-cartoes-mes");if(s){const c=e.reduce((p,m)=>p+(m.valorTotal||0),0),d=e.length?Ut(e,"mes_"+b):"";s.innerHTML=`
      ${d}
      <div class="card" style="margin-bottom:1.5rem">
        <div class="card-header">
                ...
                <div class="purchase-header" onclick="toggleDetail('fat-m-${p.id}')">
                  ...
                  <div class="purchase-values" style="display:flex;align-items:center;gap:.75rem">
                    <div style="text-align:right">
                      <div class="pv-total" style="color:#fb7185">${l(p.valorTotal)}</div>
    ...
    `}const r=document.getElementById("content-boletos-mes");if(r){const c=o.reduce((d,p)=>d+(p.valorTotal||0),0);r.innerHTML=`
      <div class="card" style="margin-bottom:1.5rem">
        <div class="card-header">
    ...
    `}const i=document.getElementById("content-mercado-mes");i&&(i.innerHTML=`
      <div class="card" style="margin-bottom:1.5rem">
        <div class="card-header">
    ...
    `)}function de(){const t=rt();let e=0,o=0,a=0,n=0,s=0;t.forEach(u=>{const v=j.filter(w=>w.mesAno===u).reduce((w,B)=>w+(B.valor||0),0),f=P.filter(w=>w.mesAno===u).reduce((w,B)=>w+(B.valorTotal!==void 0?B.valorTotal:B.valor||0),0),L=z.filter(w=>w.mesAno===u).reduce((w,B)=>w+(B.valorTotal!==void 0?B.valorTotal:B.valor||0),0);let F=0;O.filter(w=>w.mesAno===u).forEach(w=>{w.formasPagamento&&(F+=w.formasPagamento.cartaoDebito||0)});const q=v-f-L-F;e+=v,o+=f,a+=L,n+=F,s+=q});let r=0,i=0;const c={};O.forEach(u=>{const v=u.valorAPagar||0;u.formasPagamento&&(r+=u.formasPagamento.valeAlimentacao||0,i+=u.formasPagamento.cartaoCredito||0);const f=u.mesAno||"Outros";c[f]=(c[f]||0)+v});const d=N&&N.valorAtualGuardado!==void 0?N.valorAtualGuardado:3e3,p=s+d;document.getElementById("fin-total-entradas").textContent=l(e);const m=document.getElementById("fin-subtext-entradas");m&&(m.textContent="Soma Total das Entradas da Tabela Mensal"),document.getElementById("fin-total-cartoes").textContent=l(o),document.getElementById("fin-total-boletos").textContent=l(a),document.getElementById("fin-mercado-debito").textContent=l(n),document.getElementById("fin-saldo-liquido").textContent=l(s),document.getElementById("fin-saldo-liquido").style.color=s>=0?"#60a5fa":"#fb7185";const E=document.getElementById("fin-subtext-saldo");E&&(E.innerHTML=`Saldo Líquido + Reserva Guardada (${l(d)}): <strong style="color:#34d399">${l(p)}</strong>`),document.getElementById("dash-alimentacao").textContent=l(r),document.getElementById("dash-credito").textContent=l(i),document.getElementById("dash-debito").textContent=l(n),ce(),Ft(c)}function ce(){const t=document.getElementById("tabela-resumo-mensal");if(!t)return;const e=rt();if(!e.length){t.innerHTML='<div class="empty-state">Nenhum dado cadastrado ainda.</div>';return}const o=e.map(a=>{const n=j.filter(v=>v.mesAno===a).reduce((v,f)=>v+(f.valor||0),0),s=P.filter(v=>v.mesAno===a).reduce((v,f)=>v+(f.valorTotal!==void 0?f.valorTotal:f.valor||0),0),r=z.filter(v=>v.mesAno===a).reduce((v,f)=>v+(f.valorTotal!==void 0?f.valorTotal:f.valor||0),0);let i=0;O.filter(v=>v.mesAno===a).forEach(v=>{v.formasPagamento&&(i+=v.formasPagamento.cartaoDebito||0)});const c=n-s-r-i,[d,p]=a.split("-"),E=new Date(parseInt(d),parseInt(p)-1,1).toLocaleString("pt-BR",{month:"short"}).toUpperCase().replace(".","");return`
  ...
  `}window.excluirDadosDoMes=async function(t){const e=t||b;if(!e)return;const[o,a]=e.split("-"),s=new Date(parseInt(o),parseInt(a)-1,1).toLocaleString("pt-BR",{month:"long"}),r=`${s.charAt(0).toUpperCase()+s.slice(1)} de ${o}`,i=j.filter(u=>u.mesAno===e),c=P.filter(u=>u.mesAno===e),d=z.filter(u=>u.mesAno===e),p=O.filter(u=>u.mesAno===e),m=Z.filter(u=>u.id===e),E=`⚠️ TEM CERTEZA QUE DESEJA EXCLUIR O MÊS ${r.toUpperCase()} (${e})?
...
Esta ação é irreversível. Confirmar exclusão do mês?`;if(confirm(E))try{const u=[];i.forEach(f=>u.push(H(T(I,st,f.id)))),c.forEach(f=>u.push(H(T(I,ot,f.id)))),d.forEach(f=>u.push(H(T(I,K,f.id)))),p.forEach(f=>u.push(H(T(I,ft,f.id)))),m.forEach(f=>u.push(H(T(I,X,f.id)))),u.length>0&&await Promise.all(u),Lt.add(e),$(`🗑️ O mês ${r} e todos os seus dados foram excluídos com sucesso!`),b=rt()[0]||new Date().toISOString().slice(0,7),W()}catch(u){alert("Erro ao excluir dados do mês: "+u.message)}};function Ft(t){var s;if(typeof Chart>"u")return setTimeout(()=>Ft(t),300);const e=(s=document.getElementById("chart-barras"))==null?void 0:s.getContext("2d");if(!e)return;const o=Object.keys(t).sort(),a=o.map(r=>{const[i,c]=r.split("-");return`${c}/${i}`}),n=o.map(r=>t[r]);ht&&ht.destroy(),ht=new Chart(e,{type:"bar",data:{labels:a.length?a:["Sem compras"],datasets:[{label:"Gasto Mercado R$",data:n.length?n:[0],backgroundColor:"rgba(16,185,129,0.78)",borderColor:"#10b981",borderWidth:2,borderRadius:8}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1},tooltip:{callbacks:{label:r=>` ${l(r.raw)}`}}},scales:{y:{beginAtZero:!0,grid:{color:"rgba(255,255,255,.05)"},ticks:{color:"#94a3b8",callback:r=>"R$"+r}},x:{grid:{display:!1},ticks:{color:"#94a3b8"}}}}})}function qt(t){if(!t)return 0;const e=t.match(/L[íi]quido(?:\s*a\s*receber)?\s*[:\s]*R?\$\s*([\d\.,]+)/i)||t.match(/TOTAL\s*L[IÍ]QUIDO\s*[:\s]*R?\$\s*([\d\.,]+)/i)||t.match(/SAL[ÁA]RIO\s*L[IÍ]QUIDO\s*[:\s]*R?\$\s*([\d\.,]+)/i)||t.match(/VALOR\s*L[IÍ]QUIDO\s*[:\s]*R?\$\s*([\d\.,]+)/i);return e?S(e[1]):0}function me(){const t=document.getElementById("inp-entradas-mes-ano");if(t&&!t.value){const e=new Date,o=e.getFullYear(),a=String(e.getMonth()+1).padStart(2,"0");t.value=`${o}-${a}`}}setTimeout(me,300);let tt="mes";window.toggleFiltroEntradasTabela=function(t){tt=t,Rt()};document.getElementById("form-holerite-victor").addEventListener("submit",async t=>{t.preventDefault();const e=b||document.getElementById("inp-entradas-mes-ano").value||new Date().toISOString().slice(0,7),o=document.getElementById("inp-holerite-txt-victor").value;let a=parseFloat(document.getElementById("inp-salario-val-victor").value)||0;if(!a&&o&&(a=qt(o)),!a){$("⚠️ Digite ou cole um holerite válido com valor.");return}const n=`salario_victor_${e}`;await V(T(I,st,n),{pessoa:"Victor",tipo:"holerite",descricao:`Salário Líquido Victor (${e})`,valor:a,mesAno:e,data:new Date().toISOString()}),document.getElementById("inp-holerite-txt-victor").value="",document.getElementById("inp-salario-val-victor").value="",$(`✅ Salário do Victor (${e}) salvo com sucesso!`)});document.getElementById("form-holerite-maria").addEventListener("submit",async t=>{t.preventDefault();const e=b||document.getElementById("inp-entradas-mes-ano").value||new Date().toISOString().slice(0,7),o=document.getElementById("inp-holerite-txt-maria").value;let a=parseFloat(document.getElementById("inp-salario-val-maria").value)||0;if(!a&&o&&(a=qt(o)),!a){$("⚠️ Digite ou cole um holerite válido com valor.");return}const n=`salario_maria_${e}`;await V(T(I,st,n),{pessoa:"Maria",tipo:"holerite",descricao:`Salário Líquido Maria (${e})`,valor:a,mesAno:e,data:new Date().toISOString()}),document.getElementById("inp-holerite-txt-maria").value="",document.getElementById("inp-salario-val-maria").value="",$(`✅ Salário da Maria (${e}) salvo com sucesso!`)});document.getElementById("form-entrada-manual").addEventListener("submit",async t=>{t.preventDefault();const e=b||document.getElementById("inp-entradas-mes-ano").value||new Date().toISOString().slice(0,7),o=document.getElementById("inp-ent-desc").value.trim(),a=parseFloat(document.getElementById("inp-ent-val").value)||0,n=document.getElementById("inp-ent-pessoa").value;!o||!a||(await gt(Y(I,st),{pessoa:n,tipo:"manual",descricao:o,valor:a,mesAno:e,data:new Date().toISOString()}),t.target.reset(),$(`🎉 Entrada manual (${e}) registrada!`))});function Rt(){var c,d,p;const t=b||((c=document.getElementById("inp-entradas-mes-ano"))==null?void 0:c.value)||new Date().toISOString().slice(0,7),e=document.getElementById("lbl-entradas-mes-ref");if(e){const[m,E]=t.split("-"),v=new Date(parseInt(m),parseInt(E)-1,1).toLocaleString("pt-BR",{month:"long"}),f=v.charAt(0).toUpperCase()+v.slice(1);e.textContent=`Visualizando e inserindo entradas para: ${f} de ${m}`}const o=((d=j.find(m=>m.pessoa==="Victor"&&m.tipo==="holerite"&&m.mesAno===t))==null?void 0:d.valor)||0,a=((p=j.find(m=>m.pessoa==="Maria"&&m.tipo==="holerite"&&m.mesAno===t))==null?void 0:p.valor)||0,n=j.filter(m=>m.mesAno===t),s=n.reduce((m,E)=>m+(E.valor||0),0);document.getElementById("val-salario-victor").textContent=l(o),document.getElementById("val-salario-maria").textContent=l(a),document.getElementById("val-entradas-combinado").textContent=`${l(s)}`;const r=document.getElementById("lista-entradas-registradas");if(!r)return;const i=tt==="mes"?n:j;if(!i.length){r.innerHTML=`
...
`).forEach(n=>{const s=n.trim();if(!s||/EMISS[ÃA]O|TRANSA[ÇC][ÕO]ES|RESUMO|PAGAMENTO DE FATURA|TOTAL DA FATURA|FATURA ANTERIOR|SALDO ANTERIOR|LIMITE DISPON[ÍI]VEL|OPÇÕES DE PAGAMENTO|ALTERNATIVAS DE PAGAMENTO|PAGAMENTO E DEMAIS|PARCELAMENTOS|DESPESAS|HISTÓRICO DE FATURAS|SUPERCRÉDITO|SAQUE À CRÉDITO|COMPRA DATA DESCRIÇÃO/i.test(s))return;const r=/(?:[@\)\(\*•\s]+)?(\d{2}[\/\.-]\d{2}(?:[\/\.-]\d{2,4})?|\d{2}\s+[A-Za-z]{3})\s+(.+?)\s+(?:(\d{2}\/\d{2})\s+)?(-?R?\$\s*[\d\.]+,\d{2}|-?[\d\.]+,\d{2})$/i,i=s.match(r)||s.match(/(?:[@\)\(\*•\s]+)?(\d{2}[\/\.-]\d{2}(?:[\/\.-]\d{2,4})?|\d{2}\s+[A-Za-z]{3})\s+(.+?)\s+(?:(\d{2}\/\d{2})\s+)?(-?R?\$\s*[\d\.]+,\d{2}|-?[\d\.]+,\d{2})/i);if(i){const c=i[1];let d=i[2].trim();const p=i[3],m=i[4];if(m.includes("-")||/DEB AUTOM|PAGAMENTO|PAGTO|CR[ÉE]DITO FATURA/i.test(d))return;const E=S(m);p&&(d+=` (${p})`),d&&E>0&&d.length>2&&!/fatura|limite|pagamento|saldo|alternativas|opções|período|emissão|vencimento/i.test(d)&&e.push({dataCompra:c,descricao:d,valor:E})}}),e.length===0){let n;for(;(n=o.exec(t))!==null;){const s=n[1];let r=n[2].trim();const i=n[3],c=n[4];if(c.includes("-")||/DEB AUTOM|PAGAMENTO|PAGTO|CR[ÉE]DITO FATURA/i.test(r))continue;const d=S(c);i&&(r+=` (${i})`),r&&d>0&&r.length>2&&!/fatura|limite|pagamento|saldo|alternativas|opções|período|emissão|vencimento/i.test(r)&&e.push({dataCompra:s,descricao:r,valor:d})}}return e}window.ultimosLocaisAnalisados={};function fe(t){if(!t)return"DIVERSOS";let e=t.replace(/\(\d{1,2}\/\d{1,2}\)/gi,"").replace(/\b\d{1,2}\/\d{1,2}\b/gi,"").replace(/\b\d{1,2}x\b/gi,"").trim();return e=e.replace(/\s+/g," "),e.toUpperCase()}function Pt(t){const e={};(Array.isArray(t)?t:[t]).forEach(n=>{!n||!n.itens||!Array.isArray(n.itens)||n.itens.forEach(s=>{if(!s.descricao||!s.valor)return;const r=fe(s.descricao);e[r]||(e[r]={nome:r,qtd:0,valorTotal:0,compras:[]}),e[r].qtd+=1,e[r].valorTotal+=s.valor||0,e[r].compras.push({dataCompra:s.dataCompra||"—",descricao:s.descricao,valor:s.valor||0,cartao:n.cartao||"Cartão",mesAno:n.mesAno||"—"})})});const a=Object.values(e).filter(n=>n.qtd>=2);return a.sort((n,s)=>s.valorTotal-n.valorTotal),a}function Ut(t,e="geral"){const o=Pt(t);if(o.forEach(n=>{window.ultimosLocaisAnalisados[`${e}_${n.nome}`]=n}),!o.length)return`
  ...
  `,o.style.display="flex"};window.fecharModalEstabelecimento=function(){const t=document.getElementById("modal-detalhes-estabelecimento");t&&(t.style.display="none")};function be(){const t=P.reduce((a,n)=>a+(n.valorTotal!==void 0?n.valorTotal:n.valor||0),0);document.getElementById("badge-total-cartoes").textContent=`${l(t)} total`;const e=document.getElementById("lista-faturas-registradas");if(!P.length){e.innerHTML='<div class="empty-state">Nenhuma fatura cadastrada ainda.</div>';return}const o=Ut(P,"geral");e.innerHTML=o+P.map(a=>{var m;const n=a.valorTotal!==void 0?a.valorTotal:a.valor||0,s=a.cartao||"Cartão",r=s.toLowerCase().includes("nubank"),i=r?"purple":"red",c=r?"🟣":"🔴",d=a.dataVencimento?mt(a.dataVencimento).split(",")[0]:"—",p=a.mesAno||"—";return`
      <div class="purchase-card" style="margin-bottom:1rem">
        <div class="purchase-header" onclick="toggleDetail('fat-${a.id}')">
          <div class="purchase-info">
            <h3><span class="badge ${i}">${c} ${s}</span> — Vencimento: ${d}</h3>
    ...
    `}).join("")}function Vt(t){if(t.itens&&t.itens.length>0){const e=Pt([t]),o=`fatura_${t.id}`;e.forEach(n=>{window.ultimosLocaisAnalisados[`${o}_${n.nome}`]=n});let a="";return e.length>0&&(a=`
    ...
    `).join("");const a=document.getElementById("box-revisao-boleto");a.style.display="block",a.scrollIntoView({behavior:"smooth"})}window.removerItemRevisaoBoleto=function(t){if(!D||!D.itens)return;D.itens.splice(t,1);const e=D.itens.reduce((o,a)=>o+a.valor,0);e>0&&(D.valorTotal=e,document.getElementById("inp-revisao-boleto-val").value=e.toFixed(2)),D.qtdItens=D.itens.length,jt(),$("🗑️ Item removido da revisão do boleto.")};window.confirmarEGravarBoletoDocumento=async function(){if(!D)return;const t=document.getElementById("inp-revisao-boleto-desc").value.trim(),e=parseFloat(document.getElementById("inp-revisao-boleto-val").value)||0,o=document.getElementById("inp-boleto-vencimento").value||new Date().toISOString().slice(0,10);if(!e){$("⚠️ Digite ou confirme o valor total do boleto.");return}D.descricao=t||"Boleto / Conta",D.valorTotal=e,D.dataVencimento=o,D.mesAno=o.slice(0,7);try{await gt(Y(I,K),{...D,createdAt:yt()}),document.getElementById("box-revisao-boleto").style.display="none",document.getElementById("inp-boleto-txt").value="";const a=document.getElementById("txt-file-boleto");a&&(a.textContent="Clique para Selecionar o Arquivo do Boleto");const n=l(D.valorTotal);D=null,$(`🎉 Boleto de ${n} salvo com sucesso!`)}catch(a){alert("Erro ao salvar boleto: "+a.message)}};function ye(t){if(!t)return{beneficiario:"",valorTotal:0,vencimento:null,itens:[]};let e="",o=0,a=null;const n=[],s=t.match(/Vencimento\s*[:\s]*(\d{2}[\/\.-]\d{2}[\/\.-]\d{4})/i)||t.match(/Vencimento\s*[:\s]*(\d{2})\s+([A-Za-z]{3})\s+(\d{4})/i)||t.match(/Data\s*de\s*Vencimento\s*[:\s]*(\d{2}[\/\.-]\d{2}[\/\.-]\d{4})/i);if(s){if(s[2]&&s[3]){const d=s[1],p=s[2].toUpperCase();a=`${s[3]}-${{JAN:"01",FEB:"02",MAR:"03",ABR:"04",APR:"04",MAI:"05",MAY:"05",JUN:"06",JUL:"07",AGO:"08",AUG:"08",SET:"09",SEP:"09",OUT:"10",OCT:"10",NOV:"11",DEZ:"12",DEC:"12"}[p]||"07"}-${d.padStart(2,"0")}`}else if(s[1]){const[d,p,m]=s[1].split(/[\/\.-]/);a=`${m}-${p.padStart(2,"0")}-${d.padStart(2,"0")}`}}const r=t.match(/Benefici[áa]rio\s*[:\s]*([^\n\r]+)/i)||t.match(/Nome\s*do\s*Cedente\s*[:\s]*([^\n\r]+)/i)||t.match(/Raz[ãa]o\s*Social\s*[:\s]*([^\n\r]+)/i);r&&(e=r[1].trim().replace(/\s{2,}/g," "));const i=t.match(/Valor\s*do\s*Documento\s*[:\s]*R?\$\s*([\d\.]+,\d{2})/i)||t.match(/\(=\)\s*Valor\s*Cobrado\s*[:\s]*R?\$\s*([\d\.]+,\d{2})/i)||t.match(/Valor\s*Cobrado\s*[:\s]*R?\$\s*([\d\.]+,\d{2})/i)||t.match(/Valor\s*R?\$\s*([\d\.]+,\d{2})/i);return i&&(o=S(i[1])),t.split(`
`).forEach(d=>{const p=d.trim();if(!p||/vencimento|beneficiário|cedente|nosso\s*número|agência|código|autenticação|instruções/i.test(p))return;const m=p.match(/(\d{2}[\/\.-]\d{2}(?:[\/\.-]\d{2,4})?|\b[A-Za-z]{3}\b)?\s*(.+?)\s+R?\$\s*([\d\.]+,\d{2})$/i);if(m){const E=m[1]||"Boleto",u=m[2].trim(),v=S(m[3]);u&&v>0&&u.length>2&&!/valor|total|documento|cobrado/i.test(u)&&n.push({dataBoleto:E,descricao:u,valor:v})}}),{beneficiario:e,valorTotal:o,vencimento:a,itens:n}}function Ee(){const t=z.reduce((a,n)=>a+(n.valorTotal!==void 0?n.valorTotal:n.valor||0),0);document.getElementById("badge-total-boletos").textContent=`${l(t)} total`;const e=document.getElementById("lista-boletos-registrados");if(!z.length){e.innerHTML='<div class="empty-state">Nenhum boleto cadastrado ainda.</div>';return}const o=[...z].sort((a,n)=>{const s=a.dataVencimento?new Date(a.dataVencimento).getTime():a.mesAno?new Date(a.mesAno+"-01").getTime():0;return(n.dataVencimento?new Date(n.dataVencimento).getTime():n.mesAno?new Date(n.mesAno+"-01").getTime():0)-s});e.innerHTML=o.map(a=>{var c;const n=a.valorTotal!==void 0?a.valorTotal:a.valor||0,s=a.dataVencimento?mt(a.dataVencimento).split(",")[0]:"—",r=a.mesAno||"—",i=a.descricao||"Boleto / Conta";return`
      <div class="purchase-card">
        <div class="purchase-header" onclick="toggleDetail('bol-${a.id}')">
          <div class="purchase-info">
            <h3><span class="badge purple">📄 ${i}</span> — Vencimento: ${s}</h3>
  ...
  </table></div>`}window.editarValorBoletoDocumento=async function(t){const e=z.find(s=>s.id===t);if(!e)return;const o=e.valorTotal!==void 0?e.valorTotal:e.valor||0,a=prompt(`✏️ Editar valor do boleto "${e.descricao||"Boleto"}":`,o.toFixed(2));if(a===null)return;const n=typeof S=="function"?S(a):parseFloat(a.replace(",","."));if(isNaN(n)||n<=0){alert("Por favor, informe um valor numérico válido maior que zero.");return}try{const s=T(I,K,t),r={valorTotal:n,valor:n,dataAtualizacao:new Date().toISOString()};if(e.itens&&e.itens.length>0){const i=[...e.itens];i[0]={...i[0],valor:n},r.itens=i}await V(s,r,{merge:!0}),$(`✏️ Valor do boleto atualizado para ${l(n)} em todo o sistema!`)}catch(s){alert("Erro ao atualizar valor do boleto: "+s.message)}};window.editarItemBoleto=async function(t,e){const o=z.find(i=>i.id===t);if(!o||!o.itens||!o.itens[e])return;const a=o.itens[e],n=a.valor||0,s=prompt(`✏️ Editar valor do item "${a.descricao}":`,n.toFixed(2));if(s===null)return;const r=typeof S=="function"?S(s):parseFloat(s.replace(",","."));if(isNaN(r)||r<=0){alert("Por favor, informe um valor numérico válido maior que zero.");return}try{const i=[...o.itens];i[e]={...i[e],valor:r};const c=i.reduce((d,p)=>d+(p.valor||0),0);await V(T(I,K,t),{...o,itens:i,valorTotal:c,valor:c,dataAtualizacao:new Date().toISOString()},{merge:!0}),$(`✏️ Item do boleto atualizado para ${l(r)} em todo o sistema!`)}catch(i){alert("Erro ao atualizar item do boleto: "+i.message)}};window.removerItemBoletoCadastrado=async function(t,e){const o=z.find(s=>s.id===t);if(!o||!o.itens||!confirm("Remover este item do boleto?"))return;const a=[...o.itens];a.splice(e,1);const n=a.reduce((s,r)=>s+(r.valor||0),0);a.length===0?(await H(T(I,K,t)),$("🗑️ Boleto excluído pois todos os itens foram removidos.")):(await V(T(I,K,t),{...o,itens:a,valorTotal:n,qtdItens:a.length}),$("🗑️ Item removido do boleto."))};window.excluirBoletoDocumento=async function(t){const e=z.find(n=>n.id===t),o=e?e.descricao||"Boleto / Conta":"este boleto",a=e?l(e.valorTotal!==void 0?e.valorTotal:e.valor||0):"";confirm(`⚠️ Deseja realmente excluir ${o} ${a?"("+a+")":""}?

Este boleto será removido permanentemente de todos os meses, resumos e relatórios do sistema.`)&&(await H(T(I,K,t)),$("🗑️ Boleto removido de todo o sistema com sucesso."))};document.getElementById("form-config-reservas").addEventListener("submit",async t=>{t.preventDefault();const e=parseFloat(document.getElementById("inp-meta-anual").value)||0,o=parseFloat(document.getElementById("inp-saldo-guardado").value)||0;N.metaAnual=e,N.valorAtualGuardado=o,await V(T(I,Mt,"config"),{metaAnual:e,valorAtualGuardado:o,dataAtualizacao:new Date().toISOString()}),$("✅ Reservas e configurações de economias salvas!"),W()});function $e(){const t=N&&N.metaAnual!==void 0?N.metaAnual:15e3,e=N&&N.valorAtualGuardado!==void 0?N.valorAtualGuardado:3e3,o=document.getElementById("inp-meta-anual");o&&document.activeElement!==o&&(o.value=t);const a=document.getElementById("inp-saldo-guardado");a&&document.activeElement!==a&&(a.value=e);const s=new Date().getMonth()+1,r=Math.max(1,12-s+1),i=Math.max(0,t-e),c=i>0?i/r:0;document.getElementById("val-meta-reserva").textContent=l(c);const d=document.getElementById("subtext-meta-reserva");d&&(d.textContent=`Faltam ${l(i)} p/ Meta Anual de ${l(t)} (${r} mês(es) até o fim do ano)`),document.getElementById("val-real-guardado").textContent=l(e);const p=rt();let m=0,E=0,u=0,v=0;p.forEach(C=>{const G=j.filter(y=>y.mesAno===C).reduce((y,A)=>y+(A.valor||0),0),k=P.filter(y=>y.mesAno===C).reduce((y,A)=>y+(A.valorTotal!==void 0?A.valorTotal:A.valor||0),0),R=z.filter(y=>y.mesAno===C).reduce((y,A)=>y+(A.valorTotal!==void 0?A.valorTotal:A.valor||0),0);let g=0;O.filter(y=>y.mesAno===C).forEach(y=>{y.formasPagamento&&(g+=y.formasPagamento.cartaoDebito||0)}),m+=G,E+=k,u+=R,v+=g});const f=E+u+v,L=m-f,F=Math.max(1,p.length),q=L/F,w=q>0?q*.5:0,B=w*12;document.getElementById("val-recomendacao-reserva").textContent=l(B);const h=document.getElementById("subtext-recomendacao");h&&(h.textContent=`Sugerido poupar ${l(w)}/mês (${l(B)} no ano)`);const x=document.getElementById("box-analise-reserva-detalhes");if(x)if(m===0)x.innerHTML='<p class="empty-state">Cadastre seus salários e entradas na aba "Salários & Entradas" para gerar o diagnóstico inteligente de economias.</p>';else{const C=t>0?Math.min(100,e/t*100).toFixed(1):0;x.innerHTML=`
        <p style="margin-bottom:.5rem;font-weight:600">
          Com base na soma acumulada de todos os meses (<strong>${l(m)}</strong> Entradas vs <strong>${l(f)}</strong> Saídas Totais):
        </p>
        <div style="background:rgba(15,23,42,0.6);padding:1.1rem;border-radius:10px;margin:.75rem 0;border:1px solid var(--border-color)">
          <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:.6rem;flex-wrap:wrap;gap:.75rem">
            <div>
              ...
              <strong style="font-size:1.15rem;color:#60a5fa">${l(L)}</strong>
            </div>
            <div>
          ...
          <div style="display:flex;justify-content:space-between;font-size:.82rem;color:var(--text-muted);margin-top:.4rem;flex-wrap:wrap;gap:.5rem">
            <span>Progresso da Meta: <strong style="color:#34d399">${l(e)}</strong> de ${l(t)} (<strong>${C}%</strong> concluído)</span>
        ...
        <p style="font-size:.85rem;color:var(--text-muted);line-height:1.45">
          💡 <strong>Planejamento do Sistema:</strong> Guardando <strong style="color:#34d399">${l(c)}/mês</strong> durante os próximos <strong>${r} mês(es)</strong>, você atingirá com 100% de precisão sua Meta Anual de <strong>${l(t)}</strong> (considerando seu saldo atual guardado de <strong>${l(e)}</strong>)!
        </p>
      `}xe()}function xe(){const t=document.getElementById("container-analise-mensal-lista");if(!t)return;const e=rt();if(!e.length){t.innerHTML='<div class="empty-state">Nenhum mês registrado para gerar a análise mensal.</div>';return}const o=e.map(a=>{const s=j.filter(h=>h.mesAno===a).reduce((h,x)=>h+(x.valor||0),0),r=P.filter(h=>h.mesAno===a),i=r.reduce((h,x)=>h+(x.valorTotal!==void 0?x.valorTotal:x.valor||0),0),c=z.filter(h=>h.mesAno===a),d=c.reduce((h,x)=>h+(x.valorTotal!==void 0?x.valorTotal:x.valor||0),0),p=O.filter(h=>h.mesAno===a);let m=0;p.forEach(h=>{h.formasPagamento&&(m+=h.formasPagamento.cartaoDebito||0)});const E=i+d+m,u=s-E,v=u>=0,[f,L]=a.split("-"),q=new Date(parseInt(f),parseInt(L)-1,1).toLocaleString("pt-BR",{month:"long"}),w=q.charAt(0).toUpperCase()+q.slice(1);let B="";if(v){const h=u*.5;B=`
        <div style="background:rgba(16,185,129,0.08); border:1px solid rgba(16,185,129,0.25); border-radius:10px; padding:.85rem 1rem; margin-top:1rem">
          ...
          <p style="font-size:.8rem; color:var(--text-muted); margin:0">
            Neste mês sobraram <strong>${l(u)}</strong> em conta. O sistema sugere destinar pelo menos <strong style="color:#34d399">${l(h)}</strong> para sua reserva!
          </p>
        </div>
      `}else{const h=Math.abs(u);let x="Cartão de Crédito",C=i;d>C&&(x="Boletos & Contas",C=d),m>C&&(x="Mercado no Débito",C=m);const G=E>0?(C/E*100).toFixed(1):0;let k="",R=0;r.forEach(g=>{const y=g.valorTotal!==void 0?g.valorTotal:g.valor||0;y>R&&(R=y,k=`Fatura do ${g.cartao||"Cartão"}`)}),c.forEach(g=>{const y=g.valorTotal!==void 0?g.valorTotal:g.valor||0;y>R&&(R=y,k=`Boleto ${g.descricao||"de Conta"}`)}),B=`
        <div style="background:rgba(244,63,94,0.1); border:1px solid rgba(244,63,94,0.3); border-radius:10px; padding:.85rem 1rem; margin-top:1rem">
          ...
          <p style="font-size:.82rem; color:var(--text-main); margin-bottom:.5rem; line-height:1.5">
            As saídas (<strong>${l(E)}</strong>) superaram as entradas (<strong>${l(s)}</strong>) em <strong style="color:#fb7185">${l(h)}</strong>.
          </p>
          <div style="font-size:.78rem; color:var(--text-muted); line-height:1.5">
            • <strong>Vilão Principal:</strong> A categoria <strong style="color:#f8fafc">${x}</strong> representou <strong>${G}%</strong> de todas as saídas do mês (${l(C)}).
            ${k?`<br>• <strong>Maior Despesa Registrada:</strong> ${k} no valor de <strong style="color:#fb7185">${l(R)}</strong>.`:""}
          </div>
        </div>
      `}return`
      <div class="card" style="margin-bottom:1.25rem; border-color:${v?"rgba(52,211,153,0.3)":"rgba(251,113,133,0.4)"}">
        ...
        <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(160px, 1fr)); gap:.75rem; margin-top:.5rem">
          ...
          <div style="background:rgba(15,23,42,0.8); padding:.6rem .8rem; border-radius:8px; border:1px solid ${v?"#34d399":"#fb7185"}">
            ...
            <div style="font-weight:800; font-size:1.05rem; color:${v?"#60a5fa":"#fb7185"}">${l(u)}</div>
          </div>
        </div>
    ...
    <div class="card" style="margin-bottom:1.5rem; background: linear-gradient(135deg, rgba(30,41,59,0.9), rgba(15,23,42,0.95)); border: 1px solid #3b82f6;">
      ...
      <div class="payment-grid" style="margin-top:1rem;">
        <div class="payment-item" style="border-color: rgba(16,185,129,0.4);">
          ...
          <div class="p-val" style="color:#34d399;">${l(C)} <span style="font-size:0.75rem;font-weight:normal;color:var(--text-muted)">/ ${l(d)}</span></div>
        </div>
        <div class="payment-item" style="border-color: rgba(99,102,241,0.4);">
          <div class="p-label">💳 Cartão Crédito (${r}d × R$ 20,00)</div>
          <div class="p-val" style="color:#818cf8;">${l(G)} <span style="font-size:0.75rem;font-weight:normal;color:var(--text-muted)">/ ${l(p)}</span></div>
        </div>
  ...
  `;window.dadosListaMensalCache={mesAnoStr:s,diasUteis:r,totalGeralEstimado:h,cobertoAlim:C,cobertoCred:G,cobertoDeb:k,alimDisponivel:d,credDisponivel:p,lista:B},B.length===0?R+='<div class="empty-state">Adicione notas fiscais para que o sistema gere automaticamente sua lista mensal de compras.</div></div>':R+=`
      <div class="table-responsive">
        <table class="custom-table">
          <thead>
            <tr>
  ...
  `;i.document.open(),i.document.write(c),i.document.close()};document.getElementById("btn-start-cam").addEventListener("click",Gt);document.getElementById("btn-switch-cam").addEventListener("click",Ae);document.getElementById("btn-stop-cam").addEventListener("click",$t);async function Gt(){if(typeof Html5Qrcode>"u")return U("Carregando biblioteca de câmera, aguarde..."),setTimeout(Gt,600);try{J||(J=new Html5Qrcode("qr-reader")),Q=await Html5Qrcode.getCameras();let t;if(Q&&Q.length>0){const e=Q.findIndex(o=>/back|traseira|rear|environment/i.test(o.label));dt=e>=0?e:0,t=Q[dt].id}else t={facingMode:"environment"};await J.start(t,{fps:10,qrbox:{width:240,height:240}},_t,()=>{}),ct=!0,document.getElementById("btn-start-cam").style.display="none",document.getElementById("btn-switch-cam").style.display=Q.length>1?"inline-flex":"none",document.getElementById("btn-stop-cam").style.display="inline-flex"}catch(t){U("❌ Não foi possível acessar a câmera. Verifique as permissões do navegador."),console.error(t)}}async function Ae(){if(!(!J||!ct))try{await J.stop(),Q.length>1&&(dt=(dt+1)%Q.length,await J.start(Q[dt].id,{fps:10,qrbox:{width:240,height:240}},_t,()=>{}))}catch(t){console.error("switchCam:",t)}}async function $t(){if(J&&ct)try{await J.stop()}catch{}ct=!1,document.getElementById("btn-start-cam").style.display="inline-flex",document.getElementById("btn-switch-cam").style.display="none",document.getElementById("btn-stop-cam").style.display="none"}async function _t(t){$t(),document.getElementById("inp-url").value=t,U("✅ QR Code lido! Processando..."),await Yt(t)}document.getElementById("btn-carregar-dados").addEventListener("click",async()=>{const t=document.getElementById("inp-url").value.trim(),e=document.getElementById("inp-html").value.trim();if(!t&&!e){U("⚠️ Cole a URL do QR Code ou o conteúdo da página para ler a nota fiscal.");return}if(t&&!e){U("⏳ Consultando nota fiscal..."),await Yt(t);return}if(e){U("⏳ Processando conteúdo..."),await Zt(e);return}});document.getElementById("btn-preencher-manual").addEventListener("click",()=>{Qt({nomeMercado:"",dataEmissao:new Date().toISOString(),valorTotal:0,descontoTotal:0,valorAPagar:0,qtdTotalItens:0,formasPagamento:{valeAlimentacao:0,cartaoCredito:0,cartaoDebito:0},itens:[]}),U("✍️ Preencha os dados da compra abaixo e clique em Salvar Nota Fiscal.","var(--accent-cyan)")});function Qt(t){var s,r,i;document.getElementById("inp-mercado").value=t.nomeMercado||"",document.getElementById("inp-data").value=ne(t.dataEmissao),document.getElementById("inp-vtotal").value=t.valorTotal!==void 0?t.valorTotal:0,document.getElementById("inp-desconto").value=t.descontoTotal!==void 0?t.descontoTotal:0,document.getElementById("inp-pagar").value=t.valorAPagar!==void 0?t.valorAPagar:0,document.getElementById("inp-qtd").value=t.qtdTotalItens!==void 0?t.qtdTotalItens:0,document.getElementById("inp-alim").value=((s=t.formasPagamento)==null?void 0:s.valeAlimentacao)||0,document.getElementById("inp-cred").value=((r=t.formasPagamento)==null?void 0:r.cartaoCredito)||0,document.getElementById("inp-deb").value=((i=t.formasPagamento)==null?void 0:i.cartaoDebito)||0,et=t.itens||[];const e=document.getElementById("form-nfce");e.style.display="block";const o=document.getElementById("preview-itens-box"),a=document.getElementById("count-preview-itens"),n=document.getElementById("lista-preview-itens");et.length>0?(o.style.display="block",a.textContent=et.length,n.innerHTML=et.map(c=>`
    ...
    `).join("")):o.style.display="none",e.scrollIntoView({behavior:"smooth"})}document.getElementById("form-nfce").addEventListener("submit",async t=>{t.preventDefault();const e=document.getElementById("inp-mercado").value.trim()||"Mercado",o=document.getElementById("inp-data").value||new Date().toISOString(),a=parseFloat(document.getElementById("inp-vtotal").value)||0,n=parseFloat(document.getElementById("inp-desconto").value)||0,s=parseFloat(document.getElementById("inp-pagar").value)||0,r=parseInt(document.getElementById("inp-qtd").value)||0,i=parseFloat(document.getElementById("inp-alim").value)||0,c=parseFloat(document.getElementById("inp-cred").value)||0,d=parseFloat(document.getElementById("inp-deb").value)||0,p=new Date(o).toISOString().slice(0,16),m=O.find(v=>{const f=new Date(v.dataEmissao).toISOString().slice(0,16),L=Math.abs((v.valorAPagar||0)-s)<.05,F=(v.nomeMercado||"").toLowerCase().trim()===e.toLowerCase().trim();return f===p&&L&&F});if(m){U(`⚠️ Esta nota fiscal já existe no sistema (Cadastrada em ${mt(m.dataEmissao)} no valor de ${l(m.valorAPagar)}). Nota não adicionada!`,"#fb7185"),$("⚠️ Nota fiscal já cadastrada! Operação cancelada.");return}const E=new Date(o),u=`${E.getFullYear()}-${String(E.getMonth()+1).padStart(2,"0")}`;U("⏳ Salvando nota fiscal no banco...");try{await gt(Y(I,ft),{nomeMercado:e,dataEmissao:o,mesAno:u,qtdTotalItens:r||et.length,valorTotal:a,descontoTotal:n,valorAPagar:s,formasPagamento:{valeAlimentacao:i,cartaoCredito:c,cartaoDebito:d},itens:et,createdAt:yt()}),U("✅ Nota salva com sucesso!","#34d399"),document.getElementById("form-nfce").style.display="none",document.getElementById("form-nfce").reset(),document.getElementById("inp-url").value="",document.getElementById("inp-html").value="",et=[],Dt(),goTab("dashboard"),$("🎉 Nota fiscal registrada no Firebase!")}catch(v){U("❌ Erro ao salvar: "+v.message,"#fb7185")}});async function Yt(t){const e=[o=>`https://api.allorigins.win/raw?url=${encodeURIComponent(o)}`,o=>`https://corsproxy.io/?${encodeURIComponent(o)}`];for(const o of e)try{const a=await fetch(o(t),{signal:AbortSignal.timeout(8e3)});if(a.ok){const n=await a.text();if(n&&n.length>200){await Zt(n);return}}}catch{}Be(t)}function Be(t){document.getElementById("modal-link").href=t,document.getElementById("modal-cors").classList.add("active"),U("⚠️ Abra o link, copie o conteúdo da página e cole no campo de texto abaixo.")}async function Zt(t){const e=Te(t);Qt(e),U("✅ Nota lida com sucesso! Confira os valores abaixo e altere se necessário antes de Salvar.","#34d399")}function Te(t){var C,G,k;const o=new DOMParser().parseFromString(t,"text/html"),a=((C=o.body)==null?void 0:C.textContent)||t;let n=((k=(G=o.querySelector(".txtTopo, .nomeEmit, h1"))==null?void 0:G.textContent)==null?void 0:k.trim())||"Mercado",s=new Date().toISOString();const r=a.match(/Emiss[ãa]o\s*[:\-]?\s*(\d{2}\/\d{2}\/\d{4})\s+(\d{2}:\d{2}:\d{2})?/i)||a.match(/(\d{2}\/\d{2}\/\d{4})\s+(\d{2}:\d{2}:\d{2})/);if(r){const[R,g,y]=r[1].split("/");s=`${y}-${g}-${R}T${r[2]||"12:00:00"}`}const i=a.match(/Qtd\.?\s*total\s*de\s*itens\s*[:\s]*([\d,\.]+)/i),c=a.match(/Valor\s*total\s*R\$\s*[:\s]*([\d\.,]+)/i),d=a.match(/Descontos?\s*R\$\s*[:\s]*([\d\.,]+)/i),p=a.match(/Valor\s*a\s*pagar\s*R\$\s*[:\s]*([\d\.,]+)/i)||a.match(/VALOR\s*PAGO\s*R\$\s*[:\s]*([\d\.,]+)/i),m=a.match(/(?:Vale\s*)?Alimenta[çc][ãa]o\s*[:\s]*([\d\.,]+)/i),E=a.match(/(?:Cart[ãa]o\s*de\s*)?Cr[eé]dito\s*[:\s]*([\d\.,]+)/i),u=a.match(/(?:Cart[ãa]o\s*de\s*)?D[eé]bito\s*[:\s]*([\d\.,]+)/i),v=i?S(i[1]):0,f=c?S(c[1]):0,L=d?S(d[1]):0;let F=p?S(p[1]):f-L;const q={valeAlimentacao:m?S(m[1]):0,cartaoCredito:E?S(E[1]):0,cartaoDebito:u?S(u[1]):0},w=[];o.querySelectorAll("tr, .item, .itemNota").forEach(R=>{var xt;const g=R.textContent;if(!/Vl\.\s*Unit|valorUnitario|Qtde?\./i.test(g))return;const y=R.querySelector(".txtTit, .txtTit2, .nomeProd"),A=((xt=y==null?void 0:y.textContent)==null?void 0:xt.trim())||"",at=g.match(/Qtde?\.\s*[:\s]*([\d,\.]+)/i),ut=g.match(/Vl\.\s*Unit\.\s*[:\s]*([\d,\.]+)/i),_=g.match(/Vl\.\s*Total\s*([\d,\.]+)/i),it=g.match(/C[oó]digo\s*[:\s]*(\d+)/i),lt=g.match(/UN\s*[:\s]*([A-Za-z]+)/i),pt=at?S(at[1]):1,bt=ut?S(ut[1]):0,Jt=_?S(_[1]):bt*pt;A&&bt>0&&w.push({codigo:(it==null?void 0:it[1])||"",nome:A,marca:Ce(A),quantidade:pt,unidade:(lt==null?void 0:lt[1])||"Un",valorUnitario:bt,valorTotal:Jt})});const h=new Date(s),x=`${h.getFullYear()}-${String(h.getMonth()+1).padStart(2,"0")}`;return{nomeMercado:n,dataEmissao:s,mesAno:x,qtdTotalItens:v,valorTotal:f,descontoTotal:L,valorAPagar:F,formasPagamento:q,itens:w}}function Ce(t){const e=["BAUDUCCO","BAUD","PANCO","DANONE","NESTLE","QUALITA","SADIA","PERDIGAO","SEARA","CAMIL","TIO JOAO","URBANO","LIZA","SOYA","YPE","PILAO","MELITTA","3 CORACOES","VIGOR","PARMALAT","ITALAC","HEINZ","KRAFT"],o=t.toUpperCase();for(const a of e)if(o.includes(a))return a;return o.split(" ")[0]||"Genérica"}function Me(){const t=document.getElementById("lista-historico");if(!O.length){t.innerHTML='<div class="empty-state">📭 Nenhuma compra cadastrada ainda.</div>';return}t.innerHTML=O.map(e=>{var o,a,n;return`
    <div class="purchase-card">
    ...
    <tbody>${o.map(a=>{const n=Object.keys(a.hist).sort();let s=n.map(i=>`${i}: <strong>${l(a.hist[i])}</strong>`).join(" → "),r='<span class="badge cyan">Estável</span>';if(n.length>=2){const i=a.hist[n[n.length-2]],d=a.hist[n[n.length-1]]-i,p=(d/i*100).toFixed(1);d>.01?r=`<span class="badge red">+${p}% ↑</span>`:d<-.01&&(r=`<span class="badge green">${p}% ↓</span>`)}return`<tr><td><strong>${a.nome}</strong></td><td><span class="badge amber">${a.marca||"—"}</span></td><td>${s}</td><td>${r}</td></tr>`}).join("")}</tbody>
  </table></div>`}function De(){const t=document.getElementById("lista-recorrencia"),e=document.getElementById("lista-marcas"),o={},a={};O.forEach(r=>{(r.itens||[]).forEach(i=>{var m;const c=(m=i.nome)==null?void 0:m.toLowerCase().trim();if(!c)return;o[c]||(o[c]={nome:i.nome,marca:i.marca,qtd:0,notas:0,units:[]}),o[c].qtd+=i.quantidade||1,o[c].notas+=1,o[c].units.push(i.valorUnitario||0);const d=(i.nome||"").split(" ")[0].toUpperCase();a[d]||(a[d]={});const p=i.marca||"Genérica";a[d][p]||(a[d][p]=[]),a[d][p].push(i.valorUnitario||0)})});const n=Object.values(o).filter(r=>r.notas>1).sort((r,i)=>i.notas-r.notas);t.innerHTML=n.length?`<div class="table-responsive"><table class="custom-table">
        <thead><tr><th>Item</th><th>Marca</th><th>Compras</th><th class="num">Qtd Total</th><th class="num">Média Unitária</th></tr></thead>
        <tbody>${n.map(r=>{const i=r.units.reduce((c,d)=>c+d,0)/r.units.length;return`<tr>
      ...
      </table></div>`:'<div class="empty-state">Adicione notas para ver a recorrência de itens.</div>';const s=Object.entries(a).filter(([,r])=>Object.keys(r).length>1).map(([r,i])=>{let c=1/0,d="";const p=Object.entries(i).map(([m,E])=>{const u=E.reduce((v,f)=>v+f,0)/E.length;return u<c&&(c=u,d=m),{marca:m,med:u}});return`<div class="brand-card">
      <div class="brand-card-header">
        <span class="card-title">${r}</span>
        <span class="badge green">🏆 Menor preço: ${d} (${l(c)}/un)</span>
      </div>
      <div class="brands-row">
        ${p.map(m=>`<div class="brand-chip${m.marca===d?" best":""}">
