import{initializeApp as Yt}from"https://www.gstatic.com/firebasejs/10.14.1/firebase-app.js";import{getFirestore as _t,onSnapshot as nt,query as Zt,collection as Q,orderBy as Wt,doc as z,setDoc as st,addDoc as mt,deleteDoc as W,serverTimestamp as vt}from"https://www.gstatic.com/firebasejs/10.14.1/firebase-firestore.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))o(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const r of s.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&o(r)}).observe(document,{childList:!0,subtree:!0});function a(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function o(n){if(n.ep)return;n.ep=!0;const s=a(n);fetch(n.href,s)}})();const It=document.createElement("script");It.src="https://cdn.jsdelivr.net/npm/chart.js@4.4.7/dist/chart.umd.min.js";document.head.appendChild(It);const wt=document.createElement("script");wt.src="https://unpkg.com/html5-qrcode@2.3.8/html5-qrcode.min.js";document.head.appendChild(wt);const Jt={apiKey:"AIzaSyANpFnEIkyN1XCT6qbtmVR9wx7sQHEsyrE",authDomain:"comprasmercado-23913.firebaseapp.com",projectId:"comprasmercado-23913",storageBucket:"comprasmercado-23913.firebasestorage.app",messagingSenderId:"317518149234",appId:"1:317518149234:web:94f38624d68a2b9a6634eb",measurementId:"G-2XP88EK37S"},Kt=Yt(Jt),C=_t(Kt),gt="compras",rt="entradas",et="faturas",at="boletos",Bt="reservas";let F=[],N=[],P=[],V=[],ct={metaMensal:0,valorAtualGuardado:0},pt=null,G=null,j=[],tt=0,ot=!1,_=[];function l(t){return Number(t||0).toLocaleString("pt-BR",{style:"currency",currency:"BRL"})}function M(t){if(typeof t=="number")return t;if(!t)return 0;const e=parseFloat(String(t).replace(/R\$\s?/gi,"").replace(/\s/g,"").replace(/\./g,"").replace(",","."));return isNaN(e)?0:e}function it(t){if(!t)return"—";try{return new Date(t).toLocaleString("pt-BR",{dateStyle:"short",timeStyle:"short"})}catch{return t}}function h(t,e=3500){const a=document.getElementById("toast");a.textContent=t,a.classList.add("show"),setTimeout(()=>a.classList.remove("show"),e)}function O(t,e="var(--accent-amber)"){const a=document.getElementById("status-msg");a&&(a.textContent=t,a.style.color=e)}function Xt(t){if(!t)return new Date().toISOString().slice(0,16);try{const e=new Date(t);if(isNaN(e.getTime()))return new Date().toISOString().slice(0,16);const a=o=>String(o).padStart(2,"0");return`${e.getFullYear()}-${a(e.getMonth()+1)}-${a(e.getDate())}T${a(e.getHours())}:${a(e.getMinutes())}`}catch{return new Date().toISOString().slice(0,16)}}function te(t,e){let a=0;const o=new Date(t,e+1,0).getDate();for(let n=1;n<=o;n++){const s=new Date(t,e,n).getDay();s!==0&&s!==6&&a++}return a}window.goTab=function(t){document.querySelectorAll(".tab-content").forEach(a=>a.classList.remove("active")),document.querySelectorAll(".desktop-nav .nav-item").forEach(a=>a.classList.remove("active")),document.querySelectorAll(".mobile-nav .mob-btn").forEach(a=>a.classList.remove("active"));const e=document.getElementById("tab-"+t);e&&e.classList.add("active"),document.querySelectorAll(`[data-tab="${t}"]`).forEach(a=>a.classList.add("active"))};document.querySelectorAll("[data-tab]").forEach(t=>{t.addEventListener("click",()=>goTab(t.getAttribute("data-tab")))});document.querySelectorAll(".sub-item").forEach(t=>{t.addEventListener("click",()=>{document.querySelectorAll(".sub-item").forEach(a=>a.classList.remove("active")),document.querySelectorAll(".sub-tab-content").forEach(a=>a.style.display="none"),t.classList.add("active");const e=document.getElementById("sub-"+t.getAttribute("data-sub"));e&&(e.style.display="block")})});function At(){document.getElementById("modal-add-nota").classList.add("active")}function Ct(){ot&&ht(),document.getElementById("modal-add-nota").classList.remove("active")}var Et;(Et=document.getElementById("btn-open-modal-home"))==null||Et.addEventListener("click",At);var $t;($t=document.getElementById("btn-mercado-add-nota"))==null||$t.addEventListener("click",At);var xt;(xt=document.getElementById("btn-close-modal-add"))==null||xt.addEventListener("click",Ct);nt(Zt(Q(C,gt),Wt("dataEmissao","desc")),t=>{F=t.docs.map(e=>({id:e.id,...e.data()})),J()},t=>console.error("Firestore Mercado:",t));nt(Q(C,rt),t=>{N=t.docs.map(e=>({id:e.id,...e.data()})),J()},t=>console.error("Firestore Entradas:",t));nt(Q(C,et),t=>{P=t.docs.map(e=>({id:e.id,...e.data()})),J()},t=>console.error("Firestore Faturas:",t));nt(Q(C,at),t=>{V=t.docs.map(e=>({id:e.id,...e.data()})),J()},t=>console.error("Firestore Boletos:",t));nt(z(C,Bt,"config"),t=>{t.exists()&&(ct=t.data()),J()},t=>console.error("Firestore Reservas:",t));let I=new Date().toISOString().slice(0,7);function ft(){const t=new Set,e=new Date().toISOString().slice(0,7);return t.add(e),I&&t.add(I),N.forEach(a=>{a.mesAno&&t.add(a.mesAno)}),P.forEach(a=>{a.mesAno&&t.add(a.mesAno)}),V.forEach(a=>{a.mesAno&&t.add(a.mesAno)}),F.forEach(a=>{a.mesAno&&t.add(a.mesAno)}),Array.from(t).sort().reverse()}window.selecionarMesGlobal=function(t){if(!t)return;I=t;const e=document.getElementById("inp-seletor-mes-global");e&&(e.value=t);const a=document.getElementById("inp-entradas-mes-ano");a&&(a.value=t);const o=document.getElementById("inp-fatura-vencimento");o&&(o.value=`${t}-10`,typeof atualizarMesRefFatura=="function"&&atualizarMesRefFatura());const n=document.getElementById("inp-boleto-vencimento");n&&(n.value=`${t}-10`,typeof atualizarMesRefBoleto=="function"&&atualizarMesRefBoleto()),J()};window.verMesEIrParaControle=function(t){selecionarMesGlobal(t),typeof goTab=="function"&&goTab("mensal")};function ee(){const t=document.getElementById("seletor-meses-bar"),e=document.getElementById("seletor-meses-bar-salarios"),a=ft();a.includes(I)||(I=a[0]||new Date().toISOString().slice(0,7));const o=document.getElementById("inp-seletor-mes-global");o&&o.value!==I&&(o.value=I);const n=document.getElementById("inp-entradas-mes-ano");n&&n.value!==I&&(n.value=I);const s=a.map(r=>{const[c,d]=r.split("-"),u=new Date(parseInt(c),parseInt(d)-1,1).toLocaleString("pt-BR",{month:"short"}).toUpperCase().replace(".",""),m=r===I;return`
    ...
    `}).join("");t&&(t.innerHTML=s),e&&(e.innerHTML=s)}window.switchMensalSub=function(t){document.querySelectorAll("[data-mensal-sub]").forEach(o=>o.classList.remove("active")),document.querySelectorAll(".mensal-sub-content").forEach(o=>o.style.display="none");const e=document.querySelector(`[data-mensal-sub="${t}"]`);e&&e.classList.add("active");const a=document.getElementById(t);a&&(a.style.display="block")};function J(){ee(),ne(),ae(),St(),ue(),ge(),he(),Ie(),we(),Be(),fe()}function ae(){const t=I,e=N.filter(v=>v.mesAno===t),a=P.filter(v=>v.mesAno===t),o=V.filter(v=>v.mesAno===t),n=F.filter(v=>v.mesAno===t),s=e.reduce((v,E)=>v+(E.valor||0),0),r=a.reduce((v,E)=>v+(E.valorTotal!==void 0?E.valorTotal:E.valor||0),0),c=o.reduce((v,E)=>v+(E.valorTotal!==void 0?E.valorTotal:E.valor||0),0);let d=0;n.forEach(v=>{v.formasPagamento&&(d+=v.formasPagamento.cartaoDebito||0)});const i=s-r-c-d,u=document.getElementById("m-total-entradas");u&&(u.textContent=l(s));const m=document.getElementById("m-total-cartoes");m&&(m.textContent=l(r));const f=document.getElementById("m-total-boletos");f&&(f.textContent=l(c));const b=document.getElementById("m-mercado-debito");b&&(b.textContent=l(d));const g=document.getElementById("m-saldo-liquido");g&&(g.textContent=l(i),g.style.color=i>=0?"#60a5fa":"#fb7185");const[y,T]=t.split("-"),R=new Date(parseInt(y),parseInt(T)-1,1).toLocaleString("pt-BR",{month:"long"}),D=R.charAt(0).toUpperCase()+R.slice(1),x=document.getElementById("m-lbl-saldo-liquido");x&&(x.textContent=`Saldo Líquido (${D}/${y})`),oe(e,a,o,n)}function oe(t,e,a,o){const n=document.getElementById("content-salarios-mes");n&&(n.innerHTML=`
      <div class="card" style="margin-bottom:1.5rem">
        <div class="card-header">
          <span class="card-title">💵 Entradas Registradas em ${I}</span>
        ...
        ${t.length?`<div class="table-responsive"><table class="custom-table">
            ...
            </table></div>`:`<div class="empty-state">Nenhuma entrada cadastrada para ${I}. Use a aba "Salários & Entradas" para cadastrar.</div>`}
      </div>
    `);const s=document.getElementById("content-cartoes-mes");if(s){const d=e.reduce((u,m)=>u+(m.valorTotal||0),0),i=e.length?qt(e):"";s.innerHTML=`
      ...
      <div class="card" style="margin-bottom:1.5rem">
        <div class="card-header">
          <span class="card-title">💳 Faturas de Cartão Vencendo em ${I}</span>
        ...
        ${e.length?e.map(u=>`
            ...
            `).join(""):`<div class="empty-state">Nenhuma fatura cadastrada com vencimento em ${I}. Use a aba "Cartões de Crédito" para importar.</div>`}
      </div>
    `}const r=document.getElementById("content-boletos-mes");if(r){const d=a.reduce((i,u)=>i+(u.valorTotal||0),0);r.innerHTML=`
      <div class="card" style="margin-bottom:1.5rem">
        <div class="card-header">
          <span class="card-title">📄 Boletos Vencendo em ${I}</span>
        ...
        ${a.length?a.map(i=>`
            ...
            `).join(""):`<div class="empty-state">Nenhum boleto cadastrado para ${I}. Use a aba "Boletos" para importar.</div>`}
      </div>
    `}const c=document.getElementById("content-mercado-mes");c&&(c.innerHTML=`
      <div class="card" style="margin-bottom:1.5rem">
        <div class="card-header">
          <span class="card-title">🛒 Compras de Mercado em ${I}</span>
        ...
        ${o.length?o.map(d=>`
            ...
            `).join(""):`<div class="empty-state">Nenhuma nota de mercado cadastrada para ${I}.</div>`}
      </div>
    `)}function ne(){let t=N.reduce((i,u)=>i+(u.valor||0),0),e=P.reduce((i,u)=>i+(u.valorTotal!==void 0?u.valorTotal:u.valor||0),0),a=V.reduce((i,u)=>i+(u.valorTotal!==void 0?u.valorTotal:u.valor||0),0),o=0,n=0,s=0;const r={};F.forEach(i=>{const u=i.valorAPagar||0;i.formasPagamento&&(n+=i.formasPagamento.valeAlimentacao||0,s+=i.formasPagamento.cartaoCredito||0,o+=i.formasPagamento.cartaoDebito||0);const m=i.mesAno||"Outros";r[m]=(r[m]||0)+u});let c=t-e-a-o;document.getElementById("fin-total-entradas").textContent=l(t);const d=document.getElementById("fin-subtext-entradas");d&&(d.textContent="Total de Entradas Cadastradas"),document.getElementById("fin-total-cartoes").textContent=l(e),document.getElementById("fin-total-boletos").textContent=l(a),document.getElementById("fin-mercado-debito").textContent=l(o),document.getElementById("fin-saldo-liquido").textContent=l(c),document.getElementById("dash-alimentacao").textContent=l(n),document.getElementById("dash-credito").textContent=l(s),document.getElementById("dash-debito").textContent=l(o),se(),Tt(r)}function se(){const t=document.getElementById("tabela-resumo-mensal");if(!t)return;const e=ft();if(!e.length){t.innerHTML='<div class="empty-state">Nenhum dado cadastrado ainda.</div>';return}const a=e.map(o=>{const n=N.filter(g=>g.mesAno===o).reduce((g,y)=>g+(y.valor||0),0),s=P.filter(g=>g.mesAno===o).reduce((g,y)=>g+(y.valorTotal!==void 0?y.valorTotal:y.valor||0),0),r=V.filter(g=>g.mesAno===o).reduce((g,y)=>g+(y.valorTotal!==void 0?y.valorTotal:y.valor||0),0);let c=0;F.filter(g=>g.mesAno===o).forEach(g=>{g.formasPagamento&&(c+=g.formasPagamento.cartaoDebito||0)});const d=n-s-r-c,[i,u]=o.split("-"),f=new Date(parseInt(i),parseInt(u)-1,1).toLocaleString("pt-BR",{month:"short"}).toUpperCase().replace(".","");return`
      <tr style="${o===I?"background:rgba(99,102,241,0.1)":""}">
  ...
  `}function Tt(t){var s;if(typeof Chart>"u")return setTimeout(()=>Tt(t),300);const e=(s=document.getElementById("chart-barras"))==null?void 0:s.getContext("2d");if(!e)return;const a=Object.keys(t).sort(),o=a.map(r=>{const[c,d]=r.split("-");return`${d}/${c}`}),n=a.map(r=>t[r]);pt&&pt.destroy(),pt=new Chart(e,{type:"bar",data:{labels:o.length?o:["Sem compras"],datasets:[{label:"Gasto Mercado R$",data:n.length?n:[0],backgroundColor:"rgba(16,185,129,0.78)",borderColor:"#10b981",borderWidth:2,borderRadius:8}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1},tooltip:{callbacks:{label:r=>` ${l(r.raw)}`}}},scales:{y:{beginAtZero:!0,grid:{color:"rgba(255,255,255,.05)"},ticks:{color:"#94a3b8",callback:r=>"R$"+r}},x:{grid:{display:!1},ticks:{color:"#94a3b8"}}}}})}function Mt(t){if(!t)return 0;const e=t.match(/L[íi]quido(?:\s*a\s*receber)?\s*[:\s]*R?\$\s*([\d\.,]+)/i)||t.match(/TOTAL\s*L[IÍ]QUIDO\s*[:\s]*R?\$\s*([\d\.,]+)/i)||t.match(/SAL[ÁA]RIO\s*L[IÍ]QUIDO\s*[:\s]*R?\$\s*([\d\.,]+)/i)||t.match(/VALOR\s*L[IÍ]QUIDO\s*[:\s]*R?\$\s*([\d\.,]+)/i);return e?M(e[1]):0}function re(){const t=document.getElementById("inp-entradas-mes-ano");if(t&&!t.value){const e=new Date,a=e.getFullYear(),o=String(e.getMonth()+1).padStart(2,"0");t.value=`${a}-${o}`}}setTimeout(re,300);let Y="mes";window.toggleFiltroEntradasTabela=function(t){Y=t,St()};document.getElementById("form-holerite-victor").addEventListener("submit",async t=>{t.preventDefault();const e=I||document.getElementById("inp-entradas-mes-ano").value||new Date().toISOString().slice(0,7),a=document.getElementById("inp-holerite-txt-victor").value;let o=parseFloat(document.getElementById("inp-salario-val-victor").value)||0;if(!o&&a&&(o=Mt(a)),!o){h("⚠️ Digite ou cole um holerite válido com valor.");return}const n=`salario_victor_${e}`;await st(z(C,rt,n),{pessoa:"Victor",tipo:"holerite",descricao:`Salário Líquido Victor (${e})`,valor:o,mesAno:e,data:new Date().toISOString()}),document.getElementById("inp-holerite-txt-victor").value="",document.getElementById("inp-salario-val-victor").value="",h(`✅ Salário do Victor (${e}) salvo com sucesso!`)});document.getElementById("form-holerite-maria").addEventListener("submit",async t=>{t.preventDefault();const e=I||document.getElementById("inp-entradas-mes-ano").value||new Date().toISOString().slice(0,7),a=document.getElementById("inp-holerite-txt-maria").value;let o=parseFloat(document.getElementById("inp-salario-val-maria").value)||0;if(!o&&a&&(o=Mt(a)),!o){h("⚠️ Digite ou cole um holerite válido com valor.");return}const n=`salario_maria_${e}`;await st(z(C,rt,n),{pessoa:"Maria",tipo:"holerite",descricao:`Salário Líquido Maria (${e})`,valor:o,mesAno:e,data:new Date().toISOString()}),document.getElementById("inp-holerite-txt-maria").value="",document.getElementById("inp-salario-val-maria").value="",h(`✅ Salário da Maria (${e}) salvo com sucesso!`)});document.getElementById("form-entrada-manual").addEventListener("submit",async t=>{t.preventDefault();const e=I||document.getElementById("inp-entradas-mes-ano").value||new Date().toISOString().slice(0,7),a=document.getElementById("inp-ent-desc").value.trim(),o=parseFloat(document.getElementById("inp-ent-val").value)||0,n=document.getElementById("inp-ent-pessoa").value;!a||!o||(await mt(Q(C,rt),{pessoa:n,tipo:"manual",descricao:a,valor:o,mesAno:e,data:new Date().toISOString()}),t.target.reset(),h(`🎉 Entrada manual (${e}) registrada!`))});function St(){var d,i,u;const t=I||((d=document.getElementById("inp-entradas-mes-ano"))==null?void 0:d.value)||new Date().toISOString().slice(0,7),e=document.getElementById("lbl-entradas-mes-ref");if(e){const[m,f]=t.split("-"),g=new Date(parseInt(m),parseInt(f)-1,1).toLocaleString("pt-BR",{month:"long"}),y=g.charAt(0).toUpperCase()+g.slice(1);e.textContent=`Visualizando e inserindo entradas para: ${y} de ${m}`}const a=((i=N.find(m=>m.pessoa==="Victor"&&m.tipo==="holerite"&&m.mesAno===t))==null?void 0:i.valor)||0,o=((u=N.find(m=>m.pessoa==="Maria"&&m.tipo==="holerite"&&m.mesAno===t))==null?void 0:u.valor)||0,n=N.filter(m=>m.mesAno===t),s=n.reduce((m,f)=>m+(f.valor||0),0);document.getElementById("val-salario-victor").textContent=l(a),document.getElementById("val-salario-maria").textContent=l(o),document.getElementById("val-entradas-combinado").textContent=`${l(s)}`;const r=document.getElementById("lista-entradas-registradas");if(!r)return;const c=Y==="mes"?n:N;if(!c.length){r.innerHTML=`
  ...
  `}window.excluirEntrada=async function(t){confirm("Excluir esta entrada?")&&(await W(z(C,rt,t)),h("🗑️ Entrada removida."))};let bt="Nubank",w=null;function ie(){const t=document.getElementById("inp-fatura-vencimento");if(t&&!t.value){const e=new Date,a=e.getFullYear(),o=String(e.getMonth()+1).padStart(2,"0");t.value=`${a}-${o}-10`,atualizarMesRefFatura()}}setTimeout(ie,300);window.atualizarMesRefFatura=function(){const t=document.getElementById("inp-fatura-vencimento"),e=document.getElementById("lbl-fatura-mes-ref");if(!(!t||!e))if(t.value){const[a,o]=t.value.split("-"),s=new Date(parseInt(a),parseInt(o)-1,1).toLocaleString("pt-BR",{month:"long"});e.textContent=`Fatura ${s.charAt(0).toUpperCase()+s.slice(1)}/${a}`}else e.textContent="Mês da Fatura"};window.selecionarCartaoFatura=function(t){bt=t,document.querySelectorAll(".btn-card-select").forEach(a=>a.classList.remove("active"));const e=document.querySelector(`.btn-card-select[data-card="${t}"]`);e&&e.classList.add("active"),h(`Cartão selecionado: ${t}`)};window.handleFileFaturaSelect=async function(t){const e=t.target.files[0];if(!e)return;const a=document.getElementById("txt-file-fatura");a&&(a.textContent=`📄 Arquivo: ${e.name}`),h(`⏳ Lendo arquivo da fatura (${e.name})...`);let o="";if(e.type==="application/pdf"||e.name.endsWith(".pdf"))o=await Dt(e);else try{o=await e.text()}catch{o=""}o?(document.getElementById("inp-fatura-txt").value=o,await Lt(o,bt)):h("❌ Não foi possível ler o texto do arquivo da fatura.")};async function Dt(t){try{const e=await t.arrayBuffer();if(typeof pdfjsLib>"u")return h("⚠️ Aguarde a biblioteca de PDF carregar..."),"";pdfjsLib.GlobalWorkerOptions.workerSrc="https://cdnjs.cloudflare.com/ajax/libs/pdf.js/3.11.174/pdf.worker.min.js";let a=pdfjsLib.getDocument({data:e});a.onPassword=(s,r)=>{let c=prompt(`🔒 Este PDF de fatura está protegido por senha.
Digite a senha para abrir (ex: CPF ou Data de Nascimento):`);c?s(c):h("⚠️ Senha não informada. Leitura do PDF cancelada.")};const o=await a.promise;let n="";for(let s=1;s<=o.numPages;s++){const c=await(await o.getPage(s)).getTextContent();let d=null,i="";for(const u of c.items){if(!u.str)continue;const m=u.transform?u.transform[5]:null;d!==null&&Math.abs(m-d)>3?i+=`
`:i.length>0&&!i.endsWith(`
`)&&!i.endsWith(" ")&&(i+=" "),i+=u.str,d=m}n+=i+`
`}return n}catch(e){return e.name==="PasswordException"?h("🔒 O PDF precisa de senha válida para ser aberto."):console.error("Erro ao ler PDF:",e),""}}function le(t){if(!t)return null;const e=t.match(/Total\s*a\s*Pagar\s*[:\s]*R?\$\s*([\d\.,]+)/i)||t.match(/no\s*valor\s*de\s*R?\$\s*([\d\.,]+)/i)||t.match(/Valor\s*total\s*da\s*fatura\s*[:\s]*R?\$\s*([\d\.,]+)/i)||t.match(/Total\s*da\s*fatura\s*[:\s]*R?\$\s*([\d\.,]+)/i);if(e){const a=M(e[1]);if(a>0)return a}return null}function de(t){if(!t)return null;const e=t.match(/Vencimento\s*[:\s]*(\d{2}[\/\.-]\d{2}[\/\.-]\d{4})/i)||t.match(/Data\s*de\s*vencimento\s*[:\s]*(\d{2})\s+([A-Za-z]{3})\s+(\d{4})/i)||t.match(/FATURA\s+(\d{2})\s+([A-Za-z]{3})\s+(\d{4})/i);if(e){if(e[2]&&e[3]){const a=e[1],o=e[2].toUpperCase(),n=e[3],r={JAN:"01",FEB:"02",MAR:"03",ABR:"04",APR:"04",MAI:"05",MAY:"05",JUN:"06",JUL:"07",AGO:"08",AUG:"08",SET:"09",SEP:"09",OUT:"10",OCT:"10",NOV:"11",DEZ:"12",DEC:"12"}[o]||"07";return`${n}-${r}-${a.padStart(2,"0")}`}else if(e[1]){const[a,o,n]=e[1].split(/[\/\.-]/);return`${n}-${o.padStart(2,"0")}-${a.padStart(2,"0")}`}}return null}window.importarFaturaManualOuArquivo=async function(){const t=document.getElementById("inp-fatura-txt").value.trim();if(!t){h("⚠️ Selecione o arquivo da fatura (.pdf, .csv) ou cole o texto da fatura.");return}await Lt(t,bt)};async function Lt(t,e){const a=de(t);a&&(document.getElementById("inp-fatura-vencimento").value=a,atualizarMesRefFatura());const o=le(t),n=ce(t),s=document.getElementById("inp-fatura-vencimento").value||new Date().toISOString().slice(0,10),r=s.slice(0,7),c=n.reduce((f,b)=>f+b.valor,0),d=o||c||0,i=e?`Cartão ${e}`:"Fatura Cartão";w={cartao:e||"Nubank",descricao:i,dataVencimento:s,mesAno:r,valorTotal:d,qtdItens:n.length,itens:n};const u=document.getElementById("inp-revisao-fatura-desc");u&&(u.value=i);const m=document.getElementById("inp-revisao-fatura-val");m&&(m.value=d?d.toFixed(2):""),Ft(),n.length>0?h(`✅ ${n.length} compras encontradas! Fatura total: ${l(d)}.`):h("ℹ️ Fatura pronta para revisão. Confirme o valor total e o cartão abaixo.")}window.atualizarValorTotalRevisaoFatura=function(){var e;if(!w)return;const t=parseFloat((e=document.getElementById("inp-revisao-fatura-val"))==null?void 0:e.value)||0;w.valorTotal=t,document.getElementById("badge-total-preview-fatura").textContent=l(t)};function Ft(){if(!w)return;const{valorTotal:t,itens:e,cartao:a,descricao:o}=w;document.getElementById("badge-total-preview-fatura").textContent=l(t);const n=document.getElementById("inp-revisao-fatura-desc");n&&(!n.value||n.value==="Fatura Cartão")&&(n.value=o||`Cartão ${a||"Nubank"}`);const s=document.getElementById("inp-revisao-fatura-val");s&&(!s.value||parseFloat(s.value)===0)&&(s.value=t?t.toFixed(2):"");const r=document.getElementById("lista-preview-fatura-itens");!e||!e.length?r.innerHTML='<div class="empty-state">Nenhum item individual extraído. O valor total acima será considerado.</div>':r.innerHTML=e.map((d,i)=>`
    ...
    `).join("");const c=document.getElementById("box-revisao-fatura");c.style.display="block",c.scrollIntoView({behavior:"smooth"})}window.removerItemRevisaoFatura=function(t){if(!w||!w.itens)return;w.itens.splice(t,1);const e=w.itens.reduce((a,o)=>a+o.valor,0);if(e>0){w.valorTotal=e;const a=document.getElementById("inp-revisao-fatura-val");a&&(a.value=e.toFixed(2))}w.qtdItens=w.itens.length,Ft(),h("🗑️ Item removido da revisão da fatura.")};window.confirmarEGravarFaturaDocumento=async function(){var o,n;if(!w)return;const t=(o=document.getElementById("inp-revisao-fatura-desc"))==null?void 0:o.value.trim(),e=parseFloat((n=document.getElementById("inp-revisao-fatura-val"))==null?void 0:n.value)||0,a=document.getElementById("inp-fatura-vencimento").value||new Date().toISOString().slice(0,10);if(!e){h("⚠️ Digite ou confirme o valor total da fatura.");return}w.cartao=t||w.cartao||"Cartão",w.valorTotal=e,w.dataVencimento=a,w.mesAno=a.slice(0,7);try{await mt(Q(C,et),{...w,createdAt:vt()}),document.getElementById("box-revisao-fatura").style.display="none",document.getElementById("inp-fatura-txt").value="";const s=document.getElementById("txt-file-fatura");s&&(s.textContent="Clique para Selecionar o Arquivo da Fatura");const r=l(w.valorTotal);w=null,h(`🎉 Fatura de ${r} salva com sucesso!`)}catch(s){alert("Erro ao salvar fatura: "+s.message)}};function ce(t){if(!t)return[];const e=[],a=/(?:[@\)\(\*•\s]+)?(\d{2}[\/\.-]\d{2}(?:[\/\.-]\d{2,4})?|\d{2}\s+[A-Za-z]{3})\s+(.+?)\s+(?:(\d{2}\/\d{2})\s+)?(-?R?\$\s*[\d\.]+,\d{2}|-?[\d\.]+,\d{2})/gi;if(t.split(`
`).forEach(n=>{const s=n.trim();if(!s||/EMISS[ÃA]O|TRANSA[ÇC][ÕO]ES|RESUMO|PAGAMENTO DE FATURA|TOTAL DA FATURA|FATURA ANTERIOR|SALDO ANTERIOR|LIMITE DISPON[ÍI]VEL|OPÇÕES DE PAGAMENTO|ALTERNATIVAS DE PAGAMENTO|PAGAMENTO E DEMAIS|PARCELAMENTOS|DESPESAS|HISTÓRICO DE FATURAS|SUPERCRÉDITO|SAQUE À CRÉDITO|COMPRA DATA DESCRIÇÃO/i.test(s))return;const r=/(?:[@\)\(\*•\s]+)?(\d{2}[\/\.-]\d{2}(?:[\/\.-]\d{2,4})?|\d{2}\s+[A-Za-z]{3})\s+(.+?)\s+(?:(\d{2}\/\d{2})\s+)?(-?R?\$\s*[\d\.]+,\d{2}|-?[\d\.]+,\d{2})$/i,c=s.match(r)||s.match(/(?:[@\)\(\*•\s]+)?(\d{2}[\/\.-]\d{2}(?:[\/\.-]\d{2,4})?|\d{2}\s+[A-Za-z]{3})\s+(.+?)\s+(?:(\d{2}\/\d{2})\s+)?(-?R?\$\s*[\d\.]+,\d{2}|-?[\d\.]+,\d{2})/i);if(c){const d=c[1];let i=c[2].trim();const u=c[3],m=c[4];if(m.includes("-")||/DEB AUTOM|PAGAMENTO|PAGTO|CR[ÉE]DITO FATURA/i.test(i))return;const f=M(m);u&&(i+=` (${u})`),i&&f>0&&i.length>2&&!/fatura|limite|pagamento|saldo|alternativas|opções|período|emissão|vencimento/i.test(i)&&e.push({dataCompra:d,descricao:i,valor:f})}}),e.length===0){let n;for(;(n=a.exec(t))!==null;){const s=n[1];let r=n[2].trim();const c=n[3],d=n[4];if(d.includes("-")||/DEB AUTOM|PAGAMENTO|PAGTO|CR[ÉE]DITO FATURA/i.test(r))continue;const i=M(d);c&&(r+=` (${c})`),r&&i>0&&r.length>2&&!/fatura|limite|pagamento|saldo|alternativas|opções|período|emissão|vencimento/i.test(r)&&e.push({dataCompra:s,descricao:r,valor:i})}}return e}window.ultimosLocaisAnalisados={};function me(t){if(!t)return"DIVERSOS";let e=t.replace(/\(\d{1,2}\/\d{1,2}\)/gi,"").replace(/\b\d{1,2}\/\d{1,2}\b/gi,"").replace(/\b\d{1,2}x\b/gi,"").trim();return e=e.replace(/\s+/g," "),e.toUpperCase()}function Rt(t){const e={};(Array.isArray(t)?t:[t]).forEach(n=>{!n||!n.itens||!Array.isArray(n.itens)||n.itens.forEach(s=>{if(!s.descricao||!s.valor)return;const r=me(s.descricao);e[r]||(e[r]={nome:r,qtd:0,valorTotal:0,compras:[]}),e[r].qtd+=1,e[r].valorTotal+=s.valor||0,e[r].compras.push({dataCompra:s.dataCompra||"—",descricao:s.descricao,valor:s.valor||0,cartao:n.cartao||"Cartão",mesAno:n.mesAno||"—"})})});const o=Object.values(e).filter(n=>n.qtd>=2);return o.sort((n,s)=>s.valorTotal-n.valorTotal),o}function qt(t,e="geral"){const a=Rt(t);if(a.forEach(n=>{window.ultimosLocaisAnalisados[`${e}_${n.nome}`]=n}),!a.length)return`
  ...
  `,a.style.display="flex"};window.fecharModalEstabelecimento=function(){const t=document.getElementById("modal-detalhes-estabelecimento");t&&(t.style.display="none")};function ue(){const t=P.reduce((o,n)=>o+(n.valorTotal!==void 0?n.valorTotal:n.valor||0),0);document.getElementById("badge-total-cartoes").textContent=`${l(t)} total`;const e=document.getElementById("lista-faturas-registradas");if(!P.length){e.innerHTML='<div class="empty-state">Nenhuma fatura cadastrada ainda.</div>';return}const a=qt(P,"geral");e.innerHTML=a+P.map(o=>{var m;const n=o.valorTotal!==void 0?o.valorTotal:o.valor||0,s=o.cartao||"Cartão",r=s.toLowerCase().includes("nubank"),c=r?"purple":"red",d=r?"🟣":"🔴",i=o.dataVencimento?it(o.dataVencimento).split(",")[0]:"—",u=o.mesAno||"—";return`
  ...
  </table></div>`}window.removerItemFaturaCadastrada=async function(t,e){const a=P.find(s=>s.id===t);if(!a||!a.itens||!confirm("Remover este item da fatura?"))return;const o=[...a.itens];o.splice(e,1);const n=o.reduce((s,r)=>s+(r.valor||0),0);o.length===0?(await W(z(C,et,t)),h("🗑️ Fatura excluída pois todos os itens foram removidos.")):(await st(z(C,et,t),{...a,itens:o,valorTotal:n,qtdItens:o.length}),h("🗑️ Item removido da fatura."))};window.excluirFaturaDocumento=async function(t){confirm("Excluir esta fatura e todos os seus lançamentos?")&&(await W(z(C,et,t)),h("🗑️ Fatura removida com sucesso."))};let A=null;function pe(){const t=document.getElementById("inp-boleto-vencimento");if(t&&!t.value){const e=new Date,a=e.getFullYear(),o=String(e.getMonth()+1).padStart(2,"0");t.value=`${a}-${o}-10`,atualizarMesRefBoleto()}}setTimeout(pe,300);window.atualizarMesRefBoleto=function(){const t=document.getElementById("inp-boleto-vencimento"),e=document.getElementById("lbl-boleto-mes-ref");if(!(!t||!e))if(t.value){const[a,o]=t.value.split("-"),s=new Date(parseInt(a),parseInt(o)-1,1).toLocaleString("pt-BR",{month:"long"});e.textContent=`Boleto ${s.charAt(0).toUpperCase()+s.slice(1)}/${a}`}else e.textContent="Mês do Boleto"};window.handleFileBoletoSelect=async function(t){const e=t.target.files[0];if(!e)return;const a=document.getElementById("txt-file-boleto");a&&(a.textContent=`📄 Arquivo: ${e.name}`),h(`⏳ Lendo arquivo do boleto (${e.name})...`);let o="";if(e.type==="application/pdf"||e.name.endsWith(".pdf"))o=await Dt(e);else try{o=await e.text()}catch{o=""}o?(document.getElementById("inp-boleto-txt").value=o,await kt(o,e.name)):h("❌ Não foi possível ler o texto do arquivo do boleto.")};window.importarBoletoManualOuArquivo=async function(){const t=document.getElementById("inp-boleto-txt").value.trim();if(!t){h("⚠️ Selecione o arquivo do boleto (.pdf, .txt) ou cole o texto do boleto.");return}await kt(t,"Boleto")};async function kt(t,e){const a=ve(t);a.vencimento&&(document.getElementById("inp-boleto-vencimento").value=a.vencimento,atualizarMesRefBoleto());const o=document.getElementById("inp-boleto-vencimento").value||new Date().toISOString().slice(0,10),n=o.slice(0,7),s=a.beneficiario||e.replace(/\.[^/.]+$/,"")||"Boleto / Conta",r=a.itens.reduce((d,i)=>d+i.valor,0),c=a.valorTotal||r||0;document.getElementById("inp-revisao-boleto-desc").value=s,document.getElementById("inp-revisao-boleto-val").value=c?c.toFixed(2):"",A={descricao:s,dataVencimento:o,mesAno:n,valorTotal:c,qtdItens:a.itens.length,itens:a.itens},Pt(),h("✅ Boleto identificado! Confira a descrição, valor e itens antes de salvar.")}window.atualizarValorTotalRevisaoBoleto=function(){if(!A)return;const t=parseFloat(document.getElementById("inp-revisao-boleto-val").value)||0;A.valorTotal=t,document.getElementById("badge-total-preview-boleto").textContent=l(t)};function Pt(){if(!A)return;const{valorTotal:t,itens:e}=A;document.getElementById("badge-total-preview-boleto").textContent=l(t);const a=document.getElementById("lista-preview-boleto-itens");!e||!e.length?a.innerHTML='<div class="empty-state">Nenhum encargo/item individual extraído. O valor total acima será considerado.</div>':a.innerHTML=e.map((n,s)=>`
      <div style="display:flex; justify-content:space-between; align-items:center; padding:.4rem 0; border-bottom:1px dashed var(--border-color); font-size:.82rem;">
    ...
    `).join("");const o=document.getElementById("box-revisao-boleto");o.style.display="block",o.scrollIntoView({behavior:"smooth"})}window.removerItemRevisaoBoleto=function(t){if(!A||!A.itens)return;A.itens.splice(t,1);const e=A.itens.reduce((a,o)=>a+o.valor,0);e>0&&(A.valorTotal=e,document.getElementById("inp-revisao-boleto-val").value=e.toFixed(2)),A.qtdItens=A.itens.length,Pt(),h("🗑️ Item removido da revisão do boleto.")};window.confirmarEGravarBoletoDocumento=async function(){if(!A)return;const t=document.getElementById("inp-revisao-boleto-desc").value.trim(),e=parseFloat(document.getElementById("inp-revisao-boleto-val").value)||0,a=document.getElementById("inp-boleto-vencimento").value||new Date().toISOString().slice(0,10);if(!e){h("⚠️ Digite ou confirme o valor total do boleto.");return}A.descricao=t||"Boleto / Conta",A.valorTotal=e,A.dataVencimento=a,A.mesAno=a.slice(0,7);try{await mt(Q(C,at),{...A,createdAt:vt()}),document.getElementById("box-revisao-boleto").style.display="none",document.getElementById("inp-boleto-txt").value="";const o=document.getElementById("txt-file-boleto");o&&(o.textContent="Clique para Selecionar o Arquivo do Boleto");const n=l(A.valorTotal);A=null,h(`🎉 Boleto de ${n} salvo com sucesso!`)}catch(o){alert("Erro ao salvar boleto: "+o.message)}};function ve(t){if(!t)return{beneficiario:"",valorTotal:0,vencimento:null,itens:[]};let e="",a=0,o=null;const n=[],s=t.match(/Vencimento\s*[:\s]*(\d{2}[\/\.-]\d{2}[\/\.-]\d{4})/i)||t.match(/Vencimento\s*[:\s]*(\d{2})\s+([A-Za-z]{3})\s+(\d{4})/i)||t.match(/Data\s*de\s*Vencimento\s*[:\s]*(\d{2}[\/\.-]\d{2}[\/\.-]\d{4})/i);if(s){if(s[2]&&s[3]){const i=s[1],u=s[2].toUpperCase();o=`${s[3]}-${{JAN:"01",FEB:"02",MAR:"03",ABR:"04",APR:"04",MAI:"05",MAY:"05",JUN:"06",JUL:"07",AGO:"08",AUG:"08",SET:"09",SEP:"09",OUT:"10",OCT:"10",NOV:"11",DEZ:"12",DEC:"12"}[u]||"07"}-${i.padStart(2,"0")}`}else if(s[1]){const[i,u,m]=s[1].split(/[\/\.-]/);o=`${m}-${u.padStart(2,"0")}-${i.padStart(2,"0")}`}}const r=t.match(/Benefici[áa]rio\s*[:\s]*([^\n\r]+)/i)||t.match(/Nome\s*do\s*Cedente\s*[:\s]*([^\n\r]+)/i)||t.match(/Raz[ãa]o\s*Social\s*[:\s]*([^\n\r]+)/i);r&&(e=r[1].trim().replace(/\s{2,}/g," "));const c=t.match(/Valor\s*do\s*Documento\s*[:\s]*R?\$\s*([\d\.]+,\d{2})/i)||t.match(/\(=\)\s*Valor\s*Cobrado\s*[:\s]*R?\$\s*([\d\.]+,\d{2})/i)||t.match(/Valor\s*Cobrado\s*[:\s]*R?\$\s*([\d\.]+,\d{2})/i)||t.match(/Valor\s*R?\$\s*([\d\.]+,\d{2})/i);return c&&(a=M(c[1])),t.split(`
`).forEach(i=>{const u=i.trim();if(!u||/vencimento|beneficiário|cedente|nosso\s*número|agência|código|autenticação|instruções/i.test(u))return;const m=u.match(/(\d{2}[\/\.-]\d{2}(?:[\/\.-]\d{2,4})?|\b[A-Za-z]{3}\b)?\s*(.+?)\s+R?\$\s*([\d\.]+,\d{2})$/i);if(m){const f=m[1]||"Boleto",b=m[2].trim(),g=M(m[3]);b&&g>0&&b.length>2&&!/valor|total|documento|cobrado/i.test(b)&&n.push({dataBoleto:f,descricao:b,valor:g})}}),{beneficiario:e,valorTotal:a,vencimento:o,itens:n}}function ge(){const t=V.reduce((a,o)=>a+(o.valorTotal!==void 0?o.valorTotal:o.valor||0),0);document.getElementById("badge-total-boletos").textContent=`${l(t)} total`;const e=document.getElementById("lista-boletos-registrados");if(!V.length){e.innerHTML='<div class="empty-state">Nenhum boleto cadastrado ainda.</div>';return}e.innerHTML=V.map(a=>{var c;const o=a.valorTotal!==void 0?a.valorTotal:a.valor||0,n=a.dataVencimento?it(a.dataVencimento).split(",")[0]:"—",s=a.mesAno||"—",r=a.descricao||"Boleto / Conta";return`
      ...
      <td><button class="btn-danger" style="padding:.2rem .5rem; font-size:.78rem;" onclick="excluirBoletoDocumento('${t.id}')">🗑️ Excluir</button></td>
  ...
  </table></div>`}window.removerItemBoletoCadastrado=async function(t,e){const a=V.find(s=>s.id===t);if(!a||!a.itens||!confirm("Remover este item do boleto?"))return;const o=[...a.itens];o.splice(e,1);const n=o.reduce((s,r)=>s+(r.valor||0),0);o.length===0?(await W(z(C,at,t)),h("🗑️ Boleto excluído pois todos os itens foram removidos.")):(await st(z(C,at,t),{...a,itens:o,valorTotal:n,qtdItens:o.length}),h("🗑️ Item removido do boleto."))};window.excluirBoletoDocumento=async function(t){confirm("Excluir este boleto e todos os seus itens?")&&(await W(z(C,at,t)),h("🗑️ Boleto removido com sucesso."))};document.getElementById("form-config-reservas").addEventListener("submit",async t=>{t.preventDefault();const e=parseFloat(document.getElementById("inp-meta-anual").value)||0,a=parseFloat(document.getElementById("inp-meta-mensal").value)||0,o=parseFloat(document.getElementById("inp-saldo-guardado").value)||0;await st(z(C,Bt,"config"),{metaAnual:e,metaMensal:a,valorAtualGuardado:o,dataAtualizacao:new Date().toISOString()}),h("✅ Reservas e configurações de economias salvas!")});function fe(){const t=ct.metaAnual||1e4,e=ct.metaMensal||0,a=ct.valorAtualGuardado||0,o=document.getElementById("inp-meta-anual");o&&!o.value&&t&&(o.value=t);const n=document.getElementById("inp-saldo-guardado");n&&!n.value&&a&&(n.value=a);const s=document.getElementById("inp-meta-mensal");s&&!s.value&&e&&(s.value=e);const c=new Date().getMonth()+1,d=Math.max(1,12-c+1),i=Math.max(0,t-a),u=i>0?i/d:0,m=e>0?e:u;document.getElementById("val-meta-reserva").textContent=l(m);const f=document.getElementById("subtext-meta-reserva");f&&(f.textContent=`Faltam ${l(i)} p/ Meta Anual de ${l(t)} (${d} mes(es) no ano)`),document.getElementById("val-real-guardado").textContent=l(a);const b=N.reduce((x,v)=>x+(v.valor||0),0),g=P.reduce((x,v)=>x+(v.valorTotal!==void 0?v.valorTotal:v.valor||0),0),y=V.reduce((x,v)=>x+(v.valorTotal!==void 0?v.valorTotal:v.valor||0),0);let T=0;F.forEach(x=>{x.formasPagamento&&(T+=x.formasPagamento.cartaoDebito||0)});const S=b-g-y-T,R=S>0?Math.max(S*.5,b*.2):0;document.getElementById("val-recomendacao-reserva").textContent=l(R);const D=document.getElementById("box-analise-reserva-detalhes");if(D)if(b===0)D.innerHTML='<p class="empty-state">Cadastre seus salários e entradas na aba "Salários & Entradas" para gerar o diagnóstico inteligente de economias.</p>';else{const x=t>0?Math.min(100,a/t*100).toFixed(1):0;D.innerHTML=`
        <p>Com base no acumulado do sistema (<strong>${l(b)}</strong> Entradas vs <strong>${l(g+y+T)}</strong> Saídas):</p>
        <div style="background:rgba(15,23,42,0.6);padding:1rem;border-radius:10px;margin:.75rem 0;border:1px solid var(--border-color)">
          <div style="display:flex;justify-content:space-between;margin-bottom:.4rem;flex-wrap:wrap;gap:.5rem">
            <span>💰 Saldo Livre Acumulado: <strong>${l(S)}</strong></span>
            <span>🎯 Meta Anual: <strong>${l(t)}</strong> (Faltam ${d} meses no ano)</span>
          </div>
          ...
          <div style="display:flex;justify-content:space-between;font-size:.78rem;color:var(--text-muted);margin-top:.4rem">
            <span>Guardado: ${l(a)}</span>
            <span>Progresso da Meta Anual: ${x}%</span>
          </div>
        </div>
        <p style="font-size:.84rem;color:var(--text-muted)">
          💡 <strong>Recomendação de Reserva:</strong> Guardando <strong>${l(m)}/mês</strong> nos próximos ${d} meses, você atingirá com sucesso a sua meta anual de <strong>${l(t)}</strong>!
        </p>
      `}be()}function be(){const t=document.getElementById("container-analise-mensal-lista");if(!t)return;const e=ft();if(!e.length){t.innerHTML='<div class="empty-state">Nenhum mês registrado para gerar a análise mensal.</div>';return}const a=e.map(o=>{const s=N.filter(v=>v.mesAno===o).reduce((v,E)=>v+(E.valor||0),0),r=P.filter(v=>v.mesAno===o),c=r.reduce((v,E)=>v+(E.valorTotal!==void 0?E.valorTotal:E.valor||0),0),d=V.filter(v=>v.mesAno===o),i=d.reduce((v,E)=>v+(E.valorTotal!==void 0?E.valorTotal:E.valor||0),0),u=F.filter(v=>v.mesAno===o);let m=0;u.forEach(v=>{v.formasPagamento&&(m+=v.formasPagamento.cartaoDebito||0)});const f=c+i+m,b=s-f,g=b>=0,[y,T]=o.split("-"),R=new Date(parseInt(y),parseInt(T)-1,1).toLocaleString("pt-BR",{month:"long"}),D=R.charAt(0).toUpperCase()+R.slice(1);let x="";if(g){const v=b*.5;x=`
        <div style="background:rgba(16,185,129,0.08); border:1px solid rgba(16,185,129,0.25); border-radius:10px; padding:.85rem 1rem; margin-top:1rem">
          ...
          <p style="font-size:.8rem; color:var(--text-muted); margin:0">
            Neste mês sobraram <strong>${l(b)}</strong> em conta. O sistema sugere destinar pelo menos <strong style="color:#34d399">${l(v)}</strong> para sua reserva!
          </p>
        </div>
      `}else{const v=Math.abs(b);let E="Cartão de Crédito",q=c;i>q&&(E="Boletos & Contas",q=i),m>q&&(E="Mercado no Débito",q=m);const H=f>0?(q/f*100).toFixed(1):0;let k="",L=0;r.forEach(p=>{const $=p.valorTotal!==void 0?p.valorTotal:p.valor||0;$>L&&(L=$,k=`Fatura do ${p.cartao||"Cartão"}`)}),d.forEach(p=>{const $=p.valorTotal!==void 0?p.valorTotal:p.valor||0;$>L&&(L=$,k=`Boleto ${p.descricao||"de Conta"}`)}),x=`
        <div style="background:rgba(244,63,94,0.1); border:1px solid rgba(244,63,94,0.3); border-radius:10px; padding:.85rem 1rem; margin-top:1rem">
          <div style="font-weight:700; font-size:.88rem; color:#fb7185; margin-bottom:.4rem; display:flex; align-items:center; gap:.4rem">
            ⚠️ O que causou o déficit em ${D}/${y}?
          </div>
          <p style="font-size:.82rem; color:var(--text-main); margin-bottom:.5rem; line-height:1.5">
            As saídas (<strong>${l(f)}</strong>) superaram as entradas (<strong>${l(s)}</strong>) em <strong style="color:#fb7185">${l(v)}</strong>.
          </p>
          <div style="font-size:.78rem; color:var(--text-muted); line-height:1.5">
            • <strong>Vilão Principal:</strong> A categoria <strong style="color:#f8fafc">${E}</strong> representou <strong>${H}%</strong> de todas as saídas do mês (${l(q)}).
            ${k?`<br>• <strong>Maior Despesa Registrada:</strong> ${k} no valor de <strong style="color:#fb7185">${l(L)}</strong>.`:""}
          </div>
        </div>
      `}return`
      <div class="card" style="margin-bottom:1.25rem; border-color:${g?"rgba(52,211,153,0.3)":"rgba(251,113,133,0.4)"}">
        <div class="card-header" style="flex-wrap:wrap; gap:.5rem">
          <div style="display:flex; align-items:center; gap:.5rem">
            <span class="card-title" style="font-size:1rem; color:#f8fafc">📅 ${D} de ${y}</span>
        ...
        <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(160px, 1fr)); gap:.75rem; margin-top:.5rem">
          ...
          <div style="background:rgba(15,23,42,0.8); padding:.6rem .8rem; border-radius:8px; border:1px solid ${g?"#34d399":"#fb7185"}">
            ...
            <div style="font-weight:800; font-size:1.05rem; color:${g?"#60a5fa":"#fb7185"}">${l(b)}</div>
          </div>
        </div>
  ...
  `}function he(){const t=document.getElementById("lista-mensal-container");if(!t)return;const e=new Date,a=new Date(e.getFullYear(),e.getMonth()+1,1),o=a.toLocaleString("pt-BR",{month:"long"}),n=a.getFullYear(),s=`${o.charAt(0).toUpperCase()+o.slice(1)} de ${n}`,r=te(a.getFullYear(),a.getMonth()),c=31.8,d=20,i=r*c,u=r*d,m={};let f=0;F.forEach(p=>{const $=p.valorAPagar||0;f+=$;const B=p.mesAno||"Outros";m[B]=(m[B]||0)+$});const b=Math.max(1,Object.keys(m).length),g=f/b,y={};F.forEach(p=>{(p.itens||[]).forEach($=>{const B=($.nome||"").toLowerCase().trim();B&&(y[B]||(y[B]={nome:$.nome,marca:$.marca||"Geral",qtdTotal:0,frequenciaNotas:0,valoresUnitarios:[]}),y[B].qtdTotal+=$.quantidade||1,y[B].frequenciaNotas+=1,$.valorUnitario&&y[B].valoresUnitarios.push($.valorUnitario))})});const T=Object.values(y).map(p=>{const $=p.valoresUnitarios.length>0?p.valoresUnitarios.reduce((X,dt)=>X+dt,0)/p.valoresUnitarios.length:0,B=p.qtdTotal/b,Z=b/Math.max(1,p.frequenciaNotas),lt=p.frequenciaNotas/b;let U=0;lt>=.35||B>=.7?U=Math.ceil(B):U=Math.round(B),U<1&&p.frequenciaNotas>=b&&(U=1);const K=U*$;return{nome:p.nome,marca:p.marca,frequenciaNotas:p.frequenciaNotas,intervaloMeses:Z,qtdMensalTaxa:B,totalEstimadoUnidades:U,valorUnitario:$,subtotalCalculado:K}}).filter(p=>p.totalEstimadoUnidades>0);T.sort((p,$)=>$.frequenciaNotas-p.frequenciaNotas);const S=T.reduce((p,$)=>p+$.subtotalCalculado,0),R=g>0?g*1.05:S;let D=1;S>R&&g>0&&(D=R/S);const x=T.map(p=>({...p,subtotalFinal:p.subtotalCalculado*D})),v=g>0?Math.min(S,R):S;let E=v;const q=Math.min(E,i);E-=q;const H=Math.min(E,u);E-=H;const k=E>0?E:0;let L=`
    <div class="card" style="margin-bottom:1.5rem; background: linear-gradient(135deg, rgba(30,41,59,0.9), rgba(15,23,42,0.95)); border: 1px solid #3b82f6;">
      ...
      <div class="payment-grid" style="margin-top:1rem;">
        <div class="payment-item" style="border-color: rgba(16,185,129,0.4);">
          ...
          <div class="p-val" style="color:#34d399;">${l(q)} <span style="font-size:0.75rem;font-weight:normal;color:var(--text-muted)">/ ${l(i)}</span></div>
        </div>
      ...
      <div style="margin-top:1.25rem; padding-top:1rem; border-top:1px solid var(--border-color); display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:0.5rem;">
        ...
        <span style="font-size:1.6rem; font-weight:800; color:var(--primary);">${l(v)}</span>
      </div>
    </div>
  ...
  `;window.dadosListaMensalCache={mesAnoStr:s,diasUteis:r,totalGeralEstimado:v,cobertoAlim:q,cobertoCred:H,cobertoDeb:k,alimDisponivel:i,credDisponivel:u,lista:x},x.length===0?L+='<div class="empty-state">Adicione notas fiscais para que o sistema gere automaticamente sua lista mensal de compras.</div></div>':L+=`
      <div class="table-responsive">
        <table class="custom-table">
          <thead>
            <tr>
          ...
          <tbody>
            ${x.map(p=>{const $=p.intervaloMeses>1.2?`A cada ${p.intervaloMeses.toFixed(1)} meses`:`Todo mês (${p.frequenciaNotas}x)`,B=p.qtdMensalTaxa<1?p.qtdMensalTaxa.toFixed(2):p.qtdMensalTaxa.toFixed(1),Z=p.totalEstimadoUnidades.toFixed(1);return`
                <tr>
  ...
  `;c.document.open(),c.document.write(d),c.document.close()};document.getElementById("btn-start-cam").addEventListener("click",Nt);document.getElementById("btn-switch-cam").addEventListener("click",ye);document.getElementById("btn-stop-cam").addEventListener("click",ht);async function Nt(){if(typeof Html5Qrcode>"u")return O("Carregando biblioteca de câmera, aguarde..."),setTimeout(Nt,600);try{G||(G=new Html5Qrcode("qr-reader")),j=await Html5Qrcode.getCameras();let t;if(j&&j.length>0){const e=j.findIndex(a=>/back|traseira|rear|environment/i.test(a.label));tt=e>=0?e:0,t=j[tt].id}else t={facingMode:"environment"};await G.start(t,{fps:10,qrbox:{width:240,height:240}},Vt,()=>{}),ot=!0,document.getElementById("btn-start-cam").style.display="none",document.getElementById("btn-switch-cam").style.display=j.length>1?"inline-flex":"none",document.getElementById("btn-stop-cam").style.display="inline-flex"}catch(t){O("❌ Não foi possível acessar a câmera. Verifique as permissões do navegador."),console.error(t)}}async function ye(){if(!(!G||!ot))try{await G.stop(),j.length>1&&(tt=(tt+1)%j.length,await G.start(j[tt].id,{fps:10,qrbox:{width:240,height:240}},Vt,()=>{}))}catch(t){console.error("switchCam:",t)}}async function ht(){if(G&&ot)try{await G.stop()}catch{}ot=!1,document.getElementById("btn-start-cam").style.display="inline-flex",document.getElementById("btn-switch-cam").style.display="none",document.getElementById("btn-stop-cam").style.display="none"}async function Vt(t){ht(),document.getElementById("inp-url").value=t,O("✅ QR Code lido! Processando..."),await jt(t)}document.getElementById("btn-carregar-dados").addEventListener("click",async()=>{const t=document.getElementById("inp-url").value.trim(),e=document.getElementById("inp-html").value.trim();if(!t&&!e){O("⚠️ Cole a URL do QR Code ou o conteúdo da página para ler a nota fiscal.");return}if(t&&!e){O("⏳ Consultando nota fiscal..."),await jt(t);return}if(e){O("⏳ Processando conteúdo..."),await Ht(e);return}});document.getElementById("btn-preencher-manual").addEventListener("click",()=>{Ut({nomeMercado:"",dataEmissao:new Date().toISOString(),valorTotal:0,descontoTotal:0,valorAPagar:0,qtdTotalItens:0,formasPagamento:{valeAlimentacao:0,cartaoCredito:0,cartaoDebito:0},itens:[]}),O("✍️ Preencha os dados da compra abaixo e clique em Salvar Nota Fiscal.","var(--accent-cyan)")});function Ut(t){var s,r,c;document.getElementById("inp-mercado").value=t.nomeMercado||"",document.getElementById("inp-data").value=Xt(t.dataEmissao),document.getElementById("inp-vtotal").value=t.valorTotal!==void 0?t.valorTotal:0,document.getElementById("inp-desconto").value=t.descontoTotal!==void 0?t.descontoTotal:0,document.getElementById("inp-pagar").value=t.valorAPagar!==void 0?t.valorAPagar:0,document.getElementById("inp-qtd").value=t.qtdTotalItens!==void 0?t.qtdTotalItens:0,document.getElementById("inp-alim").value=((s=t.formasPagamento)==null?void 0:s.valeAlimentacao)||0,document.getElementById("inp-cred").value=((r=t.formasPagamento)==null?void 0:r.cartaoCredito)||0,document.getElementById("inp-deb").value=((c=t.formasPagamento)==null?void 0:c.cartaoDebito)||0,_=t.itens||[];const e=document.getElementById("form-nfce");e.style.display="block";const a=document.getElementById("preview-itens-box"),o=document.getElementById("count-preview-itens"),n=document.getElementById("lista-preview-itens");_.length>0?(a.style.display="block",o.textContent=_.length,n.innerHTML=_.map(d=>`
    ...
    `).join("")):a.style.display="none",e.scrollIntoView({behavior:"smooth"})}document.getElementById("form-nfce").addEventListener("submit",async t=>{t.preventDefault();const e=document.getElementById("inp-mercado").value.trim()||"Mercado",a=document.getElementById("inp-data").value||new Date().toISOString(),o=parseFloat(document.getElementById("inp-vtotal").value)||0,n=parseFloat(document.getElementById("inp-desconto").value)||0,s=parseFloat(document.getElementById("inp-pagar").value)||0,r=parseInt(document.getElementById("inp-qtd").value)||0,c=parseFloat(document.getElementById("inp-alim").value)||0,d=parseFloat(document.getElementById("inp-cred").value)||0,i=parseFloat(document.getElementById("inp-deb").value)||0,u=new Date(a).toISOString().slice(0,16),m=F.find(g=>{const y=new Date(g.dataEmissao).toISOString().slice(0,16),T=Math.abs((g.valorAPagar||0)-s)<.05,S=(g.nomeMercado||"").toLowerCase().trim()===e.toLowerCase().trim();return y===u&&T&&S});if(m){O(`⚠️ Esta nota fiscal já existe no sistema (Cadastrada em ${it(m.dataEmissao)} no valor de ${l(m.valorAPagar)}). Nota não adicionada!`,"#fb7185"),h("⚠️ Nota fiscal já cadastrada! Operação cancelada.");return}const f=new Date(a),b=`${f.getFullYear()}-${String(f.getMonth()+1).padStart(2,"0")}`;O("⏳ Salvando nota fiscal no banco...");try{await mt(Q(C,gt),{nomeMercado:e,dataEmissao:a,mesAno:b,qtdTotalItens:r||_.length,valorTotal:o,descontoTotal:n,valorAPagar:s,formasPagamento:{valeAlimentacao:c,cartaoCredito:d,cartaoDebito:i},itens:_,createdAt:vt()}),O("✅ Nota salva com sucesso!","#34d399"),document.getElementById("form-nfce").style.display="none",document.getElementById("form-nfce").reset(),document.getElementById("inp-url").value="",document.getElementById("inp-html").value="",_=[],Ct(),goTab("dashboard"),h("🎉 Nota fiscal registrada no Firebase!")}catch(g){O("❌ Erro ao salvar: "+g.message,"#fb7185")}});async function jt(t){const e=[a=>`https://api.allorigins.win/raw?url=${encodeURIComponent(a)}`,a=>`https://corsproxy.io/?${encodeURIComponent(a)}`];for(const a of e)try{const o=await fetch(a(t),{signal:AbortSignal.timeout(8e3)});if(o.ok){const n=await o.text();if(n&&n.length>200){await Ht(n);return}}}catch{}Ee(t)}function Ee(t){document.getElementById("modal-link").href=t,document.getElementById("modal-cors").classList.add("active"),O("⚠️ Abra o link, copie o conteúdo da página e cole no campo de texto abaixo.")}async function Ht(t){const e=$e(t);Ut(e),O("✅ Nota lida com sucesso! Confira os valores abaixo e altere se necessário antes de Salvar.","#34d399")}function $e(t){var q,H,k;const a=new DOMParser().parseFromString(t,"text/html"),o=((q=a.body)==null?void 0:q.textContent)||t;let n=((k=(H=a.querySelector(".txtTopo, .nomeEmit, h1"))==null?void 0:H.textContent)==null?void 0:k.trim())||"Mercado",s=new Date().toISOString();const r=o.match(/Emiss[ãa]o\s*[:\-]?\s*(\d{2}\/\d{2}\/\d{4})\s+(\d{2}:\d{2}:\d{2})?/i)||o.match(/(\d{2}\/\d{2}\/\d{4})\s+(\d{2}:\d{2}:\d{2})/);if(r){const[L,p,$]=r[1].split("/");s=`${$}-${p}-${L}T${r[2]||"12:00:00"}`}const c=o.match(/Qtd\.?\s*total\s*de\s*itens\s*[:\s]*([\d,\.]+)/i),d=o.match(/Valor\s*total\s*R\$\s*[:\s]*([\d\.,]+)/i),i=o.match(/Descontos?\s*R\$\s*[:\s]*([\d\.,]+)/i),u=o.match(/Valor\s*a\s*pagar\s*R\$\s*[:\s]*([\d\.,]+)/i)||o.match(/VALOR\s*PAGO\s*R\$\s*[:\s]*([\d\.,]+)/i),m=o.match(/(?:Vale\s*)?Alimenta[çc][ãa]o\s*[:\s]*([\d\.,]+)/i),f=o.match(/(?:Cart[ãa]o\s*de\s*)?Cr[eé]dito\s*[:\s]*([\d\.,]+)/i),b=o.match(/(?:Cart[ãa]o\s*de\s*)?D[eé]bito\s*[:\s]*([\d\.,]+)/i),g=c?M(c[1]):0,y=d?M(d[1]):0,T=i?M(i[1]):0;let S=u?M(u[1]):y-T;const R={valeAlimentacao:m?M(m[1]):0,cartaoCredito:f?M(f[1]):0,cartaoDebito:b?M(b[1]):0},D=[];a.querySelectorAll("tr, .item, .itemNota").forEach(L=>{var yt;const p=L.textContent;if(!/Vl\.\s*Unit|valorUnitario|Qtde?\./i.test(p))return;const $=L.querySelector(".txtTit, .txtTit2, .nomeProd"),B=((yt=$==null?void 0:$.textContent)==null?void 0:yt.trim())||"",Z=p.match(/Qtde?\.\s*[:\s]*([\d,\.]+)/i),lt=p.match(/Vl\.\s*Unit\.\s*[:\s]*([\d,\.]+)/i),U=p.match(/Vl\.\s*Total\s*([\d,\.]+)/i),K=p.match(/C[oó]digo\s*[:\s]*(\d+)/i),X=p.match(/UN\s*[:\s]*([A-Za-z]+)/i),dt=Z?M(Z[1]):1,ut=lt?M(lt[1]):0,Qt=U?M(U[1]):ut*dt;B&&ut>0&&D.push({codigo:(K==null?void 0:K[1])||"",nome:B,marca:xe(B),quantidade:dt,unidade:(X==null?void 0:X[1])||"Un",valorUnitario:ut,valorTotal:Qt})});const v=new Date(s),E=`${v.getFullYear()}-${String(v.getMonth()+1).padStart(2,"0")}`;return{nomeMercado:n,dataEmissao:s,mesAno:E,qtdTotalItens:g,valorTotal:y,descontoTotal:T,valorAPagar:S,formasPagamento:R,itens:D}}function xe(t){const e=["BAUDUCCO","BAUD","PANCO","DANONE","NESTLE","QUALITA","SADIA","PERDIGAO","SEARA","CAMIL","TIO JOAO","URBANO","LIZA","SOYA","YPE","PILAO","MELITTA","3 CORACOES","VIGOR","PARMALAT","ITALAC","HEINZ","KRAFT"],a=t.toUpperCase();for(const o of e)if(a.includes(o))return o;return a.split(" ")[0]||"Genérica"}function Ie(){const t=document.getElementById("lista-historico");if(!F.length){t.innerHTML='<div class="empty-state">📭 Nenhuma compra cadastrada ainda.</div>';return}t.innerHTML=F.map(e=>{var a,o,n;return`
    <div class="purchase-card">
    ...
    <tbody>${a.map(o=>{const n=Object.keys(o.hist).sort();let s=n.map(c=>`${c}: <strong>${l(o.hist[c])}</strong>`).join(" → "),r='<span class="badge cyan">Estável</span>';if(n.length>=2){const c=o.hist[n[n.length-2]],i=o.hist[n[n.length-1]]-c,u=(i/c*100).toFixed(1);i>.01?r=`<span class="badge red">+${u}% ↑</span>`:i<-.01&&(r=`<span class="badge green">${u}% ↓</span>`)}return`<tr><td><strong>${o.nome}</strong></td><td><span class="badge amber">${o.marca||"—"}</span></td><td>${s}</td><td>${r}</td></tr>`}).join("")}</tbody>
      ...
      </table></div>`:'<div class="empty-state">Adicione notas para ver a recorrência de itens.</div>';const s=Object.entries(o).filter(([,r])=>Object.keys(r).length>1).map(([r,c])=>{let d=1/0,i="";const u=Object.entries(c).map(([m,f])=>{const b=f.reduce((g,y)=>g+y,0)/f.length;return b<d&&(d=b,i=m),{marca:m,med:b}});return`<div class="brand-card">
