import{initializeApp as tt}from"https://www.gstatic.com/firebasejs/10.14.1/firebase-app.js";import{getFirestore as at,onSnapshot as re,query as ot,collection as W,orderBy as nt,doc as R,deleteDoc as Z,setDoc as H,addDoc as fe,serverTimestamp as $e}from"https://www.gstatic.com/firebasejs/10.14.1/firebase-firestore.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))o(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const i of s.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&o(i)}).observe(document,{childList:!0,subtree:!0});function a(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function o(n){if(n.ep)return;n.ep=!0;const s=a(n);fetch(n.href,s)}})();const Me=document.createElement("script");Me.src="https://cdn.jsdelivr.net/npm/chart.js@4.4.7/dist/chart.umd.min.js";document.head.appendChild(Me);const Se=document.createElement("script");Se.src="https://unpkg.com/html5-qrcode@2.3.8/html5-qrcode.min.js";document.head.appendChild(Se);const st={apiKey:"AIzaSyANpFnEIkyN1XCT6qbtmVR9wx7sQHEsyrE",authDomain:"comprasmercado-23913.firebaseapp.com",projectId:"comprasmercado-23913",storageBucket:"comprasmercado-23913.firebasestorage.app",messagingSenderId:"317518149234",appId:"1:317518149234:web:94f38624d68a2b9a6634eb",measurementId:"G-2XP88EK37S"},rt=tt(st),B=at(rt),be="compras",ie="entradas",se="faturas",oe="boletos",De="reservas",ee="estimativas";let U=[],Q=[],V=[],N=[],J=[],_={valorAtualGuardado:0},he=null,X=null,Y=[],me=0,ue=!1,ae=[];function l(t){return Number(t||0).toLocaleString("pt-BR",{style:"currency",currency:"BRL"})}function q(t){if(typeof t=="number")return t;if(!t)return 0;const e=parseFloat(String(t).replace(/R\$\s?/gi,"").replace(/\s/g,"").replace(/\./g,"").replace(",","."));return isNaN(e)?0:e}function pe(t){if(!t)return"—";try{return new Date(t).toLocaleString("pt-BR",{dateStyle:"short",timeStyle:"short"})}catch{return t}}function A(t,e=3500){const a=document.getElementById("toast");a.textContent=t,a.classList.add("show"),setTimeout(()=>a.classList.remove("show"),e)}function G(t,e="var(--accent-amber)"){const a=document.getElementById("status-msg");a&&(a.textContent=t,a.style.color=e)}function it(t){if(!t)return new Date().toISOString().slice(0,16);try{const e=new Date(t);if(isNaN(e.getTime()))return new Date().toISOString().slice(0,16);const a=o=>String(o).padStart(2,"0");return`${e.getFullYear()}-${a(e.getMonth()+1)}-${a(e.getDate())}T${a(e.getHours())}:${a(e.getMinutes())}`}catch{return new Date().toISOString().slice(0,16)}}function lt(t,e){let a=0;const o=new Date(t,e+1,0).getDate();for(let n=1;n<=o;n++){const s=new Date(t,e,n).getDay();s!==0&&s!==6&&a++}return a}window.goTab=function(t){document.querySelectorAll(".tab-content").forEach(a=>a.classList.remove("active")),document.querySelectorAll(".desktop-nav .nav-item").forEach(a=>a.classList.remove("active")),document.querySelectorAll(".mobile-nav .mob-btn").forEach(a=>a.classList.remove("active"));const e=document.getElementById("tab-"+t);e&&e.classList.add("active"),document.querySelectorAll(`[data-tab="${t}"]`).forEach(a=>a.classList.add("active"))};document.querySelectorAll("[data-tab]").forEach(t=>{t.addEventListener("click",()=>goTab(t.getAttribute("data-tab")))});document.querySelectorAll(".sub-item").forEach(t=>{t.addEventListener("click",()=>{document.querySelectorAll(".sub-item").forEach(a=>a.classList.remove("active")),document.querySelectorAll(".sub-tab-content").forEach(a=>a.style.display="none"),t.classList.add("active");const e=document.getElementById("sub-"+t.getAttribute("data-sub"));e&&(e.style.display="block")})});function Oe(){document.getElementById("modal-add-nota").classList.add("active")}function Le(){ue&&Ie(),document.getElementById("modal-add-nota").classList.remove("active")}var Te;(Te=document.getElementById("btn-open-modal-home"))==null||Te.addEventListener("click",Oe);var we;(we=document.getElementById("btn-mercado-add-nota"))==null||we.addEventListener("click",Oe);var Ce;(Ce=document.getElementById("btn-close-modal-add"))==null||Ce.addEventListener("click",Le);re(ot(W(B,be),nt("dataEmissao","desc")),t=>{U=t.docs.map(e=>({id:e.id,...e.data()})),K()},t=>console.error("Firestore Mercado:",t));re(W(B,ie),t=>{Q=t.docs.map(e=>({id:e.id,...e.data()})),K()},t=>console.error("Firestore Entradas:",t));re(W(B,se),t=>{V=t.docs.map(e=>({id:e.id,...e.data()})),K()},t=>console.error("Firestore Faturas:",t));re(W(B,oe),t=>{N=t.docs.map(e=>({id:e.id,...e.data()})),K()},t=>console.error("Firestore Boletos:",t));re(R(B,De,"config"),t=>{t.exists()&&(_=t.data()),K()},t=>console.error("Firestore Reservas:",t));re(W(B,ee),t=>{J=t.docs.map(e=>({id:e.id,...e.data()})),K()},t=>console.error("Firestore Estimativas:",t));let E=new Date().toISOString().slice(0,7);const Re=new Set;function le(){const t=new Set,e=new Date().toISOString().slice(0,7);t.add(e);const a=new Date,o=new Date(a.getFullYear(),a.getMonth()+1,1),n=i=>String(i).padStart(2,"0"),s=`${o.getFullYear()}-${n(o.getMonth()+1)}`;return t.add(s),E&&t.add(E),Q.forEach(i=>{i.mesAno&&t.add(i.mesAno)}),V.forEach(i=>{i.mesAno&&t.add(i.mesAno)}),N.forEach(i=>{i.mesAno&&t.add(i.mesAno)}),U.forEach(i=>{i.mesAno&&t.add(i.mesAno)}),J.forEach(i=>{i.mesAno&&t.add(i.mesAno)}),Array.from(t).filter(i=>!Re.has(i)).sort().reverse()}window.excluirMesSelecionadoAtual=function(){window.excluirDadosDoMes(E)};window.selecionarMesGlobal=function(t){if(!t)return;E=t;const e=document.getElementById("inp-seletor-mes-global");e&&(e.value=t);const a=document.getElementById("inp-entradas-mes-ano");a&&(a.value=t);const o=document.getElementById("inp-fatura-vencimento");o&&(o.value=`${t}-10`,typeof atualizarMesRefFatura=="function"&&atualizarMesRefFatura());const n=document.getElementById("inp-boleto-vencimento");n&&(n.value=`${t}-10`,typeof atualizarMesRefBoleto=="function"&&atualizarMesRefBoleto()),K()};window.verMesEIrParaControle=function(t){selecionarMesGlobal(t),typeof goTab=="function"&&goTab("mensal")};function dt(){const t=document.getElementById("seletor-meses-bar"),e=document.getElementById("seletor-meses-bar-salarios"),a=document.getElementById("seletor-meses-bar-estimativa"),o=le();o.includes(E)||(E=o[0]||new Date().toISOString().slice(0,7));const n=document.getElementById("inp-seletor-mes-global");n&&n.value!==E&&(n.value=E);const s=document.getElementById("inp-entradas-mes-ano");s&&s.value!==E&&(s.value=E);const i=o.map(d=>{const[u,m]=d.split("-"),p=new Date(parseInt(u),parseInt(m)-1,1).toLocaleString("pt-BR",{month:"short"}).toUpperCase().replace(".",""),b=d===E;return`
    ...
    `}).join("");t&&(t.innerHTML=i),e&&(e.innerHTML=i),a&&(a.innerHTML=i)}window.switchMensalSub=function(t){document.querySelectorAll("[data-mensal-sub]").forEach(o=>o.classList.remove("active")),document.querySelectorAll(".mensal-sub-content").forEach(o=>o.style.display="none");const e=document.querySelector(`[data-mensal-sub="${t}"]`);e&&e.classList.add("active");const a=document.getElementById(t);a&&(a.style.display="block")};function K(){dt(),ut(),ct(),Pe(),Et(),xt(),Ct(),Bt(),Lt(),Rt(),Ft(),Tt()}function ct(){const t=E,e=Q.filter(h=>h.mesAno===t),a=V.filter(h=>h.mesAno===t),o=N.filter(h=>h.mesAno===t),n=U.filter(h=>h.mesAno===t),s=e.reduce((h,w)=>h+(w.valor||0),0),i=a.reduce((h,w)=>h+(w.valorTotal!==void 0?w.valorTotal:w.valor||0),0),d=o.reduce((h,w)=>h+(w.valorTotal!==void 0?w.valorTotal:w.valor||0),0);let u=0;n.forEach(h=>{h.formasPagamento&&(u+=h.formasPagamento.cartaoDebito||0)});const m=s-i-d-u,v=document.getElementById("m-total-entradas");v&&(v.textContent=l(s));const p=document.getElementById("m-total-cartoes");p&&(p.textContent=l(i));const b=document.getElementById("m-total-boletos");b&&(b.textContent=l(d));const r=document.getElementById("m-mercado-debito");r&&(r.textContent=l(u));const c=document.getElementById("m-saldo-liquido");c&&(c.textContent=l(m),c.style.color=m>=0?"#60a5fa":"#fb7185");const[g,I]=t.split("-"),M=new Date(parseInt(g),parseInt(I)-1,1).toLocaleString("pt-BR",{month:"long"}),T=M.charAt(0).toUpperCase()+M.slice(1),C=document.getElementById("m-lbl-saldo-liquido");C&&(C.textContent=`Saldo Líquido (${T}/${g})`),mt(e,a,o,n)}function mt(t,e,a,o){const n=document.getElementById("content-salarios-mes");n&&(n.innerHTML=`
  ...
  `}window.excluirDadosDoMes=async function(t){const e=t||E;if(!e)return;const[a,o]=e.split("-"),s=new Date(parseInt(a),parseInt(o)-1,1).toLocaleString("pt-BR",{month:"long"}),i=`${s.charAt(0).toUpperCase()+s.slice(1)} de ${a}`,d=Q.filter(r=>r.mesAno===e),u=V.filter(r=>r.mesAno===e),m=N.filter(r=>r.mesAno===e),v=U.filter(r=>r.mesAno===e),p=J.filter(r=>r.id===e),b=`⚠️ TEM CERTEZA QUE DESEJA EXCLUIR O MÊS ${i.toUpperCase()} (${e})?
...
`}return n}catch(e){return e.name==="PasswordException"?A("🔒 O PDF precisa de senha válida para ser aberto."):console.error("Erro ao ler PDF:",e),""}}function ft(t){if(!t)return null;const e=t.match(/Total\s*a\s*Pagar\s*[:\s]*R?\$\s*([\d\.,]+)/i)||t.match(/no\s*valor\s*de\s*R?\$\s*([\d\.,]+)/i)||t.match(/Valor\s*total\s*da\s*fatura\s*[:\s]*R?\$\s*([\d\.,]+)/i)||t.match(/Total\s*da\s*fatura\s*[:\s]*R?\$\s*([\d\.,]+)/i);if(e){const a=q(e[1]);if(a>0)return a}return null}function bt(t){if(!t)return null;const e=t.match(/Vencimento\s*[:\s]*(\d{2}[\/\.-]\d{2}[\/\.-]\d{4})/i)||t.match(/Data\s*de\s*vencimento\s*[:\s]*(\d{2})\s+([A-Za-z]{3})\s+(\d{4})/i)||t.match(/FATURA\s+(\d{2})\s+([A-Za-z]{3})\s+(\d{4})/i);if(e){if(e[2]&&e[3]){const a=e[1],o=e[2].toUpperCase(),n=e[3],i={JAN:"01",FEB:"02",MAR:"03",ABR:"04",APR:"04",MAI:"05",MAY:"05",JUN:"06",JUL:"07",AGO:"08",AUG:"08",SET:"09",SEP:"09",OUT:"10",OCT:"10",NOV:"11",DEZ:"12",DEC:"12"}[o]||"07";return`${n}-${i}-${a.padStart(2,"0")}`}else if(e[1]){const[a,o,n]=e[1].split(/[\/\.-]/);return`${n}-${o.padStart(2,"0")}-${a.padStart(2,"0")}`}}return null}window.importarFaturaManualOuArquivo=async function(){const t=document.getElementById("inp-fatura-txt").value.trim();if(!t){A("⚠️ Selecione o arquivo da fatura (.pdf, .csv) ou cole o texto da fatura.");return}await Ne(t,Ae)};async function Ne(t,e){const a=bt(t);a&&(document.getElementById("inp-fatura-vencimento").value=a,atualizarMesRefFatura());const o=ft(t),n=yt(t),s=document.getElementById("inp-fatura-vencimento").value||new Date().toISOString().slice(0,10),i=s.slice(0,7),d=n.reduce((b,r)=>b+r.valor,0),u=o||d||0,m=e?`Cartão ${e}`:"Fatura Cartão";P={cartao:e||"Nubank",descricao:m,dataVencimento:s,mesAno:i,valorTotal:u,qtdItens:n.length,itens:n};const v=document.getElementById("inp-revisao-fatura-desc");v&&(v.value=m);const p=document.getElementById("inp-revisao-fatura-val");p&&(p.value=u?u.toFixed(2):""),qe(),n.length>0?A(`✅ ${n.length} compras encontradas! Fatura total: ${l(u)}.`):A("ℹ️ Fatura pronta para revisão. Confirme o valor total e o cartão abaixo.")}window.atualizarValorTotalRevisaoFatura=function(){var e;if(!P)return;const t=parseFloat((e=document.getElementById("inp-revisao-fatura-val"))==null?void 0:e.value)||0;P.valorTotal=t,document.getElementById("badge-total-preview-fatura").textContent=l(t)};function qe(){if(!P)return;const{valorTotal:t,itens:e,cartao:a,descricao:o}=P;document.getElementById("badge-total-preview-fatura").textContent=l(t);const n=document.getElementById("inp-revisao-fatura-desc");n&&(!n.value||n.value==="Fatura Cartão")&&(n.value=o||`Cartão ${a||"Nubank"}`);const s=document.getElementById("inp-revisao-fatura-val");s&&(!s.value||parseFloat(s.value)===0)&&(s.value=t?t.toFixed(2):"");const i=document.getElementById("lista-preview-fatura-itens");!e||!e.length?i.innerHTML='<div class="empty-state">Nenhum item individual extraído. O valor total acima será considerado.</div>':i.innerHTML=e.map((u,m)=>`
    ...
    `).join("");const d=document.getElementById("box-revisao-fatura");d.style.display="block",d.scrollIntoView({behavior:"smooth"})}window.removerItemRevisaoFatura=function(t){if(!P||!P.itens)return;P.itens.splice(t,1);const e=P.itens.reduce((a,o)=>a+o.valor,0);if(e>0){P.valorTotal=e;const a=document.getElementById("inp-revisao-fatura-val");a&&(a.value=e.toFixed(2))}P.qtdItens=P.itens.length,qe(),A("🗑️ Item removido da revisão da fatura.")};window.confirmarEGravarFaturaDocumento=async function(){var o,n;if(!P)return;const t=(o=document.getElementById("inp-revisao-fatura-desc"))==null?void 0:o.value.trim(),e=parseFloat((n=document.getElementById("inp-revisao-fatura-val"))==null?void 0:n.value)||0,a=document.getElementById("inp-fatura-vencimento").value||new Date().toISOString().slice(0,10);if(!e){A("⚠️ Digite ou confirme o valor total da fatura.");return}P.cartao=t||P.cartao||"Cartão",P.valorTotal=e,P.dataVencimento=a,P.mesAno=a.slice(0,7);try{await fe(W(B,se),{...P,createdAt:$e()}),document.getElementById("box-revisao-fatura").style.display="none",document.getElementById("inp-fatura-txt").value="";const s=document.getElementById("txt-file-fatura");s&&(s.textContent="Clique para Selecionar o Arquivo da Fatura");const i=l(P.valorTotal);P=null,A(`🎉 Fatura de ${i} salva com sucesso!`)}catch(s){alert("Erro ao salvar fatura: "+s.message)}};function yt(t){if(!t)return[];const e=[],a=/(?:[@\)\(\*•\s]+)?(\d{2}[\/\.-]\d{2}(?:[\/\.-]\d{2,4})?|\d{2}\s+[A-Za-z]{3})\s+(.+?)\s+(?:(\d{2}\/\d{2})\s+)?(-?R?\$\s*[\d\.]+,\d{2}|-?[\d\.]+,\d{2})/gi;if(t.split(`
`).forEach(n=>{const s=n.trim();if(!s||/EMISS[ÃA]O|TRANSA[ÇC][ÕO]ES|RESUMO|PAGAMENTO DE FATURA|TOTAL DA FATURA|FATURA ANTERIOR|SALDO ANTERIOR|LIMITE DISPON[ÍI]VEL|OPÇÕES DE PAGAMENTO|ALTERNATIVAS DE PAGAMENTO|PAGAMENTO E DEMAIS|PARCELAMENTOS|DESPESAS|HISTÓRICO DE FATURAS|SUPERCRÉDITO|SAQUE À CRÉDITO|COMPRA DATA DESCRIÇÃO/i.test(s))return;const i=/(?:[@\)\(\*•\s]+)?(\d{2}[\/\.-]\d{2}(?:[\/\.-]\d{2,4})?|\d{2}\s+[A-Za-z]{3})\s+(.+?)\s+(?:(\d{2}\/\d{2})\s+)?(-?R?\$\s*[\d\.]+,\d{2}|-?[\d\.]+,\d{2})$/i,d=s.match(i)||s.match(/(?:[@\)\(\*•\s]+)?(\d{2}[\/\.-]\d{2}(?:[\/\.-]\d{2,4})?|\d{2}\s+[A-Za-z]{3})\s+(.+?)\s+(?:(\d{2}\/\d{2})\s+)?(-?R?\$\s*[\d\.]+,\d{2}|-?[\d\.]+,\d{2})/i);if(d){const u=d[1];let m=d[2].trim();const v=d[3],p=d[4];if(p.includes("-")||/DEB AUTOM|PAGAMENTO|PAGTO|CR[ÉE]DITO FATURA/i.test(m))return;const b=q(p);v&&(m+=` (${v})`),m&&b>0&&m.length>2&&!/fatura|limite|pagamento|saldo|alternativas|opções|período|emissão|vencimento/i.test(m)&&e.push({dataCompra:u,descricao:m,valor:b})}}),e.length===0){let n;for(;(n=a.exec(t))!==null;){const s=n[1];let i=n[2].trim();const d=n[3],u=n[4];if(u.includes("-")||/DEB AUTOM|PAGAMENTO|PAGTO|CR[ÉE]DITO FATURA/i.test(i))continue;const m=q(u);d&&(i+=` (${d})`),i&&m>0&&i.length>2&&!/fatura|limite|pagamento|saldo|alternativas|opções|período|emissão|vencimento/i.test(i)&&e.push({dataCompra:s,descricao:i,valor:m})}}return e}window.ultimosLocaisAnalisados={};function Ue(t){if(!t)return"DIVERSOS";let e=t.replace(/\(\d{1,2}\/\d{1,2}\)/gi,"").replace(/\b\d{1,2}\/\d{1,2}\b/gi,"").replace(/\b\d{1,2}x\b/gi,"").trim();return e=e.replace(/\s+/g," "),e.toUpperCase()}function je(t){const e={};(Array.isArray(t)?t:[t]).forEach(n=>{!n||!n.itens||!Array.isArray(n.itens)||n.itens.forEach(s=>{if(!s.descricao||!s.valor)return;const i=Ue(s.descricao);e[i]||(e[i]={nome:i,qtd:0,valorTotal:0,compras:[]}),e[i].qtd+=1,e[i].valorTotal+=s.valor||0,e[i].compras.push({dataCompra:s.dataCompra||"—",descricao:s.descricao,valor:s.valor||0,cartao:n.cartao||"Cartão",mesAno:n.mesAno||"—"})})});const o=Object.values(e).filter(n=>n.qtd>=2);return o.sort((n,s)=>s.valorTotal-n.valorTotal),o}function Ve(t,e="geral"){const a=je(t);if(a.forEach(n=>{window.ultimosLocaisAnalisados[`${e}_${n.nome}`]=n}),!a.length)return`
  ...
  `,a.style.display="flex"};window.fecharModalEstabelecimento=function(){const t=document.getElementById("modal-detalhes-estabelecimento");t&&(t.style.display="none")};function Ee(t){if(!t)return{nome:"Outros & Diversos",icone:"📦",cor:"blue"};const e=t.toUpperCase();return e.includes("ZARA")||e.includes("RENNER")||e.includes("C&A")||e.includes("RIACHUELO")||e.includes("ROUPA")||e.includes("VESTUARIO")||e.includes("SAPATO")||e.includes("CALCADO")||e.includes("CENTAURO")||e.includes("NIKE")||e.includes("ADIDAS")||e.includes("SHEIN")||e.includes("DAFITI")?{nome:"Vestuário & Roupas",icone:"👗",cor:"rose"}:e.includes("VIAGEM")||e.includes("AIRBNB")||e.includes("BOOKING")||e.includes("HOTEL")||e.includes("POUSADA")||e.includes("DECOLAR")||e.includes("LATAM")||e.includes("GOL")||e.includes("AZUL")||e.includes("FLIGHT")||e.includes("PASSAGEM")||e.includes("PASSAGENS")?{nome:"Viagens & Hospedagem",icone:"✈️",cor:"purple"}:e.includes("AUTOPOSTO")||e.includes("POSTO")||e.includes("UBER")||e.includes("99")||e.includes("SHELL")||e.includes("IPIRANGA")||e.includes("PETROBRAS")||e.includes("COMBUSTIVEL")||e.includes("PEDAGIO")?{nome:"Transporte & Combustível",icone:"⛽",cor:"amber"}:e.includes("SAVEGNAGO")||e.includes("TONELLI")||e.includes("SUPERMERCADO")||e.includes("MERCADO")||e.includes("ATACADAO")||e.includes("CARREFOUR")||e.includes("PAO DE ACUCAR")||e.includes("MARTINS")?{nome:"Supermercado & Alimentação",icone:"🛒",cor:"green"}:e.includes("SORVETERIA")||e.includes("PIZZA")||e.includes("BURGER")||e.includes("IFOOD")||e.includes("RESTAURANTE")||e.includes("BAR")||e.includes("PUB")||e.includes("DELICIAS")||e.includes("CHOCOLATE")||e.includes("CINEMA")||e.includes("OUTBACK")||e.includes("MC DONALDS")||e.includes("KFC")?{nome:"Restaurantes & Lazer",icone:"🍕",cor:"orange"}:e.includes("COSMETICO")||e.includes("COSMETICOS")||e.includes("FARMACIA")||e.includes("DROGARIA")||e.includes("DROGASIL")||e.includes("PAGUE MENOS")||e.includes("PERFUMARIA")||e.includes("NATURA")||e.includes("BOTICARIO")||e.includes("ESSENCIA")?{nome:"Saúde & Cosméticos",icone:"💄",cor:"pink"}:e.includes("AMAZON")||e.includes("MERCADO LIVRE")||e.includes("MAGALU")||e.includes("MAGAZINE")||e.includes("SHOPEE")||e.includes("ALIEXPRESS")||e.includes("FAST SHOP")||e.includes("APPLE")||e.includes("KABUM")?{nome:"Eletrônicos & Shopping",icone:"📱",cor:"cyan"}:{nome:"Outros & Diversos",icone:"📦",cor:"blue"}}function ht(t){if(!t||!t.length)return"";const e=[];t.forEach(r=>{r.itens&&Array.isArray(r.itens)&&r.itens.forEach(c=>{c.descricao&&c.valor&&e.push({...c,cartao:r.cartao||"Cartão",mesAno:r.mesAno||"Outros"})})});const a=t.reduce((r,c)=>r+(c.valorTotal!==void 0?c.valorTotal:c.valor||0),0),o={};e.forEach(r=>{const c=Ue(r.descricao);o[c]||(o[c]={nome:c,valorTotal:0,qtd:0}),o[c].valorTotal+=r.valor,o[c].qtd+=1});const n=Object.values(o).sort((r,c)=>c.valorTotal-r.valorTotal).slice(0,5),s={};e.forEach(r=>{const c=Ee(r.descricao);s[c.nome]||(s[c.nome]={...c,valorTotal:0,qtd:0}),s[c.nome].valorTotal+=r.valor,s[c.nome].qtd+=1});const i=Object.values(s).sort((r,c)=>c.valorTotal-r.valorTotal),d={};t.forEach(r=>{const c=r.mesAno||"Outros";d[c]||(d[c]=[]),d[c].push(r)});const u=Object.keys(d).sort((r,c)=>c.localeCompare(r)),m=u[0],v=u[1];let p="",b="";if(m&&v){let T=function(f){if(!f||!f.includes("-"))return f;const[$,F]=f.split("-"),L=new Date(parseInt($),parseInt(F)-1,1).toLocaleString("pt-BR",{month:"long"});return`${L.charAt(0).toUpperCase()+L.slice(1)}/${$}`};const r=d[m]||[],c=d[v]||[],g=r.reduce((f,$)=>f+($.valorTotal!==void 0?$.valorTotal:$.valor||0),0),I=c.reduce((f,$)=>f+($.valorTotal!==void 0?$.valorTotal:$.valor||0),0),x=g-I,M=I>0?(x/I*100).toFixed(1):0,C=T(m),h=T(v),w={},S={};r.forEach(f=>{f.itens&&f.itens.forEach($=>{const F=Ee($.descricao).nome;w[F]=(w[F]||0)+($.valor||0)})}),c.forEach(f=>{f.itens&&f.itens.forEach($=>{const F=Ee($.descricao).nome;S[F]=(S[F]||0)+($.valor||0)})});const j=Array.from(new Set([...Object.keys(w),...Object.keys(S)])),z=[];j.forEach(f=>{const $=w[f]||0,F=S[f]||0,O=$-F;if(O>50){const L=F>0?(O/F*100).toFixed(0):"100+";z.push({categoria:f,vAtual:$,vAnterior:F,difCat:O,pctCat:L})}}),z.sort((f,$)=>$.difCat-f.difCat);let D=x>0?"📈":"📉",y=x>0?"+":"";p=`
      <div style="background:rgba(15,23,42,0.7); border:1px solid var(--border-color); border-radius:10px; padding:.85rem 1rem; margin-bottom:1rem; display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:.75rem">
        <div>
          <span style="font-size:.82rem; color:var(--text-muted); display:block">⚖️ Comparativo Mês Atual (${C}) vs Mês Anterior (${h})</span>
          <div style="font-size:1.05rem; font-weight:700; color:#f8fafc; margin-top:.2rem">
            ${l(g)} <span style="font-size:.82rem; font-weight:400; color:var(--text-muted)">em ${C}</span> vs ${l(I)} <span style="font-size:.82rem; font-weight:400; color:var(--text-muted)">em ${h}</span>
          </div>
        </div>
        <div style="text-align:right">
          <span class="badge ${x>0?"rose":"green"}" style="font-size:.88rem; padding:.35rem .75rem">
            ${D} Variação: ${y}${l(x)} (${y}${M}%)
          </span>
        </div>
      </div>
    `,z.length>0?b=`
        <div style="margin-top:1rem; background:rgba(251,113,133,0.08); border:1px dashed rgba(251,113,133,0.35); border-radius:10px; padding:.85rem 1rem">
          <div style="font-weight:700; font-size:.9rem; color:#fb7185; margin-bottom:.5rem; display:flex; align-items:center; gap:.4rem">
            💡 DICAS DE ECONOMIA & RECOMENDAÇÕES (Categorias com Aumento em ${C}):
          </div>
  ...
  `}function Et(){const t=V.reduce((d,u)=>d+(u.valorTotal!==void 0?u.valorTotal:u.valor||0),0);document.getElementById("badge-total-cartoes").textContent=`${l(t)} total`;const e=document.getElementById("lista-faturas-registradas");if(!V.length){e.innerHTML='<div class="empty-state">Nenhuma fatura cadastrada ainda.</div>';return}const a=ht(V),o=Ve(V,"geral"),n={};V.forEach(d=>{const u=d.mesAno||"Outros";n[u]||(n[u]=[]),n[u].push(d)});const i=Object.keys(n).sort((d,u)=>u.localeCompare(d)).map((d,u)=>{const m=n[d],v=m.reduce((r,c)=>r+(c.valorTotal!==void 0?c.valorTotal:c.valor||0),0);let p=d;if(d!=="Outros"&&d.includes("-")){const[r,c]=d.split("-"),I=new Date(parseInt(r),parseInt(c)-1,1).toLocaleString("pt-BR",{month:"long"});p=`${I.charAt(0).toUpperCase()+I.slice(1)} de ${r}`}const b=u===0;return`
      <div class="card" style="margin-bottom:1.25rem;background:rgba(15,23,42,0.45);border:1px solid var(--border-color)">
        ...
        <div id="fat-group-${d}" class="purchase-details ${b?"open":""}" style="padding:.75rem 1rem;display:${b?"block":"none"}">
          ${m.map(r=>{var h;const c=r.valorTotal!==void 0?r.valorTotal:r.valor||0,g=r.cartao||"Cartão",I=g.toLowerCase().includes("nubank"),x=I?"purple":"red",M=I?"🟣":"🔴",T=r.dataVencimento?pe(r.dataVencimento).split(",")[0]:"—",C=r.mesAno||"—";return`
              <div class="purchase-card" style="margin-bottom:1rem">
                <div class="purchase-header" onclick="toggleDetail('fat-${r.id}')">
                  <div class="purchase-info">
                    <h3><span class="badge ${x}">${M} ${g}</span> — Vencimento: ${T}</h3>
                    <p>📅 Mês Referência: <strong>${C}</strong> &nbsp;•&nbsp; 🛒 ${r.qtdItens||((h=r.itens)==null?void 0:h.length)||1} itens contemplados</p>
                  </div>
                  <div class="purchase-values" style="display:flex;align-items:center;gap:.75rem">
                    <div style="text-align:right">
    ...
    `).join("");const o=document.getElementById("box-revisao-boleto");o.style.display="block",o.scrollIntoView({behavior:"smooth"})}window.removerItemRevisaoBoleto=function(t){if(!k||!k.itens)return;k.itens.splice(t,1);const e=k.itens.reduce((a,o)=>a+o.valor,0);e>0&&(k.valorTotal=e,document.getElementById("inp-revisao-boleto-val").value=e.toFixed(2)),k.qtdItens=k.itens.length,_e(),A("🗑️ Item removido da revisão do boleto.")};window.confirmarEGravarBoletoDocumento=async function(){if(!k)return;const t=document.getElementById("inp-revisao-boleto-desc").value.trim(),e=parseFloat(document.getElementById("inp-revisao-boleto-val").value)||0,a=document.getElementById("inp-boleto-vencimento").value||new Date().toISOString().slice(0,10);if(!e){A("⚠️ Digite ou confirme o valor total do boleto.");return}k.descricao=t||"Boleto / Conta",k.valorTotal=e,k.dataVencimento=a,k.mesAno=a.slice(0,7);try{await fe(W(B,oe),{...k,createdAt:$e()}),document.getElementById("box-revisao-boleto").style.display="none",document.getElementById("inp-boleto-txt").value="";const o=document.getElementById("txt-file-boleto");o&&(o.textContent="Clique para Selecionar o Arquivo do Boleto");const n=l(k.valorTotal);k=null,A(`🎉 Boleto de ${n} salvo com sucesso!`)}catch(o){alert("Erro ao salvar boleto: "+o.message)}};function At(t){if(!t)return{beneficiario:"",valorTotal:0,vencimento:null,itens:[]};let e="",a=0,o=null;const n=[],s=t.match(/Vencimento\s*[:\s]*(\d{2}[\/\.-]\d{2}[\/\.-]\d{4})/i)||t.match(/Vencimento\s*[:\s]*(\d{2})\s+([A-Za-z]{3})\s+(\d{4})/i)||t.match(/Data\s*de\s*Vencimento\s*[:\s]*(\d{2}[\/\.-]\d{2}[\/\.-]\d{4})/i);if(s){if(s[2]&&s[3]){const m=s[1],v=s[2].toUpperCase();o=`${s[3]}-${{JAN:"01",FEB:"02",MAR:"03",ABR:"04",APR:"04",MAI:"05",MAY:"05",JUN:"06",JUL:"07",AGO:"08",AUG:"08",SET:"09",SEP:"09",OUT:"10",OCT:"10",NOV:"11",DEZ:"12",DEC:"12"}[v]||"07"}-${m.padStart(2,"0")}`}else if(s[1]){const[m,v,p]=s[1].split(/[\/\.-]/);o=`${p}-${v.padStart(2,"0")}-${m.padStart(2,"0")}`}}const i=t.match(/Benefici[áa]rio\s*[:\s]*([^\n\r]+)/i)||t.match(/Nome\s*do\s*Cedente\s*[:\s]*([^\n\r]+)/i)||t.match(/Raz[ãa]o\s*Social\s*[:\s]*([^\n\r]+)/i);i&&(e=i[1].trim().replace(/\s{2,}/g," "));const d=t.match(/Valor\s*do\s*Documento\s*[:\s]*R?\$\s*([\d\.]+,\d{2})/i)||t.match(/\(=\)\s*Valor\s*Cobrado\s*[:\s]*R?\$\s*([\d\.]+,\d{2})/i)||t.match(/Valor\s*Cobrado\s*[:\s]*R?\$\s*([\d\.]+,\d{2})/i)||t.match(/Valor\s*R?\$\s*([\d\.]+,\d{2})/i);return d&&(a=q(d[1])),t.split(`
`).forEach(m=>{const v=m.trim();if(!v||/vencimento|beneficiário|cedente|nosso\s*número|agência|código|autenticação|instruções/i.test(v))return;const p=v.match(/(\d{2}[\/\.-]\d{2}(?:[\/\.-]\d{2,4})?|\b[A-Za-z]{3}\b)?\s*(.+?)\s+R?\$\s*([\d\.]+,\d{2})$/i);if(p){const b=p[1]||"Boleto",r=p[2].trim(),c=q(p[3]);r&&c>0&&r.length>2&&!/valor|total|documento|cobrado/i.test(r)&&n.push({dataBoleto:b,descricao:r,valor:c})}}),{beneficiario:e,valorTotal:a,vencimento:o,itens:n}}function It(t){const e=document.getElementById("container-analise-boletos-recorrentes");if(!e)return;if(!t||!t.length){e.innerHTML="";return}const a={};t.forEach(r=>{const c=ne(r);a[c]||(a[c]={nome:c,valorTotalAno:0,qtd:0,historicoMeses:{}});const g=r.valorTotal!==void 0?r.valorTotal:r.valor||0;a[c].valorTotalAno+=g,a[c].qtd+=1;const I=r.mesAno||"Outros";a[c].historicoMeses[I]=(a[c].historicoMeses[I]||0)+g});const o=Object.values(a).sort((r,c)=>c.valorTotalAno-r.valorTotalAno),n=Array.from(new Set(t.map(r=>r.mesAno||"Outros"))).sort((r,c)=>c.localeCompare(r)),s=n[0],i=n[1];function d(r){if(!r||!r.includes("-"))return r;const[c,g]=r.split("-"),x=new Date(parseInt(c),parseInt(g)-1,1).toLocaleString("pt-BR",{month:"long"});return`${x.charAt(0).toUpperCase()+x.slice(1)}/${c}`}const u=d(s),m=d(i),v=[];s&&i&&o.forEach(r=>{const c=r.historicoMeses[s],g=r.historicoMeses[i];if(c!==void 0&&g!==void 0){const I=c-g;if(I>5){const x=(I/g*100).toFixed(1);v.push({nome:r.nome,valAtual:c,valAnterior:g,dif:I,pct:x})}}}),v.sort((r,c)=>c.dif-r.dif);const p=t.reduce((r,c)=>r+(c.valorTotal!==void 0?c.valorTotal:c.valor||0),0);let b="";s&&i&&(v.length>0?b=`
        <div style="margin-top:1rem; background:rgba(251,113,133,0.08); border:1px dashed rgba(251,113,133,0.35); border-radius:10px; padding:.85rem 1rem">
          <div style="font-weight:700; font-size:.9rem; color:#fb7185; margin-bottom:.5rem; display:flex; align-items:center; gap:.4rem">
    ...
    <div class="card" style="margin-bottom:1.5rem; background:linear-gradient(135deg,rgba(30,41,59,.98),rgba(15,23,42,.99)); border-color:#c084fc; box-shadow:0 4px 22px rgba(192,132,252,0.18)">
      ...
      <div style="display:grid; grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); gap:.85rem; margin-top:.75rem">
        ${o.map(r=>{const c=r.qtd>0?r.valorTotalAno/r.qtd:0;let g='<span class="badge gray" style="font-size:.72rem">Único registro</span>';if(s&&i){const I=r.historicoMeses[s],x=r.historicoMeses[i];if(I!==void 0&&x!==void 0){const M=I-x;if(M>0){const T=(M/x*100).toFixed(1);g=`<span class="badge rose" style="font-size:.75rem" title="Subiu ${l(M)} em relação a ${m}">📈 +${l(M)} (+${T}%)</span>`}else if(M<0){const T=(Math.abs(M)/x*100).toFixed(1);g=`<span class="badge green" style="font-size:.75rem" title="Caiu ${l(Math.abs(M))} em relação a ${m}">📉 ${l(M)} (-${T}%)</span>`}else g='<span class="badge purple" style="font-size:.75rem">🟢 R$ 0,00 (Estável)</span>'}}return`
  ...
  </table></div>`}window.editarValorBoletoDocumento=function(t){const e=N.find(s=>s.id===t);if(!e)return;const a=e.valorTotal!==void 0?e.valorTotal:e.valor||0,o=typeof ne=="function"?ne(e):e.descricao||"Boleto";document.getElementById("inp-edit-boleto-id").value=t,document.getElementById("inp-edit-item-index").value="",document.getElementById("inp-edit-boleto-desc").value=o,document.getElementById("inp-edit-boleto-valor").value=a.toFixed(2),document.getElementById("titulo-modal-editar-boleto").textContent="✏️ Editar Valor do Boleto";const n=document.getElementById("modal-editar-boleto");n&&(n.classList.add("active"),setTimeout(()=>{const s=document.getElementById("inp-edit-boleto-valor");s&&(s.focus(),s.select())},100))};window.editarItemBoleto=function(t,e){const a=N.find(i=>i.id===t);if(!a||!a.itens||!a.itens[e])return;const o=a.itens[e],n=o.valor||0;document.getElementById("inp-edit-boleto-id").value=t,document.getElementById("inp-edit-item-index").value=e,document.getElementById("inp-edit-boleto-desc").value=o.descricao||(typeof ne=="function"?ne(a):"Item"),document.getElementById("inp-edit-boleto-valor").value=n.toFixed(2),document.getElementById("titulo-modal-editar-boleto").textContent="✏️ Editar Valor do Item";const s=document.getElementById("modal-editar-boleto");s&&(s.classList.add("active"),setTimeout(()=>{const i=document.getElementById("inp-edit-boleto-valor");i&&(i.focus(),i.select())},100))};window.fecharModalEditarBoleto=function(){const t=document.getElementById("modal-editar-boleto");t&&t.classList.remove("active")};document.getElementById("form-editar-boleto").addEventListener("submit",async t=>{t.preventDefault();const e=document.getElementById("inp-edit-boleto-id").value,a=document.getElementById("inp-edit-item-index").value,o=document.getElementById("inp-edit-boleto-valor").value,n=parseFloat(o);if(!e||isNaN(n)||n<=0){alert("Por favor, informe um valor numérico válido maior que zero.");return}const s=N.find(i=>i.id===e);if(s)try{const i=R(B,oe,e);if(a===""){const d={valorTotal:n,valor:n,dataAtualizacao:new Date().toISOString()};if(s.itens&&s.itens.length>0){const u=[...s.itens];u[0]={...u[0],valor:n},d.itens=u}await H(i,d,{merge:!0}),A(`✏️ Valor do boleto atualizado para ${l(n)} em todo o sistema!`)}else{const d=parseInt(a);if(s.itens&&s.itens[d]){const u=[...s.itens];u[d]={...u[d],valor:n};const m=u.reduce((v,p)=>v+(p.valor||0),0);await H(i,{...s,itens:u,valorTotal:m,valor:m,dataAtualizacao:new Date().toISOString()},{merge:!0}),A(`✏️ Item do boleto atualizado para ${l(n)} em todo o sistema!`)}}fecharModalEditarBoleto()}catch(i){alert("Erro ao atualizar valor do boleto: "+i.message)}});window.removerItemBoletoCadastrado=async function(t,e){const a=N.find(s=>s.id===t);if(!a||!a.itens||!confirm("Remover este item do boleto?"))return;const o=[...a.itens];o.splice(e,1);const n=o.reduce((s,i)=>s+(i.valor||0),0);o.length===0?(await Z(R(B,oe,t)),A("🗑️ Boleto excluído pois todos os itens foram removidos.")):(await H(R(B,oe,t),{...a,itens:o,valorTotal:n,qtdItens:o.length}),A("🗑️ Item removido do boleto."))};window.excluirBoletoDocumento=async function(t){const e=N.find(n=>n.id===t),a=e?e.descricao||"Boleto / Conta":"este boleto",o=e?l(e.valorTotal!==void 0?e.valorTotal:e.valor||0):"";confirm(`⚠️ Deseja realmente excluir ${a} ${o?"("+o+")":""}?

Este boleto será removido permanentemente de todos os meses, resumos e relatórios do sistema.`)&&(await Z(R(B,oe,t)),A("🗑️ Boleto removido de todo o sistema com sucesso."))};document.getElementById("form-config-reservas").addEventListener("submit",async t=>{t.preventDefault();const e=parseFloat(document.getElementById("inp-meta-anual").value)||0,a=parseFloat(document.getElementById("inp-saldo-guardado").value)||0;_.metaAnual=e,_.valorAtualGuardado=a,await H(R(B,De,"config"),{metaAnual:e,valorAtualGuardado:a,dataAtualizacao:new Date().toISOString()}),A("✅ Reservas e configurações de economias salvas!"),K()});function Tt(){const t=_&&_.metaAnual!==void 0?_.metaAnual:15e3,e=_&&_.valorAtualGuardado!==void 0?_.valorAtualGuardado:3e3,a=document.getElementById("inp-meta-anual");a&&document.activeElement!==a&&(a.value=t);const o=document.getElementById("inp-saldo-guardado");o&&document.activeElement!==o&&(o.value=e);const s=new Date().getMonth()+1,i=Math.max(1,12-s+1),d=Math.max(0,t-e),u=d>0?d/i:0;document.getElementById("val-meta-reserva").textContent=l(u);const m=document.getElementById("subtext-meta-reserva");m&&(m.textContent=`Faltam ${l(d)} p/ Meta Anual de ${l(t)} (${i} mês(es) até o fim do ano)`),document.getElementById("val-real-guardado").textContent=l(e);const v=le();let p=0,b=0,r=0,c=0;v.forEach(D=>{const y=Q.filter(O=>O.mesAno===D).reduce((O,L)=>O+(L.valor||0),0),f=V.filter(O=>O.mesAno===D).reduce((O,L)=>O+(L.valorTotal!==void 0?L.valorTotal:L.valor||0),0),$=N.filter(O=>O.mesAno===D).reduce((O,L)=>O+(L.valorTotal!==void 0?L.valorTotal:L.valor||0),0);let F=0;U.filter(O=>O.mesAno===D).forEach(O=>{O.formasPagamento&&(F+=O.formasPagamento.cartaoDebito||0)}),p+=y,b+=f,r+=$,c+=F});const g=b+r+c,I=p-g,x=Math.max(1,v.length),M=p/x,T=g/x,C=I/x,h=C>0?C:0,w=h*i,S=e+w;document.getElementById("val-recomendacao-reserva").textContent=l(S);const j=document.getElementById("subtext-recomendacao");if(j)if(S>=t)j.innerHTML=`✅ Projeção de <strong style="color:#34d399">${l(S)}</strong> até Dez/2026 supera sua Meta Anual de ${l(t)}!`;else{const D=t-S;j.innerHTML=`⚠️ Sobra média de ${l(h)}/mês. Projeção de ${l(S)} fica <strong style="color:#fb7185">${l(D)}</strong> abaixo da Meta de ${l(t)}.`}const z=document.getElementById("box-analise-reserva-detalhes");if(z)if(p===0)z.innerHTML='<p class="empty-state">Cadastre seus salários e entradas na aba "Salários & Entradas" para gerar o diagnóstico inteligente de economias.</p>';else{const D=t>0?Math.min(100,e/t*100).toFixed(1):0,y=S>=t;let f="";if(y)f=`
          <div style="background:rgba(16,185,129,0.12);border:1px solid rgba(16,185,129,0.35);border-radius:8px;padding:.85rem 1rem;margin-top:.85rem">
            ...
            <p style="font-size:.85rem;color:#f1f5f9;margin-top:.35rem;line-height:1.45">
              Com base na sua média de sobra mensal livre de <strong style="color:#34d399">${l(C)}/mês</strong> (Entradas: ${l(M)} vs Saídas: ${l(T)}), a projeção é acumular <strong style="color:#34d399">${l(S)}</strong> até o fim do ano.
              Isso <strong>SUPERA a sua Meta Anual de ${l(t)}</strong> (contemplando o valor já guardado de ${l(e)})!
            </p>
          </div>
        `;else if(C>0){const $=Math.max(0,u-C);f=`
          <div style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.35);border-radius:8px;padding:.85rem 1rem;margin-top:.85rem">
            ...
            <p style="font-size:.85rem;color:#f1f5f9;margin-top:.35rem;line-height:1.45">
              Com a sua sobra média mensal atual de <strong style="color:#fbbf24">${l(C)}/mês</strong>, o sistema projeta acumular <strong style="color:#60a5fa">${l(S)}</strong> até o fim do ano (somando os ${l(e)} já guardados).
        ...
        `}else f=`
          <div style="background:rgba(251,113,133,0.12);border:1px solid rgba(251,113,133,0.35);border-radius:8px;padding:.85rem 1rem;margin-top:.85rem">
            ...
            <p style="font-size:.85rem;color:#f1f5f9;margin-top:.35rem;line-height:1.45">
              No histórico dos ${x} meses registrados, suas saídas (${l(g)}) superaram as entradas (${l(p)}), com saldo médio negativo de ${l(C)}/mês.
        ...
        <p style="margin-bottom:.5rem;font-weight:600">
          Com base no histórico dos ${x} mês(es) registrados (Média Entradas: <strong>${l(M)}</strong> vs Saídas: <strong>${l(T)}</strong>):
        </p>
        ...
        ${f}
      `}wt()}function wt(){const t=document.getElementById("container-analise-mensal-lista");if(!t)return;const e=le();if(!e.length){t.innerHTML='<div class="empty-state">Nenhum mês registrado para gerar a análise mensal.</div>';return}const a=e.map(o=>{const s=Q.filter(h=>h.mesAno===o).reduce((h,w)=>h+(w.valor||0),0),i=V.filter(h=>h.mesAno===o),d=i.reduce((h,w)=>h+(w.valorTotal!==void 0?w.valorTotal:w.valor||0),0),u=N.filter(h=>h.mesAno===o),m=u.reduce((h,w)=>h+(w.valorTotal!==void 0?w.valorTotal:w.valor||0),0),v=U.filter(h=>h.mesAno===o);let p=0;v.forEach(h=>{h.formasPagamento&&(p+=h.formasPagamento.cartaoDebito||0)});const b=d+m+p,r=s-b,c=r>=0,[g,I]=o.split("-"),M=new Date(parseInt(g),parseInt(I)-1,1).toLocaleString("pt-BR",{month:"long"}),T=M.charAt(0).toUpperCase()+M.slice(1);let C="";if(c){const h=r*.5;C=`
      ...
      `}else{const h=Math.abs(r);let w="Cartão de Crédito",S=d;m>S&&(w="Boletos & Contas",S=m),p>S&&(w="Mercado no Débito",S=p);const j=b>0?(S/b*100).toFixed(1):0;let z="",D=0;i.forEach(y=>{const f=y.valorTotal!==void 0?y.valorTotal:y.valor||0;f>D&&(D=f,z=`Fatura do ${y.cartao||"Cartão"}`)}),u.forEach(y=>{const f=y.valorTotal!==void 0?y.valorTotal:y.valor||0;f>D&&(D=f,z=`Boleto ${y.descricao||"de Conta"}`)}),C=`
        <div style="background:rgba(244,63,94,0.1); border:1px solid rgba(244,63,94,0.3); border-radius:10px; padding:.85rem 1rem; margin-top:1rem">
          <div style="font-weight:700; font-size:.88rem; color:#fb7185; margin-bottom:.4rem; display:flex; align-items:center; gap:.4rem">
            ⚠️ O que causou o déficit em ${T}/${g}?
          </div>
          ...
          <div style="font-size:.78rem; color:var(--text-muted); line-height:1.5">
            • <strong>Vilão Principal:</strong> A categoria <strong style="color:#f8fafc">${w}</strong> representou <strong>${j}%</strong> de todas as saídas do mês (${l(S)}).
      ...
      <div class="card" style="margin-bottom:1.25rem; border-color:${c?"rgba(52,211,153,0.3)":"rgba(251,113,133,0.4)"}">
        <div class="card-header" style="flex-wrap:wrap; gap:.5rem">
          <div style="display:flex; align-items:center; gap:.5rem">
            <span class="card-title" style="font-size:1rem; color:#f8fafc">📅 ${T} de ${g}</span>
  ...
  `}const ge=[{id:"est_1",nome:"Corte de Cabelo Victor",quantidade:2,valorUnitario:70},{id:"est_2",nome:"Compra Programada Tunico",quantidade:1,valorUnitario:150},{id:"est_3",nome:"Sobrancelha Maria",quantidade:1,valorUnitario:50},{id:"est_4",nome:"Unha Maria",quantidade:1,valorUnitario:90},{id:"est_5",nome:"Banho Tunico",quantidade:1,valorUnitario:65},{id:"est_6",nome:"Saída Simples",quantidade:2,valorUnitario:100},{id:"est_7",nome:"Saída Premiun",quantidade:1,valorUnitario:150},{id:"est_8",nome:"Saída Premiun Plus",quantidade:1,valorUnitario:200},{id:"est_9",nome:"Mercado Pontual",quantidade:4,valorUnitario:70},{id:"est_10",nome:"Farmacia",quantidade:2,valorUnitario:35},{id:"est_11",nome:"Padaria 3D",quantidade:10,valorUnitario:10}];window.abrirModalAddEstimativa=function(t=null){const e=document.getElementById("modal-add-estimativa");if(e){if(document.getElementById("inp-est-id").value=t||"",t){document.getElementById("titulo-modal-estimativa").textContent="✏️ Editar Gastos Previsto";const a=J.find(n=>n.id===E),o=((a==null?void 0:a.itens)||[]).find(n=>n.id===t);o&&(document.getElementById("inp-est-nome").value=o.nome||"",document.getElementById("inp-est-qtd").value=o.quantidade||1,document.getElementById("inp-est-val").value=o.valorUnitario||0)}else document.getElementById("titulo-modal-estimativa").textContent="➕ Adicionar Gastos Previsto",document.getElementById("inp-est-nome").value="",document.getElementById("inp-est-qtd").value=1,document.getElementById("inp-est-val").value="";e.classList.add("active")}};window.fecharModalAddEstimativa=function(){var t;(t=document.getElementById("modal-add-estimativa"))==null||t.classList.remove("active")};var Be;(Be=document.getElementById("form-item-estimativa"))==null||Be.addEventListener("submit",async t=>{t.preventDefault();const e=document.getElementById("inp-est-id").value,a=document.getElementById("inp-est-nome").value.trim(),o=parseFloat(document.getElementById("inp-est-qtd").value)||1,n=parseFloat(document.getElementById("inp-est-val").value)||0;if(!a){alert("Preencha a descrição do gasto.");return}const s=J.find(d=>d.id===E);let i=s?[...s.itens||[]]:[...ge];e?i=i.map(d=>d.id===e?{...d,nome:a,quantidade:o,valorUnitario:n}:d):i.push({id:"est_"+Date.now(),nome:a,quantidade:o,valorUnitario:n}),await H(R(B,ee,E),{mesAno:E,itens:i,ultimaAtualizacao:new Date().toISOString()}),fecharModalAddEstimativa(),A("✅ Estimativa atualizada!")});window.atualizarQtdItemEstimativa=async function(t,e){const a=J.find(s=>s.id===E);if(!a)return;const o=Math.max(1,parseInt(e)||1),n=(a.itens||[]).map(s=>s.id===t?{...s,quantidade:o}:s);await H(R(B,ee,E),{mesAno:E,itens:n,ultimaAtualizacao:new Date().toISOString()})};window.atualizarValorItemEstimativa=async function(t,e){const a=J.find(s=>s.id===E);if(!a)return;const o=Math.max(0,parseFloat(e)||0),n=(a.itens||[]).map(s=>s.id===t?{...s,valorUnitario:o}:s);await H(R(B,ee,E),{mesAno:E,itens:n,ultimaAtualizacao:new Date().toISOString()})};window.excluirItemEstimativa=async function(t){if(!confirm("Remover este item da estimativa do mês?"))return;const e=J.find(o=>o.id===E);if(!e)return;const a=(e.itens||[]).filter(o=>o.id!==t);await H(R(B,ee,E),{mesAno:E,itens:a,ultimaAtualizacao:new Date().toISOString()}),A("🗑️ Item removido da estimativa.")};window.resetarItensEstimativaPadrao=async function(){confirm(`Deseja carregar/resetar os 11 itens padrão de previsão para ${E}?`)&&(await H(R(B,ee,E),{mesAno:E,itens:ge,ultimaAtualizacao:new Date().toISOString()}),A("🔄 Itens padrão de estimativa carregados!"))};function Ct(){const t=document.getElementById("container-lista-estimativa");if(!t)return;const e=J.find(r=>r.id===E);let a=[];e&&Array.isArray(e.itens)?a=e.itens:(a=ge,H(R(B,ee,E),{mesAno:E,itens:ge,ultimaAtualizacao:new Date().toISOString()}).catch(r=>console.error("Auto init estimativa error:",r)));let o=0;a.forEach(r=>{o+=(r.quantidade||0)*(r.valorUnitario||0)});const n=document.getElementById("val-total-estimativa-mes");n&&(n.textContent=l(o));const[s,i]=E.split("-"),u=new Date(parseInt(s),parseInt(i)-1,1).toLocaleString("pt-BR",{month:"long"}),m=u.charAt(0).toUpperCase()+u.slice(1),v=document.getElementById("subtext-estimativa-mes");v&&(v.textContent=`Total previsto para ${m} de ${s} (${a.length} itens cadastrados)`);const p=document.getElementById("badge-count-estimativa");if(p&&(p.textContent=`${a.length} itens previstos`),!a.length){t.innerHTML=`
  ...
  `;t.innerHTML=b}function Bt(){const t=document.getElementById("lista-mensal-container");if(!t)return;const e=new Date,a=new Date(e.getFullYear(),e.getMonth()+1,1),o=a.toLocaleString("pt-BR",{month:"long"}),n=a.getFullYear(),s=`${o.charAt(0).toUpperCase()+o.slice(1)} de ${n}`,i=lt(a.getFullYear(),a.getMonth()),d=31.8,u=20,m=i*d,v=i*u,p={};let b=0;U.forEach(y=>{const f=y.valorAPagar||0;b+=f;const $=y.mesAno||"Outros";p[$]=(p[$]||0)+f});const r=Math.max(1,Object.keys(p).length),c=b/r,g={};U.forEach(y=>{(y.itens||[]).forEach(f=>{const $=(f.nome||"").toLowerCase().trim();$&&(g[$]||(g[$]={nome:f.nome,marca:f.marca||"Geral",qtdTotal:0,frequenciaNotas:0,valoresUnitarios:[]}),g[$].qtdTotal+=f.quantidade||1,g[$].frequenciaNotas+=1,f.valorUnitario&&g[$].valoresUnitarios.push(f.valorUnitario))})});const I=Object.values(g).map(y=>{const f=y.valoresUnitarios.length>0?y.valoresUnitarios.reduce((ce,ve)=>ce+ve,0)/y.valoresUnitarios.length:0,$=y.qtdTotal/r,F=r/Math.max(1,y.frequenciaNotas),O=y.frequenciaNotas/r;let L=0;O>=.35||$>=.7?L=Math.ceil($):L=Math.round($),L<1&&y.frequenciaNotas>=r&&(L=1);const de=L*f;return{nome:y.nome,marca:y.marca,frequenciaNotas:y.frequenciaNotas,intervaloMeses:F,qtdMensalTaxa:$,totalEstimadoUnidades:L,valorUnitario:f,subtotalCalculado:de}}).filter(y=>y.totalEstimadoUnidades>0);I.sort((y,f)=>f.frequenciaNotas-y.frequenciaNotas);const x=I.reduce((y,f)=>y+f.subtotalCalculado,0),M=c>0?c*1.05:x;let T=1;x>M&&c>0&&(T=M/x);const C=I.map(y=>({...y,subtotalFinal:y.subtotalCalculado*T})),h=c>0?Math.min(x,M):x;let w=h;const S=Math.min(w,m);w-=S;const j=Math.min(w,v);w-=j;const z=w>0?w:0;let D=`
    ...
    <div class="card">
      <div class="card-header">
        ...
        <span class="badge amber">${C.length} itens cadastrados</span>
      </div>
  ...
  `;window.dadosListaMensalCache={mesAnoStr:s,diasUteis:i,totalGeralEstimado:h,cobertoAlim:S,cobertoCred:j,cobertoDeb:z,alimDisponivel:m,credDisponivel:v,lista:C},C.length===0?D+='<div class="empty-state">Adicione notas fiscais para que o sistema gere automaticamente sua lista mensal de compras.</div></div>':D+=`
      <div class="table-responsive">
        <table class="custom-table">
          <thead>
            <tr>
          ...
          <tbody>
            ${C.map(y=>{const f=y.intervaloMeses>1.2?`A cada ${y.intervaloMeses.toFixed(1)} meses`:`Todo mês (${y.frequenciaNotas}x)`,$=y.qtdMensalTaxa<1?y.qtdMensalTaxa.toFixed(2):y.qtdMensalTaxa.toFixed(1),F=y.totalEstimadoUnidades.toFixed(1);return`
                <tr>
  ...
  `;d.document.open(),d.document.write(u),d.document.close()};document.getElementById("btn-start-cam").addEventListener("click",Ze);document.getElementById("btn-switch-cam").addEventListener("click",Mt);document.getElementById("btn-stop-cam").addEventListener("click",Ie);async function Ze(){if(typeof Html5Qrcode>"u")return G("Carregando biblioteca de câmera, aguarde..."),setTimeout(Ze,600);try{X||(X=new Html5Qrcode("qr-reader")),Y=await Html5Qrcode.getCameras();let t;if(Y&&Y.length>0){const e=Y.findIndex(a=>/back|traseira|rear|environment/i.test(a.label));me=e>=0?e:0,t=Y[me].id}else t={facingMode:"environment"};await X.start(t,{fps:10,qrbox:{width:240,height:240}},Ye,()=>{}),ue=!0,document.getElementById("btn-start-cam").style.display="none",document.getElementById("btn-switch-cam").style.display=Y.length>1?"inline-flex":"none",document.getElementById("btn-stop-cam").style.display="inline-flex"}catch(t){G("❌ Não foi possível acessar a câmera. Verifique as permissões do navegador."),console.error(t)}}async function Mt(){if(!(!X||!ue))try{await X.stop(),Y.length>1&&(me=(me+1)%Y.length,await X.start(Y[me].id,{fps:10,qrbox:{width:240,height:240}},Ye,()=>{}))}catch(t){console.error("switchCam:",t)}}async function Ie(){if(X&&ue)try{await X.stop()}catch{}ue=!1,document.getElementById("btn-start-cam").style.display="inline-flex",document.getElementById("btn-switch-cam").style.display="none",document.getElementById("btn-stop-cam").style.display="none"}async function Ye(t){Ie(),document.getElementById("inp-url").value=t,G("✅ QR Code lido! Processando..."),await Je(t)}document.getElementById("btn-carregar-dados").addEventListener("click",async()=>{const t=document.getElementById("inp-url").value.trim(),e=document.getElementById("inp-html").value.trim();if(!t&&!e){G("⚠️ Cole a URL do QR Code ou o conteúdo da página para ler a nota fiscal.");return}if(t&&!e){G("⏳ Consultando nota fiscal..."),await Je(t);return}if(e){G("⏳ Processando conteúdo..."),await Ke(e);return}});document.getElementById("btn-preencher-manual").addEventListener("click",()=>{We({nomeMercado:"",dataEmissao:new Date().toISOString(),valorTotal:0,descontoTotal:0,valorAPagar:0,qtdTotalItens:0,formasPagamento:{valeAlimentacao:0,cartaoCredito:0,cartaoDebito:0},itens:[]}),G("✍️ Preencha os dados da compra abaixo e clique em Salvar Nota Fiscal.","var(--accent-cyan)")});function We(t){var s,i,d;document.getElementById("inp-mercado").value=t.nomeMercado||"",document.getElementById("inp-data").value=it(t.dataEmissao),document.getElementById("inp-vtotal").value=t.valorTotal!==void 0?t.valorTotal:0,document.getElementById("inp-desconto").value=t.descontoTotal!==void 0?t.descontoTotal:0,document.getElementById("inp-pagar").value=t.valorAPagar!==void 0?t.valorAPagar:0,document.getElementById("inp-qtd").value=t.qtdTotalItens!==void 0?t.qtdTotalItens:0,document.getElementById("inp-alim").value=((s=t.formasPagamento)==null?void 0:s.valeAlimentacao)||0,document.getElementById("inp-cred").value=((i=t.formasPagamento)==null?void 0:i.cartaoCredito)||0,document.getElementById("inp-deb").value=((d=t.formasPagamento)==null?void 0:d.cartaoDebito)||0,ae=t.itens||[];const e=document.getElementById("form-nfce");e.style.display="block";const a=document.getElementById("preview-itens-box"),o=document.getElementById("count-preview-itens"),n=document.getElementById("lista-preview-itens");ae.length>0?(a.style.display="block",o.textContent=ae.length,n.innerHTML=ae.map(u=>`
    ...
    `).join("")):a.style.display="none",e.scrollIntoView({behavior:"smooth"})}document.getElementById("form-nfce").addEventListener("submit",async t=>{t.preventDefault();const e=document.getElementById("inp-mercado").value.trim()||"Mercado",a=document.getElementById("inp-data").value||new Date().toISOString(),o=parseFloat(document.getElementById("inp-vtotal").value)||0,n=parseFloat(document.getElementById("inp-desconto").value)||0,s=parseFloat(document.getElementById("inp-pagar").value)||0,i=parseInt(document.getElementById("inp-qtd").value)||0,d=parseFloat(document.getElementById("inp-alim").value)||0,u=parseFloat(document.getElementById("inp-cred").value)||0,m=parseFloat(document.getElementById("inp-deb").value)||0,v=new Date(a).toISOString().slice(0,16),p=U.find(c=>{const g=new Date(c.dataEmissao).toISOString().slice(0,16),I=Math.abs((c.valorAPagar||0)-s)<.05,x=(c.nomeMercado||"").toLowerCase().trim()===e.toLowerCase().trim();return g===v&&I&&x});if(p){G(`⚠️ Esta nota fiscal já existe no sistema (Cadastrada em ${pe(p.dataEmissao)} no valor de ${l(p.valorAPagar)}). Nota não adicionada!`,"#fb7185"),A("⚠️ Nota fiscal já cadastrada! Operação cancelada.");return}const b=new Date(a),r=`${b.getFullYear()}-${String(b.getMonth()+1).padStart(2,"0")}`;G("⏳ Salvando nota fiscal no banco...");try{await fe(W(B,be),{nomeMercado:e,dataEmissao:a,mesAno:r,qtdTotalItens:i||ae.length,valorTotal:o,descontoTotal:n,valorAPagar:s,formasPagamento:{valeAlimentacao:d,cartaoCredito:u,cartaoDebito:m},itens:ae,createdAt:$e()}),G("✅ Nota salva com sucesso!","#34d399"),document.getElementById("form-nfce").style.display="none",document.getElementById("form-nfce").reset(),document.getElementById("inp-url").value="",document.getElementById("inp-html").value="",ae=[],Le(),goTab("dashboard"),A("🎉 Nota fiscal registrada no Firebase!")}catch(c){G("❌ Erro ao salvar: "+c.message,"#fb7185")}});async function Je(t){const e=[a=>`https://api.allorigins.win/raw?url=${encodeURIComponent(a)}`,a=>`https://corsproxy.io/?${encodeURIComponent(a)}`];for(const a of e)try{const o=await fetch(a(t),{signal:AbortSignal.timeout(8e3)});if(o.ok){const n=await o.text();if(n&&n.length>200){await Ke(n);return}}}catch{}St(t)}function St(t){document.getElementById("modal-link").href=t,document.getElementById("modal-cors").classList.add("active"),G("⚠️ Abra o link, copie o conteúdo da página e cole no campo de texto abaixo.")}async function Ke(t){const e=Dt(t);We(e),G("✅ Nota lida com sucesso! Confira os valores abaixo e altere se necessário antes de Salvar.","#34d399")}function Dt(t){var S,j,z;const a=new DOMParser().parseFromString(t,"text/html"),o=((S=a.body)==null?void 0:S.textContent)||t;let n=((z=(j=a.querySelector(".txtTopo, .nomeEmit, h1"))==null?void 0:j.textContent)==null?void 0:z.trim())||"Mercado",s=new Date().toISOString();const i=o.match(/Emiss[ãa]o\s*[:\-]?\s*(\d{2}\/\d{2}\/\d{4})\s+(\d{2}:\d{2}:\d{2})?/i)||o.match(/(\d{2}\/\d{2}\/\d{4})\s+(\d{2}:\d{2}:\d{2})/);if(i){const[D,y,f]=i[1].split("/");s=`${f}-${y}-${D}T${i[2]||"12:00:00"}`}const d=o.match(/Qtd\.?\s*total\s*de\s*itens\s*[:\s]*([\d,\.]+)/i),u=o.match(/Valor\s*total\s*R\$\s*[:\s]*([\d\.,]+)/i),m=o.match(/Descontos?\s*R\$\s*[:\s]*([\d\.,]+)/i),v=o.match(/Valor\s*a\s*pagar\s*R\$\s*[:\s]*([\d\.,]+)/i)||o.match(/VALOR\s*PAGO\s*R\$\s*[:\s]*([\d\.,]+)/i),p=o.match(/(?:Vale\s*)?Alimenta[çc][ãa]o\s*[:\s]*([\d\.,]+)/i),b=o.match(/(?:Cart[ãa]o\s*de\s*)?Cr[eé]dito\s*[:\s]*([\d\.,]+)/i),r=o.match(/(?:Cart[ãa]o\s*de\s*)?D[eé]bito\s*[:\s]*([\d\.,]+)/i),c=d?q(d[1]):0,g=u?q(u[1]):0,I=m?q(m[1]):0;let x=v?q(v[1]):g-I;const M={valeAlimentacao:p?q(p[1]):0,cartaoCredito:b?q(b[1]):0,cartaoDebito:r?q(r[1]):0},T=[];a.querySelectorAll("tr, .item, .itemNota").forEach(D=>{var xe;const y=D.textContent;if(!/Vl\.\s*Unit|valorUnitario|Qtde?\./i.test(y))return;const f=D.querySelector(".txtTit, .txtTit2, .nomeProd"),$=((xe=f==null?void 0:f.textContent)==null?void 0:xe.trim())||"",F=y.match(/Qtde?\.\s*[:\s]*([\d,\.]+)/i),O=y.match(/Vl\.\s*Unit\.\s*[:\s]*([\d,\.]+)/i),L=y.match(/Vl\.\s*Total\s*([\d,\.]+)/i),de=y.match(/C[oó]digo\s*[:\s]*(\d+)/i),ce=y.match(/UN\s*[:\s]*([A-Za-z]+)/i),ve=F?q(F[1]):1,ye=O?q(O[1]):0,et=L?q(L[1]):ye*ve;$&&ye>0&&T.push({codigo:(de==null?void 0:de[1])||"",nome:$,marca:Ot($),quantidade:ve,unidade:(ce==null?void 0:ce[1])||"Un",valorUnitario:ye,valorTotal:et})});const h=new Date(s),w=`${h.getFullYear()}-${String(h.getMonth()+1).padStart(2,"0")}`;return{nomeMercado:n,dataEmissao:s,mesAno:w,qtdTotalItens:c,valorTotal:g,descontoTotal:I,valorAPagar:x,formasPagamento:M,itens:T}}function Ot(t){const e=["BAUDUCCO","BAUD","PANCO","DANONE","NESTLE","QUALITA","SADIA","PERDIGAO","SEARA","CAMIL","TIO JOAO","URBANO","LIZA","SOYA","YPE","PILAO","MELITTA","3 CORACOES","VIGOR","PARMALAT","ITALAC","HEINZ","KRAFT"],a=t.toUpperCase();for(const o of e)if(a.includes(o))return o;return a.split(" ")[0]||"Genérica"}function Lt(){const t=document.getElementById("lista-historico");if(!U.length){t.innerHTML='<div class="empty-state">📭 Nenhuma compra cadastrada ainda.</div>';return}t.innerHTML=U.map(e=>{var a,o,n;return`
