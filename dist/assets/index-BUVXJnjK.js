import{initializeApp as Yt}from"https://www.gstatic.com/firebasejs/10.14.1/firebase-app.js";import{getFirestore as Zt,onSnapshot as nt,query as _t,collection as z,orderBy as Wt,doc as M,setDoc as st,addDoc as ct,deleteDoc as W,serverTimestamp as vt}from"https://www.gstatic.com/firebasejs/10.14.1/firebase-firestore.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))o(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const r of s.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&o(r)}).observe(document,{childList:!0,subtree:!0});function a(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function o(n){if(n.ep)return;n.ep=!0;const s=a(n);fetch(n.href,s)}})();const It=document.createElement("script");It.src="https://cdn.jsdelivr.net/npm/chart.js@4.4.7/dist/chart.umd.min.js";document.head.appendChild(It);const xt=document.createElement("script");xt.src="https://unpkg.com/html5-qrcode@2.3.8/html5-qrcode.min.js";document.head.appendChild(xt);const Jt={apiKey:"AIzaSyANpFnEIkyN1XCT6qbtmVR9wx7sQHEsyrE",authDomain:"comprasmercado-23913.firebaseapp.com",projectId:"comprasmercado-23913",storageBucket:"comprasmercado-23913.firebasestorage.app",messagingSenderId:"317518149234",appId:"1:317518149234:web:94f38624d68a2b9a6634eb",measurementId:"G-2XP88EK37S"},Kt=Yt(Jt),w=Zt(Kt),gt="compras",rt="entradas",et="faturas",at="boletos",Bt="reservas";let S=[],R=[],D=[],O=[],pt={metaMensal:0,valorAtualGuardado:0},ut=null,U=null,P=[],tt=0,ot=!1,Q=[];function c(t){return Number(t||0).toLocaleString("pt-BR",{style:"currency",currency:"BRL"})}function T(t){if(typeof t=="number")return t;if(!t)return 0;const e=parseFloat(String(t).replace(/R\$\s?/gi,"").replace(/\s/g,"").replace(/\./g,"").replace(",","."));return isNaN(e)?0:e}function it(t){if(!t)return"—";try{return new Date(t).toLocaleString("pt-BR",{dateStyle:"short",timeStyle:"short"})}catch{return t}}function g(t,e=3500){const a=document.getElementById("toast");a.textContent=t,a.classList.add("show"),setTimeout(()=>a.classList.remove("show"),e)}function C(t,e="var(--accent-amber)"){const a=document.getElementById("status-msg");a&&(a.textContent=t,a.style.color=e)}function Xt(t){if(!t)return new Date().toISOString().slice(0,16);try{const e=new Date(t);if(isNaN(e.getTime()))return new Date().toISOString().slice(0,16);const a=o=>String(o).padStart(2,"0");return`${e.getFullYear()}-${a(e.getMonth()+1)}-${a(e.getDate())}T${a(e.getHours())}:${a(e.getMinutes())}`}catch{return new Date().toISOString().slice(0,16)}}function te(t,e){let a=0;const o=new Date(t,e+1,0).getDate();for(let n=1;n<=o;n++){const s=new Date(t,e,n).getDay();s!==0&&s!==6&&a++}return a}window.goTab=function(t){document.querySelectorAll(".tab-content").forEach(a=>a.classList.remove("active")),document.querySelectorAll(".desktop-nav .nav-item").forEach(a=>a.classList.remove("active")),document.querySelectorAll(".mobile-nav .mob-btn").forEach(a=>a.classList.remove("active"));const e=document.getElementById("tab-"+t);e&&e.classList.add("active"),document.querySelectorAll(`[data-tab="${t}"]`).forEach(a=>a.classList.add("active"))};document.querySelectorAll("[data-tab]").forEach(t=>{t.addEventListener("click",()=>goTab(t.getAttribute("data-tab")))});document.querySelectorAll(".sub-item").forEach(t=>{t.addEventListener("click",()=>{document.querySelectorAll(".sub-item").forEach(a=>a.classList.remove("active")),document.querySelectorAll(".sub-tab-content").forEach(a=>a.style.display="none"),t.classList.add("active");const e=document.getElementById("sub-"+t.getAttribute("data-sub"));e&&(e.style.display="block")})});function wt(){document.getElementById("modal-add-nota").classList.add("active")}function At(){ot&&bt(),document.getElementById("modal-add-nota").classList.remove("active")}var yt;(yt=document.getElementById("btn-open-modal-home"))==null||yt.addEventListener("click",wt);var Et;(Et=document.getElementById("btn-mercado-add-nota"))==null||Et.addEventListener("click",wt);var $t;($t=document.getElementById("btn-close-modal-add"))==null||$t.addEventListener("click",At);nt(_t(z(w,gt),Wt("dataEmissao","desc")),t=>{S=t.docs.map(e=>({id:e.id,...e.data()})),J()},t=>console.error("Firestore Mercado:",t));nt(z(w,rt),t=>{R=t.docs.map(e=>({id:e.id,...e.data()})),J()},t=>console.error("Firestore Entradas:",t));nt(z(w,et),t=>{D=t.docs.map(e=>({id:e.id,...e.data()})),J()},t=>console.error("Firestore Faturas:",t));nt(z(w,at),t=>{O=t.docs.map(e=>({id:e.id,...e.data()})),J()},t=>console.error("Firestore Boletos:",t));nt(M(w,Bt,"config"),t=>{t.exists()&&(pt=t.data()),J()},t=>console.error("Firestore Reservas:",t));let E=new Date().toISOString().slice(0,7);function Tt(){const t=new Set,e=new Date().toISOString().slice(0,7);return t.add(e),E&&t.add(E),R.forEach(a=>{a.mesAno&&t.add(a.mesAno)}),D.forEach(a=>{a.mesAno&&t.add(a.mesAno)}),O.forEach(a=>{a.mesAno&&t.add(a.mesAno)}),S.forEach(a=>{a.mesAno&&t.add(a.mesAno)}),Array.from(t).sort().reverse()}window.selecionarMesGlobal=function(t){if(!t)return;E=t;const e=document.getElementById("inp-seletor-mes-global");e&&(e.value=t);const a=document.getElementById("inp-entradas-mes-ano");a&&(a.value=t);const o=document.getElementById("inp-fatura-vencimento");o&&(o.value=`${t}-10`,typeof atualizarMesRefFatura=="function"&&atualizarMesRefFatura());const n=document.getElementById("inp-boleto-vencimento");n&&(n.value=`${t}-10`,typeof atualizarMesRefBoleto=="function"&&atualizarMesRefBoleto()),J()};window.verMesEIrParaControle=function(t){selecionarMesGlobal(t),typeof goTab=="function"&&goTab("mensal")};function ee(){const t=document.getElementById("seletor-meses-bar"),e=document.getElementById("seletor-meses-bar-salarios"),a=Tt();a.includes(E)||(E=a[0]||new Date().toISOString().slice(0,7));const o=document.getElementById("inp-seletor-mes-global");o&&o.value!==E&&(o.value=E);const n=document.getElementById("inp-entradas-mes-ano");n&&n.value!==E&&(n.value=E);const s=a.map(r=>{const[d,l]=r.split("-"),m=new Date(parseInt(d),parseInt(l)-1,1).toLocaleString("pt-BR",{month:"short"}).toUpperCase().replace(".",""),u=r===E;return`
    ...
    `}).join("");t&&(t.innerHTML=s),e&&(e.innerHTML=s)}window.switchMensalSub=function(t){document.querySelectorAll("[data-mensal-sub]").forEach(o=>o.classList.remove("active")),document.querySelectorAll(".mensal-sub-content").forEach(o=>o.style.display="none");const e=document.querySelector(`[data-mensal-sub="${t}"]`);e&&e.classList.add("active");const a=document.getElementById(t);a&&(a.style.display="block")};function J(){ee(),ne(),ae(),Mt(),ue(),ge(),be(),Ie(),xe(),Be(),fe()}function ae(){const t=E,e=R.filter($=>$.mesAno===t),a=D.filter($=>$.mesAno===t),o=O.filter($=>$.mesAno===t),n=S.filter($=>$.mesAno===t),s=e.reduce(($,A)=>$+(A.valor||0),0),r=a.reduce(($,A)=>$+(A.valorTotal!==void 0?A.valorTotal:A.valor||0),0),d=o.reduce(($,A)=>$+(A.valorTotal!==void 0?A.valorTotal:A.valor||0),0);let l=0;n.forEach($=>{$.formasPagamento&&(l+=$.formasPagamento.cartaoDebito||0)});const i=s-r-d-l,m=document.getElementById("m-total-entradas");m&&(m.textContent=c(s));const u=document.getElementById("m-total-cartoes");u&&(u.textContent=c(r));const f=document.getElementById("m-total-boletos");f&&(f.textContent=c(d));const h=document.getElementById("m-mercado-debito");h&&(h.textContent=c(l));const v=document.getElementById("m-saldo-liquido");v&&(v.textContent=c(i),v.style.color=i>=0?"#60a5fa":"#fb7185");const[b,L]=t.split("-"),k=new Date(parseInt(b),parseInt(L)-1,1).toLocaleString("pt-BR",{month:"long"}),j=k.charAt(0).toUpperCase()+k.slice(1),N=document.getElementById("m-lbl-saldo-liquido");N&&(N.textContent=`Saldo Líquido (${j}/${b})`),oe(e,a,o,n)}function oe(t,e,a,o){const n=document.getElementById("content-salarios-mes");n&&(n.innerHTML=`
      <div class="card" style="margin-bottom:1.5rem">
        <div class="card-header">
          <span class="card-title">💵 Entradas Registradas em ${E}</span>
          <span class="badge green">Total: ${c(t.reduce((l,i)=>l+(i.valor||0),0))}</span>
        </div>
    ...
    `);const s=document.getElementById("content-cartoes-mes");if(s){const l=e.reduce((m,u)=>m+(u.valorTotal||0),0),i=e.length?Ot(e):"";s.innerHTML=`
      ${i}
      <div class="card" style="margin-bottom:1.5rem">
        <div class="card-header">
              ...
              <div class="purchase-card" style="margin-bottom:1rem">
                <div class="purchase-header" onclick="toggleDetail('fat-m-${m.id}')">
                  ...
                  <div class="purchase-values">
                    <div class="pv-total" style="color:#fb7185">${c(m.valorTotal)}</div>
        ...
        ${a.length?a.map(i=>`
              <div class="purchase-card" style="margin-bottom:1rem">
                <div class="purchase-header" onclick="toggleDetail('bol-m-${i.id}')">
                  ...
                  <div class="purchase-values">
                    <div class="pv-total" style="color:#c084fc">${c(i.valorTotal)}</div>
    ...
    `)}function ne(){let t=R.reduce((i,m)=>i+(m.valor||0),0),e=D.reduce((i,m)=>i+(m.valorTotal!==void 0?m.valorTotal:m.valor||0),0),a=O.reduce((i,m)=>i+(m.valorTotal!==void 0?m.valorTotal:m.valor||0),0),o=0,n=0,s=0;const r={};S.forEach(i=>{const m=i.valorAPagar||0;i.formasPagamento&&(n+=i.formasPagamento.valeAlimentacao||0,s+=i.formasPagamento.cartaoCredito||0,o+=i.formasPagamento.cartaoDebito||0);const u=i.mesAno||"Outros";r[u]=(r[u]||0)+m});let d=t-e-a-o;document.getElementById("fin-total-entradas").textContent=c(t);const l=document.getElementById("fin-subtext-entradas");l&&(l.textContent="Total de Entradas Cadastradas"),document.getElementById("fin-total-cartoes").textContent=c(e),document.getElementById("fin-total-boletos").textContent=c(a),document.getElementById("fin-mercado-debito").textContent=c(o),document.getElementById("fin-saldo-liquido").textContent=c(d),document.getElementById("dash-alimentacao").textContent=c(n),document.getElementById("dash-credito").textContent=c(s),document.getElementById("dash-debito").textContent=c(o),se(),Ct(r)}function se(){const t=document.getElementById("tabela-resumo-mensal");if(!t)return;const e=Tt();if(!e.length){t.innerHTML='<div class="empty-state">Nenhum dado cadastrado ainda.</div>';return}const a=e.map(o=>{const n=R.filter(v=>v.mesAno===o).reduce((v,b)=>v+(b.valor||0),0),s=D.filter(v=>v.mesAno===o).reduce((v,b)=>v+(b.valorTotal!==void 0?b.valorTotal:b.valor||0),0),r=O.filter(v=>v.mesAno===o).reduce((v,b)=>v+(b.valorTotal!==void 0?b.valorTotal:b.valor||0),0);let d=0;S.filter(v=>v.mesAno===o).forEach(v=>{v.formasPagamento&&(d+=v.formasPagamento.cartaoDebito||0)});const l=n-s-r-d,[i,m]=o.split("-"),f=new Date(parseInt(i),parseInt(m)-1,1).toLocaleString("pt-BR",{month:"short"}).toUpperCase().replace(".","");return`
  ...
  `}function Ct(t){var s;if(typeof Chart>"u")return setTimeout(()=>Ct(t),300);const e=(s=document.getElementById("chart-barras"))==null?void 0:s.getContext("2d");if(!e)return;const a=Object.keys(t).sort(),o=a.map(r=>{const[d,l]=r.split("-");return`${l}/${d}`}),n=a.map(r=>t[r]);ut&&ut.destroy(),ut=new Chart(e,{type:"bar",data:{labels:o.length?o:["Sem compras"],datasets:[{label:"Gasto Mercado R$",data:n.length?n:[0],backgroundColor:"rgba(16,185,129,0.78)",borderColor:"#10b981",borderWidth:2,borderRadius:8}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1},tooltip:{callbacks:{label:r=>` ${c(r.raw)}`}}},scales:{y:{beginAtZero:!0,grid:{color:"rgba(255,255,255,.05)"},ticks:{color:"#94a3b8",callback:r=>"R$"+r}},x:{grid:{display:!1},ticks:{color:"#94a3b8"}}}}})}function St(t){if(!t)return 0;const e=t.match(/L[íi]quido(?:\s*a\s*receber)?\s*[:\s]*R?\$\s*([\d\.,]+)/i)||t.match(/TOTAL\s*L[IÍ]QUIDO\s*[:\s]*R?\$\s*([\d\.,]+)/i)||t.match(/SAL[ÁA]RIO\s*L[IÍ]QUIDO\s*[:\s]*R?\$\s*([\d\.,]+)/i)||t.match(/VALOR\s*L[IÍ]QUIDO\s*[:\s]*R?\$\s*([\d\.,]+)/i);return e?T(e[1]):0}function re(){const t=document.getElementById("inp-entradas-mes-ano");if(t&&!t.value){const e=new Date,a=e.getFullYear(),o=String(e.getMonth()+1).padStart(2,"0");t.value=`${a}-${o}`}}setTimeout(re,300);let G="mes";window.toggleFiltroEntradasTabela=function(t){G=t,Mt()};document.getElementById("form-holerite-victor").addEventListener("submit",async t=>{t.preventDefault();const e=E||document.getElementById("inp-entradas-mes-ano").value||new Date().toISOString().slice(0,7),a=document.getElementById("inp-holerite-txt-victor").value;let o=parseFloat(document.getElementById("inp-salario-val-victor").value)||0;if(!o&&a&&(o=St(a)),!o){g("⚠️ Digite ou cole um holerite válido com valor.");return}const n=`salario_victor_${e}`;await st(M(w,rt,n),{pessoa:"Victor",tipo:"holerite",descricao:`Salário Líquido Victor (${e})`,valor:o,mesAno:e,data:new Date().toISOString()}),document.getElementById("inp-holerite-txt-victor").value="",document.getElementById("inp-salario-val-victor").value="",g(`✅ Salário do Victor (${e}) salvo com sucesso!`)});document.getElementById("form-holerite-maria").addEventListener("submit",async t=>{t.preventDefault();const e=E||document.getElementById("inp-entradas-mes-ano").value||new Date().toISOString().slice(0,7),a=document.getElementById("inp-holerite-txt-maria").value;let o=parseFloat(document.getElementById("inp-salario-val-maria").value)||0;if(!o&&a&&(o=St(a)),!o){g("⚠️ Digite ou cole um holerite válido com valor.");return}const n=`salario_maria_${e}`;await st(M(w,rt,n),{pessoa:"Maria",tipo:"holerite",descricao:`Salário Líquido Maria (${e})`,valor:o,mesAno:e,data:new Date().toISOString()}),document.getElementById("inp-holerite-txt-maria").value="",document.getElementById("inp-salario-val-maria").value="",g(`✅ Salário da Maria (${e}) salvo com sucesso!`)});document.getElementById("form-entrada-manual").addEventListener("submit",async t=>{t.preventDefault();const e=E||document.getElementById("inp-entradas-mes-ano").value||new Date().toISOString().slice(0,7),a=document.getElementById("inp-ent-desc").value.trim(),o=parseFloat(document.getElementById("inp-ent-val").value)||0,n=document.getElementById("inp-ent-pessoa").value;!a||!o||(await ct(z(w,rt),{pessoa:n,tipo:"manual",descricao:a,valor:o,mesAno:e,data:new Date().toISOString()}),t.target.reset(),g(`🎉 Entrada manual (${e}) registrada!`))});function Mt(){var l,i,m;const t=E||((l=document.getElementById("inp-entradas-mes-ano"))==null?void 0:l.value)||new Date().toISOString().slice(0,7),e=document.getElementById("lbl-entradas-mes-ref");if(e){const[u,f]=t.split("-"),v=new Date(parseInt(u),parseInt(f)-1,1).toLocaleString("pt-BR",{month:"long"}),b=v.charAt(0).toUpperCase()+v.slice(1);e.textContent=`Visualizando e inserindo entradas para: ${b} de ${u}`}const a=((i=R.find(u=>u.pessoa==="Victor"&&u.tipo==="holerite"&&u.mesAno===t))==null?void 0:i.valor)||0,o=((m=R.find(u=>u.pessoa==="Maria"&&u.tipo==="holerite"&&u.mesAno===t))==null?void 0:m.valor)||0,n=R.filter(u=>u.mesAno===t),s=n.reduce((u,f)=>u+(f.valor||0),0);document.getElementById("val-salario-victor").textContent=c(a),document.getElementById("val-salario-maria").textContent=c(o),document.getElementById("val-entradas-combinado").textContent=`${c(s)}`;const r=document.getElementById("lista-entradas-registradas");if(!r)return;const d=G==="mes"?n:R;if(!d.length){r.innerHTML=`
...
`}return n}catch(e){return e.name==="PasswordException"?g("🔒 O PDF precisa de senha válida para ser aberto."):console.error("Erro ao ler PDF:",e),""}}function le(t){if(!t)return null;const e=t.match(/Total\s*a\s*Pagar\s*[:\s]*R?\$\s*([\d\.,]+)/i)||t.match(/no\s*valor\s*de\s*R?\$\s*([\d\.,]+)/i)||t.match(/Valor\s*total\s*da\s*fatura\s*[:\s]*R?\$\s*([\d\.,]+)/i)||t.match(/Total\s*da\s*fatura\s*[:\s]*R?\$\s*([\d\.,]+)/i);if(e){const a=T(e[1]);if(a>0)return a}return null}function de(t){if(!t)return null;const e=t.match(/Vencimento\s*[:\s]*(\d{2}[\/\.-]\d{2}[\/\.-]\d{4})/i)||t.match(/Data\s*de\s*vencimento\s*[:\s]*(\d{2})\s+([A-Za-z]{3})\s+(\d{4})/i)||t.match(/FATURA\s+(\d{2})\s+([A-Za-z]{3})\s+(\d{4})/i);if(e){if(e[2]&&e[3]){const a=e[1],o=e[2].toUpperCase(),n=e[3],r={JAN:"01",FEB:"02",MAR:"03",ABR:"04",APR:"04",MAI:"05",MAY:"05",JUN:"06",JUL:"07",AGO:"08",AUG:"08",SET:"09",SEP:"09",OUT:"10",OCT:"10",NOV:"11",DEZ:"12",DEC:"12"}[o]||"07";return`${n}-${r}-${a.padStart(2,"0")}`}else if(e[1]){const[a,o,n]=e[1].split(/[\/\.-]/);return`${n}-${o.padStart(2,"0")}-${a.padStart(2,"0")}`}}return null}window.importarFaturaManualOuArquivo=async function(){const t=document.getElementById("inp-fatura-txt").value.trim();if(!t){g("⚠️ Selecione o arquivo da fatura (.pdf, .csv) ou cole o texto da fatura.");return}await Lt(t,ft)};async function Lt(t,e){const a=de(t);a&&(document.getElementById("inp-fatura-vencimento").value=a,atualizarMesRefFatura());const o=le(t),n=ce(t),s=document.getElementById("inp-fatura-vencimento").value||new Date().toISOString().slice(0,10),r=s.slice(0,7),d=n.reduce((f,h)=>f+h.valor,0),l=o||d||0,i=e?`Cartão ${e}`:"Fatura Cartão";I={cartao:e||"Nubank",descricao:i,dataVencimento:s,mesAno:r,valorTotal:l,qtdItens:n.length,itens:n};const m=document.getElementById("inp-revisao-fatura-desc");m&&(m.value=i);const u=document.getElementById("inp-revisao-fatura-val");u&&(u.value=l?l.toFixed(2):""),Ft(),n.length>0?g(`✅ ${n.length} compras encontradas! Fatura total: ${c(l)}.`):g("ℹ️ Fatura pronta para revisão. Confirme o valor total e o cartão abaixo.")}window.atualizarValorTotalRevisaoFatura=function(){var e;if(!I)return;const t=parseFloat((e=document.getElementById("inp-revisao-fatura-val"))==null?void 0:e.value)||0;I.valorTotal=t,document.getElementById("badge-total-preview-fatura").textContent=c(t)};function Ft(){if(!I)return;const{valorTotal:t,itens:e,cartao:a,descricao:o}=I;document.getElementById("badge-total-preview-fatura").textContent=c(t);const n=document.getElementById("inp-revisao-fatura-desc");n&&(!n.value||n.value==="Fatura Cartão")&&(n.value=o||`Cartão ${a||"Nubank"}`);const s=document.getElementById("inp-revisao-fatura-val");s&&(!s.value||parseFloat(s.value)===0)&&(s.value=t?t.toFixed(2):"");const r=document.getElementById("lista-preview-fatura-itens");!e||!e.length?r.innerHTML='<div class="empty-state">Nenhum item individual extraído. O valor total acima será considerado.</div>':r.innerHTML=e.map((l,i)=>`
    ...
    `).join("");const d=document.getElementById("box-revisao-fatura");d.style.display="block",d.scrollIntoView({behavior:"smooth"})}window.removerItemRevisaoFatura=function(t){if(!I||!I.itens)return;I.itens.splice(t,1);const e=I.itens.reduce((a,o)=>a+o.valor,0);if(e>0){I.valorTotal=e;const a=document.getElementById("inp-revisao-fatura-val");a&&(a.value=e.toFixed(2))}I.qtdItens=I.itens.length,Ft(),g("🗑️ Item removido da revisão da fatura.")};window.confirmarEGravarFaturaDocumento=async function(){var o,n;if(!I)return;const t=(o=document.getElementById("inp-revisao-fatura-desc"))==null?void 0:o.value.trim(),e=parseFloat((n=document.getElementById("inp-revisao-fatura-val"))==null?void 0:n.value)||0,a=document.getElementById("inp-fatura-vencimento").value||new Date().toISOString().slice(0,10);if(!e){g("⚠️ Digite ou confirme o valor total da fatura.");return}I.cartao=t||I.cartao||"Cartão",I.valorTotal=e,I.dataVencimento=a,I.mesAno=a.slice(0,7);try{await ct(z(w,et),{...I,createdAt:vt()}),document.getElementById("box-revisao-fatura").style.display="none",document.getElementById("inp-fatura-txt").value="";const s=document.getElementById("txt-file-fatura");s&&(s.textContent="Clique para Selecionar o Arquivo da Fatura");const r=c(I.valorTotal);I=null,g(`🎉 Fatura de ${r} salva com sucesso!`)}catch(s){alert("Erro ao salvar fatura: "+s.message)}};function ce(t){if(!t)return[];const e=[],a=/(?:[@\)\(\*•\s]+)?(\d{2}[\/\.-]\d{2}(?:[\/\.-]\d{2,4})?|\d{2}\s+[A-Za-z]{3})\s+(.+?)\s+(?:(\d{2}\/\d{2})\s+)?(-?R?\$\s*[\d\.]+,\d{2}|-?[\d\.]+,\d{2})/gi;if(t.split(`
`).forEach(n=>{const s=n.trim();if(!s||/EMISS[ÃA]O|TRANSA[ÇC][ÕO]ES|RESUMO|PAGAMENTO DE FATURA|TOTAL DA FATURA|FATURA ANTERIOR|SALDO ANTERIOR|LIMITE DISPON[ÍI]VEL|OPÇÕES DE PAGAMENTO|ALTERNATIVAS DE PAGAMENTO|PAGAMENTO E DEMAIS|PARCELAMENTOS|DESPESAS|HISTÓRICO DE FATURAS|SUPERCRÉDITO|SAQUE À CRÉDITO|COMPRA DATA DESCRIÇÃO/i.test(s))return;const r=/(?:[@\)\(\*•\s]+)?(\d{2}[\/\.-]\d{2}(?:[\/\.-]\d{2,4})?|\d{2}\s+[A-Za-z]{3})\s+(.+?)\s+(?:(\d{2}\/\d{2})\s+)?(-?R?\$\s*[\d\.]+,\d{2}|-?[\d\.]+,\d{2})$/i,d=s.match(r)||s.match(/(?:[@\)\(\*•\s]+)?(\d{2}[\/\.-]\d{2}(?:[\/\.-]\d{2,4})?|\d{2}\s+[A-Za-z]{3})\s+(.+?)\s+(?:(\d{2}\/\d{2})\s+)?(-?R?\$\s*[\d\.]+,\d{2}|-?[\d\.]+,\d{2})/i);if(d){const l=d[1];let i=d[2].trim();const m=d[3],u=d[4];if(u.includes("-")||/DEB AUTOM|PAGAMENTO|PAGTO|CR[ÉE]DITO FATURA/i.test(i))return;const f=T(u);m&&(i+=` (${m})`),i&&f>0&&i.length>2&&!/fatura|limite|pagamento|saldo|alternativas|opções|período|emissão|vencimento/i.test(i)&&e.push({dataCompra:l,descricao:i,valor:f})}}),e.length===0){let n;for(;(n=a.exec(t))!==null;){const s=n[1];let r=n[2].trim();const d=n[3],l=n[4];if(l.includes("-")||/DEB AUTOM|PAGAMENTO|PAGTO|CR[ÉE]DITO FATURA/i.test(r))continue;const i=T(l);d&&(r+=` (${d})`),r&&i>0&&r.length>2&&!/fatura|limite|pagamento|saldo|alternativas|opções|período|emissão|vencimento/i.test(r)&&e.push({dataCompra:s,descricao:r,valor:i})}}return e}function me(t){if(!t)return"DIVERSOS";let e=t.replace(/\(\d{1,2}\/\d{1,2}\)/gi,"").replace(/\b\d{1,2}\/\d{1,2}\b/gi,"").replace(/\b\d{1,2}x\b/gi,"").trim();return e=e.replace(/\s+/g," "),e.toUpperCase()}function Rt(t){const e={};(Array.isArray(t)?t:[t]).forEach(n=>{!n||!n.itens||!Array.isArray(n.itens)||n.itens.forEach(s=>{if(!s.descricao||!s.valor)return;const r=me(s.descricao);e[r]||(e[r]={nome:r,qtd:0,valorTotal:0}),e[r].qtd+=1,e[r].valorTotal+=s.valor||0})});const o=Object.values(e).filter(n=>n.qtd>=2);return o.sort((n,s)=>s.valorTotal-n.valorTotal),o}function Ot(t){const e=Rt(t);if(!e.length)return`
    ...
    `;const a=e.reduce((o,n)=>o+n.valorTotal,0);return`
    <div class="card" style="margin-bottom:1.5rem; background:linear-gradient(135deg,rgba(30,41,59,.95),rgba(15,23,42,.98)); border-color:#fb7185; box-shadow:0 4px 20px rgba(251,113,133,0.15)">
      <div class="card-header" style="flex-wrap:wrap; gap:.5rem">
        <div>
          <span class="card-title" style="color:#fb7185; font-size:1.05rem">🏬 Locais Mais Frequentados (${e.length} estabelecimentos com 2+ compras)</span>
          <p style="font-size:.78rem; color:var(--text-muted); margin-top:.2rem">Locais onde você comprou 2 ou mais vezes e a soma total gasta em cada um:</p>
        </div>
        <span class="badge rose" style="font-size:.85rem; padding:.35rem .75rem">Soma Repetidos: ${c(a)}</span>
      </div>

      <div style="display:grid; grid-template-columns: repeat(auto-fill, minmax(260px, 1fr)); gap:0.85rem; margin-top:.5rem">
        ${e.map(o=>`
          <div style="background:rgba(15,23,42,0.85); border:1px solid rgba(251,113,133,0.35); border-radius:10px; padding:.75rem 1rem; display:flex; justify-content:space-between; align-items:center; transition:transform .15s" onmouseover="this.style.transform='translateY(-2px)'" onmouseout="this.style.transform='none'">
            <div>
              <div style="font-weight:700; font-size:.88rem; color:#f8fafc; margin-bottom:.3rem; word-break:break-word">🏪 ${o.nome}</div>
              <span class="badge rose" style="font-size:.72rem">🛒 ${o.qtd} compras registradas</span>
            </div>
            <div style="text-align:right; min-width:90px">
              <div style="font-weight:800; font-size:1.05rem; color:#fb7185">${c(o.valorTotal)}</div>
  ...
  `}function ue(){const t=D.reduce((o,n)=>o+(n.valorTotal!==void 0?n.valorTotal:n.valor||0),0);document.getElementById("badge-total-cartoes").textContent=`${c(t)} total`;const e=document.getElementById("lista-faturas-registradas");if(!D.length){e.innerHTML='<div class="empty-state">Nenhuma fatura cadastrada ainda.</div>';return}const a=Ot(D);e.innerHTML=a+D.map(o=>{var u;const n=o.valorTotal!==void 0?o.valorTotal:o.valor||0,s=o.cartao||"Cartão",r=s.toLowerCase().includes("nubank"),d=r?"purple":"red",l=r?"🟣":"🔴",i=o.dataVencimento?it(o.dataVencimento).split(",")[0]:"—",m=o.mesAno||"—";return`
      <div class="purchase-card" style="margin-bottom:1rem">
        <div class="purchase-header" onclick="toggleDetail('fat-${o.id}')">
          <div class="purchase-info">
            <h3><span class="badge ${d}">${l} ${s}</span> — Vencimento: ${i}</h3>
            <p>📅 Mês Referência: <strong>${m}</strong> &nbsp;•&nbsp; 🛒 ${o.qtdItens||((u=o.itens)==null?void 0:u.length)||1} itens contemplados</p>
          </div>
          <div class="purchase-values">
            <div class="pv-total" style="color:#fb7185">${c(n)}</div>
    ...
    `}).join("")}function qt(t){if(t.itens&&t.itens.length>0){const e=Rt([t]);let a="";return e.length>0&&(a=`
        <div style="background:rgba(251,113,133,0.08); border:1px dashed rgba(251,113,133,0.35); border-radius:8px; padding:.75rem 1rem; margin-bottom:1rem">
          <div style="font-weight:700; font-size:.84rem; color:#fb7185; margin-bottom:.5rem">
            🏬 Locais com 2 ou mais compras nesta fatura (${e.length} estabelecimentos):
          </div>
          <div style="display:flex; flex-wrap:wrap; gap:.5rem">
            ${e.map(o=>`
              <span style="background:rgba(15,23,42,0.9); border:1px solid rgba(251,113,133,0.4); border-radius:6px; padding:.3rem .6rem; font-size:.78rem; color:#f1f5f9; display:inline-flex; align-items:center; gap:.35rem">
                🏬 <strong>${o.nome}</strong>: <span class="badge rose" style="font-size:.7rem">${o.qtd}x compras</span> <strong style="color:#fb7185; margin-left:.25rem">${c(o.valorTotal)}</strong>
              </span>
            `).join("")}
          </div>
        </div>
      ...
      <div class="table-responsive"><table class="custom-table">
        ...
        <tbody>${t.itens.map((o,n)=>`<tr>
          <td><strong>${o.dataCompra||"—"}</strong></td>
          <td>${o.descricao}</td>
          <td class="num" style="color:#fb7185"><strong>${c(o.valor)}</strong></td>
          <td><button class="btn-danger" style="padding:.2rem .5rem; font-size:.78rem;" onclick="removerItemFaturaCadastrada('${t.id}', ${n})">🗑️ Excluir</button></td>
        </tr>`).join("")}</tbody>
      </table></div>
  ...
  </table></div>`}window.removerItemFaturaCadastrada=async function(t,e){const a=D.find(s=>s.id===t);if(!a||!a.itens||!confirm("Remover este item da fatura?"))return;const o=[...a.itens];o.splice(e,1);const n=o.reduce((s,r)=>s+(r.valor||0),0);o.length===0?(await W(M(w,et,t)),g("🗑️ Fatura excluída pois todos os itens foram removidos.")):(await st(M(w,et,t),{...a,itens:o,valorTotal:n,qtdItens:o.length}),g("🗑️ Item removido da fatura."))};window.excluirFaturaDocumento=async function(t){confirm("Excluir esta fatura e todos os seus lançamentos?")&&(await W(M(w,et,t)),g("🗑️ Fatura removida com sucesso."))};let B=null;function pe(){const t=document.getElementById("inp-boleto-vencimento");if(t&&!t.value){const e=new Date,a=e.getFullYear(),o=String(e.getMonth()+1).padStart(2,"0");t.value=`${a}-${o}-10`,atualizarMesRefBoleto()}}setTimeout(pe,300);window.atualizarMesRefBoleto=function(){const t=document.getElementById("inp-boleto-vencimento"),e=document.getElementById("lbl-boleto-mes-ref");if(!(!t||!e))if(t.value){const[a,o]=t.value.split("-"),s=new Date(parseInt(a),parseInt(o)-1,1).toLocaleString("pt-BR",{month:"long"});e.textContent=`Boleto ${s.charAt(0).toUpperCase()+s.slice(1)}/${a}`}else e.textContent="Mês do Boleto"};window.handleFileBoletoSelect=async function(t){const e=t.target.files[0];if(!e)return;const a=document.getElementById("txt-file-boleto");a&&(a.textContent=`📄 Arquivo: ${e.name}`),g(`⏳ Lendo arquivo do boleto (${e.name})...`);let o="";if(e.type==="application/pdf"||e.name.endsWith(".pdf"))o=await Dt(e);else try{o=await e.text()}catch{o=""}o?(document.getElementById("inp-boleto-txt").value=o,await Pt(o,e.name)):g("❌ Não foi possível ler o texto do arquivo do boleto.")};window.importarBoletoManualOuArquivo=async function(){const t=document.getElementById("inp-boleto-txt").value.trim();if(!t){g("⚠️ Selecione o arquivo do boleto (.pdf, .txt) ou cole o texto do boleto.");return}await Pt(t,"Boleto")};async function Pt(t,e){const a=ve(t);a.vencimento&&(document.getElementById("inp-boleto-vencimento").value=a.vencimento,atualizarMesRefBoleto());const o=document.getElementById("inp-boleto-vencimento").value||new Date().toISOString().slice(0,10),n=o.slice(0,7),s=a.beneficiario||e.replace(/\.[^/.]+$/,"")||"Boleto / Conta",r=a.itens.reduce((l,i)=>l+i.valor,0),d=a.valorTotal||r||0;document.getElementById("inp-revisao-boleto-desc").value=s,document.getElementById("inp-revisao-boleto-val").value=d?d.toFixed(2):"",B={descricao:s,dataVencimento:o,mesAno:n,valorTotal:d,qtdItens:a.itens.length,itens:a.itens},kt(),g("✅ Boleto identificado! Confira a descrição, valor e itens antes de salvar.")}window.atualizarValorTotalRevisaoBoleto=function(){if(!B)return;const t=parseFloat(document.getElementById("inp-revisao-boleto-val").value)||0;B.valorTotal=t,document.getElementById("badge-total-preview-boleto").textContent=c(t)};function kt(){if(!B)return;const{valorTotal:t,itens:e}=B;document.getElementById("badge-total-preview-boleto").textContent=c(t);const a=document.getElementById("lista-preview-boleto-itens");!e||!e.length?a.innerHTML='<div class="empty-state">Nenhum encargo/item individual extraído. O valor total acima será considerado.</div>':a.innerHTML=e.map((n,s)=>`
      <div style="display:flex; justify-content:space-between; align-items:center; padding:.4rem 0; border-bottom:1px dashed var(--border-color); font-size:.82rem;">
...
`).forEach(i=>{const m=i.trim();if(!m||/vencimento|beneficiário|cedente|nosso\s*número|agência|código|autenticação|instruções/i.test(m))return;const u=m.match(/(\d{2}[\/\.-]\d{2}(?:[\/\.-]\d{2,4})?|\b[A-Za-z]{3}\b)?\s*(.+?)\s+R?\$\s*([\d\.]+,\d{2})$/i);if(u){const f=u[1]||"Boleto",h=u[2].trim(),v=T(u[3]);h&&v>0&&h.length>2&&!/valor|total|documento|cobrado/i.test(h)&&n.push({dataBoleto:f,descricao:h,valor:v})}}),{beneficiario:e,valorTotal:a,vencimento:o,itens:n}}function ge(){const t=O.reduce((a,o)=>a+(o.valorTotal!==void 0?o.valorTotal:o.valor||0),0);document.getElementById("badge-total-boletos").textContent=`${c(t)} total`;const e=document.getElementById("lista-boletos-registrados");if(!O.length){e.innerHTML='<div class="empty-state">Nenhum boleto cadastrado ainda.</div>';return}e.innerHTML=O.map(a=>{var d;const o=a.valorTotal!==void 0?a.valorTotal:a.valor||0,n=a.dataVencimento?it(a.dataVencimento).split(",")[0]:"—",s=a.mesAno||"—",r=a.descricao||"Boleto / Conta";return`
  ...
  </table></div>`}window.removerItemBoletoCadastrado=async function(t,e){const a=O.find(s=>s.id===t);if(!a||!a.itens||!confirm("Remover este item do boleto?"))return;const o=[...a.itens];o.splice(e,1);const n=o.reduce((s,r)=>s+(r.valor||0),0);o.length===0?(await W(M(w,at,t)),g("🗑️ Boleto excluído pois todos os itens foram removidos.")):(await st(M(w,at,t),{...a,itens:o,valorTotal:n,qtdItens:o.length}),g("🗑️ Item removido do boleto."))};window.excluirBoletoDocumento=async function(t){confirm("Excluir este boleto e todos os seus itens?")&&(await W(M(w,at,t)),g("🗑️ Boleto removido com sucesso."))};document.getElementById("form-config-reservas").addEventListener("submit",async t=>{t.preventDefault();const e=parseFloat(document.getElementById("inp-meta-mensal").value)||0,a=parseFloat(document.getElementById("inp-saldo-guardado").value)||0;await st(M(w,Bt,"config"),{metaMensal:e,valorAtualGuardado:a,dataAtualizacao:new Date().toISOString()}),g("✅ Reservas e economias atualizadas!")});function fe(){const t=pt.metaMensal||0,e=pt.valorAtualGuardado||0;document.getElementById("val-meta-reserva").textContent=c(t),document.getElementById("val-real-guardado").textContent=c(e);const a=R.reduce((m,u)=>m+(u.valor||0),0),o=D.reduce((m,u)=>m+(u.valorTotal!==void 0?u.valorTotal:u.valor||0),0),n=O.reduce((m,u)=>m+(u.valorTotal!==void 0?u.valorTotal:u.valor||0),0);let s=0;S.forEach(m=>{m.formasPagamento&&(s+=m.formasPagamento.cartaoDebito||0)});const r=a-o-n-s,d=r>0?Math.max(r*.5,a*.2):0;document.getElementById("val-recomendacao-reserva").textContent=c(d);const l=document.getElementById("box-analise-reserva-detalhes");if(a===0){l.innerHTML='<p class="empty-state">Cadastre seus salários e entradas na aba "Salários & Entradas" para gerar o diagnóstico inteligente de economias.</p>';return}const i=t>0?Math.min(100,e/t*100).toFixed(1):0;l.innerHTML=`
  ...
  `}function be(){const t=document.getElementById("lista-mensal-container");if(!t)return;const e=new Date,a=new Date(e.getFullYear(),e.getMonth()+1,1),o=a.toLocaleString("pt-BR",{month:"long"}),n=a.getFullYear(),s=`${o.charAt(0).toUpperCase()+o.slice(1)} de ${n}`,r=te(a.getFullYear(),a.getMonth()),d=31.8,l=20,i=r*d,m=r*l,u={};let f=0;S.forEach(p=>{const y=p.valorAPagar||0;f+=y;const x=p.mesAno||"Outros";u[x]=(u[x]||0)+y});const h=Math.max(1,Object.keys(u).length),v=f/h,b={};S.forEach(p=>{(p.itens||[]).forEach(y=>{const x=(y.nome||"").toLowerCase().trim();x&&(b[x]||(b[x]={nome:y.nome,marca:y.marca||"Geral",qtdTotal:0,frequenciaNotas:0,valoresUnitarios:[]}),b[x].qtdTotal+=y.quantidade||1,b[x].frequenciaNotas+=1,y.valorUnitario&&b[x].valoresUnitarios.push(y.valorUnitario))})});const L=Object.values(b).map(p=>{const y=p.valoresUnitarios.length>0?p.valoresUnitarios.reduce((X,dt)=>X+dt,0)/p.valoresUnitarios.length:0,x=p.qtdTotal/h,_=h/Math.max(1,p.frequenciaNotas),lt=p.frequenciaNotas/h;let q=0;lt>=.35||x>=.7?q=Math.ceil(x):q=Math.round(x),q<1&&p.frequenciaNotas>=h&&(q=1);const K=q*y;return{nome:p.nome,marca:p.marca,frequenciaNotas:p.frequenciaNotas,intervaloMeses:_,qtdMensalTaxa:x,totalEstimadoUnidades:q,valorUnitario:y,subtotalCalculado:K}}).filter(p=>p.totalEstimadoUnidades>0);L.sort((p,y)=>y.frequenciaNotas-p.frequenciaNotas);const F=L.reduce((p,y)=>p+y.subtotalCalculado,0),k=v>0?v*1.05:F;let j=1;F>k&&v>0&&(j=k/F);const N=L.map(p=>({...p,subtotalFinal:p.subtotalCalculado*j})),$=v>0?Math.min(F,k):F;let A=$;const Y=Math.min(A,i);A-=Y;const Z=Math.min(A,m);A-=Z;const H=A>0?A:0;let V=`
    <div class="card" style="margin-bottom:1.5rem; background: linear-gradient(135deg, rgba(30,41,59,0.9), rgba(15,23,42,0.95)); border: 1px solid #3b82f6;">
      ...
      <div class="payment-grid" style="margin-top:1rem;">
        <div class="payment-item" style="border-color: rgba(16,185,129,0.4);">
          ...
          <div class="p-val" style="color:#34d399;">${c(Y)} <span style="font-size:0.75rem;font-weight:normal;color:var(--text-muted)">/ ${c(i)}</span></div>
        </div>
        <div class="payment-item" style="border-color: rgba(99,102,241,0.4);">
          <div class="p-label">💳 Cartão Crédito (${r}d × R$ 20,00)</div>
          <div class="p-val" style="color:#818cf8;">${c(Z)} <span style="font-size:0.75rem;font-weight:normal;color:var(--text-muted)">/ ${c(m)}</span></div>
        </div>
  ...
  `;window.dadosListaMensalCache={mesAnoStr:s,diasUteis:r,totalGeralEstimado:$,cobertoAlim:Y,cobertoCred:Z,cobertoDeb:H,alimDisponivel:i,credDisponivel:m,lista:N},N.length===0?V+='<div class="empty-state">Adicione notas fiscais para que o sistema gere automaticamente sua lista mensal de compras.</div></div>':V+=`
      <div class="table-responsive">
        <table class="custom-table">
          <thead>
            <tr>
  ...
  `;d.document.open(),d.document.write(l),d.document.close()};document.getElementById("btn-start-cam").addEventListener("click",Vt);document.getElementById("btn-switch-cam").addEventListener("click",he);document.getElementById("btn-stop-cam").addEventListener("click",bt);async function Vt(){if(typeof Html5Qrcode>"u")return C("Carregando biblioteca de câmera, aguarde..."),setTimeout(Vt,600);try{U||(U=new Html5Qrcode("qr-reader")),P=await Html5Qrcode.getCameras();let t;if(P&&P.length>0){const e=P.findIndex(a=>/back|traseira|rear|environment/i.test(a.label));tt=e>=0?e:0,t=P[tt].id}else t={facingMode:"environment"};await U.start(t,{fps:10,qrbox:{width:240,height:240}},Ut,()=>{}),ot=!0,document.getElementById("btn-start-cam").style.display="none",document.getElementById("btn-switch-cam").style.display=P.length>1?"inline-flex":"none",document.getElementById("btn-stop-cam").style.display="inline-flex"}catch(t){C("❌ Não foi possível acessar a câmera. Verifique as permissões do navegador."),console.error(t)}}async function he(){if(!(!U||!ot))try{await U.stop(),P.length>1&&(tt=(tt+1)%P.length,await U.start(P[tt].id,{fps:10,qrbox:{width:240,height:240}},Ut,()=>{}))}catch(t){console.error("switchCam:",t)}}async function bt(){if(U&&ot)try{await U.stop()}catch{}ot=!1,document.getElementById("btn-start-cam").style.display="inline-flex",document.getElementById("btn-switch-cam").style.display="none",document.getElementById("btn-stop-cam").style.display="none"}async function Ut(t){bt(),document.getElementById("inp-url").value=t,C("✅ QR Code lido! Processando..."),await jt(t)}document.getElementById("btn-carregar-dados").addEventListener("click",async()=>{const t=document.getElementById("inp-url").value.trim(),e=document.getElementById("inp-html").value.trim();if(!t&&!e){C("⚠️ Cole a URL do QR Code ou o conteúdo da página para ler a nota fiscal.");return}if(t&&!e){C("⏳ Consultando nota fiscal..."),await jt(t);return}if(e){C("⏳ Processando conteúdo..."),await Ht(e);return}});document.getElementById("btn-preencher-manual").addEventListener("click",()=>{zt({nomeMercado:"",dataEmissao:new Date().toISOString(),valorTotal:0,descontoTotal:0,valorAPagar:0,qtdTotalItens:0,formasPagamento:{valeAlimentacao:0,cartaoCredito:0,cartaoDebito:0},itens:[]}),C("✍️ Preencha os dados da compra abaixo e clique em Salvar Nota Fiscal.","var(--accent-cyan)")});function zt(t){var s,r,d;document.getElementById("inp-mercado").value=t.nomeMercado||"",document.getElementById("inp-data").value=Xt(t.dataEmissao),document.getElementById("inp-vtotal").value=t.valorTotal!==void 0?t.valorTotal:0,document.getElementById("inp-desconto").value=t.descontoTotal!==void 0?t.descontoTotal:0,document.getElementById("inp-pagar").value=t.valorAPagar!==void 0?t.valorAPagar:0,document.getElementById("inp-qtd").value=t.qtdTotalItens!==void 0?t.qtdTotalItens:0,document.getElementById("inp-alim").value=((s=t.formasPagamento)==null?void 0:s.valeAlimentacao)||0,document.getElementById("inp-cred").value=((r=t.formasPagamento)==null?void 0:r.cartaoCredito)||0,document.getElementById("inp-deb").value=((d=t.formasPagamento)==null?void 0:d.cartaoDebito)||0,Q=t.itens||[];const e=document.getElementById("form-nfce");e.style.display="block";const a=document.getElementById("preview-itens-box"),o=document.getElementById("count-preview-itens"),n=document.getElementById("lista-preview-itens");Q.length>0?(a.style.display="block",o.textContent=Q.length,n.innerHTML=Q.map(l=>`
    ...
    `).join("")):a.style.display="none",e.scrollIntoView({behavior:"smooth"})}document.getElementById("form-nfce").addEventListener("submit",async t=>{t.preventDefault();const e=document.getElementById("inp-mercado").value.trim()||"Mercado",a=document.getElementById("inp-data").value||new Date().toISOString(),o=parseFloat(document.getElementById("inp-vtotal").value)||0,n=parseFloat(document.getElementById("inp-desconto").value)||0,s=parseFloat(document.getElementById("inp-pagar").value)||0,r=parseInt(document.getElementById("inp-qtd").value)||0,d=parseFloat(document.getElementById("inp-alim").value)||0,l=parseFloat(document.getElementById("inp-cred").value)||0,i=parseFloat(document.getElementById("inp-deb").value)||0,m=new Date(a).toISOString().slice(0,16),u=S.find(v=>{const b=new Date(v.dataEmissao).toISOString().slice(0,16),L=Math.abs((v.valorAPagar||0)-s)<.05,F=(v.nomeMercado||"").toLowerCase().trim()===e.toLowerCase().trim();return b===m&&L&&F});if(u){C(`⚠️ Esta nota fiscal já existe no sistema (Cadastrada em ${it(u.dataEmissao)} no valor de ${c(u.valorAPagar)}). Nota não adicionada!`,"#fb7185"),g("⚠️ Nota fiscal já cadastrada! Operação cancelada.");return}const f=new Date(a),h=`${f.getFullYear()}-${String(f.getMonth()+1).padStart(2,"0")}`;C("⏳ Salvando nota fiscal no banco...");try{await ct(z(w,gt),{nomeMercado:e,dataEmissao:a,mesAno:h,qtdTotalItens:r||Q.length,valorTotal:o,descontoTotal:n,valorAPagar:s,formasPagamento:{valeAlimentacao:d,cartaoCredito:l,cartaoDebito:i},itens:Q,createdAt:vt()}),C("✅ Nota salva com sucesso!","#34d399"),document.getElementById("form-nfce").style.display="none",document.getElementById("form-nfce").reset(),document.getElementById("inp-url").value="",document.getElementById("inp-html").value="",Q=[],At(),goTab("dashboard"),g("🎉 Nota fiscal registrada no Firebase!")}catch(v){C("❌ Erro ao salvar: "+v.message,"#fb7185")}});async function jt(t){const e=[a=>`https://api.allorigins.win/raw?url=${encodeURIComponent(a)}`,a=>`https://corsproxy.io/?${encodeURIComponent(a)}`];for(const a of e)try{const o=await fetch(a(t),{signal:AbortSignal.timeout(8e3)});if(o.ok){const n=await o.text();if(n&&n.length>200){await Ht(n);return}}}catch{}ye(t)}function ye(t){document.getElementById("modal-link").href=t,document.getElementById("modal-cors").classList.add("active"),C("⚠️ Abra o link, copie o conteúdo da página e cole no campo de texto abaixo.")}async function Ht(t){const e=Ee(t);zt(e),C("✅ Nota lida com sucesso! Confira os valores abaixo e altere se necessário antes de Salvar.","#34d399")}function Ee(t){var Y,Z,H;const a=new DOMParser().parseFromString(t,"text/html"),o=((Y=a.body)==null?void 0:Y.textContent)||t;let n=((H=(Z=a.querySelector(".txtTopo, .nomeEmit, h1"))==null?void 0:Z.textContent)==null?void 0:H.trim())||"Mercado",s=new Date().toISOString();const r=o.match(/Emiss[ãa]o\s*[:\-]?\s*(\d{2}\/\d{2}\/\d{4})\s+(\d{2}:\d{2}:\d{2})?/i)||o.match(/(\d{2}\/\d{2}\/\d{4})\s+(\d{2}:\d{2}:\d{2})/);if(r){const[V,p,y]=r[1].split("/");s=`${y}-${p}-${V}T${r[2]||"12:00:00"}`}const d=o.match(/Qtd\.?\s*total\s*de\s*itens\s*[:\s]*([\d,\.]+)/i),l=o.match(/Valor\s*total\s*R\$\s*[:\s]*([\d\.,]+)/i),i=o.match(/Descontos?\s*R\$\s*[:\s]*([\d\.,]+)/i),m=o.match(/Valor\s*a\s*pagar\s*R\$\s*[:\s]*([\d\.,]+)/i)||o.match(/VALOR\s*PAGO\s*R\$\s*[:\s]*([\d\.,]+)/i),u=o.match(/(?:Vale\s*)?Alimenta[çc][ãa]o\s*[:\s]*([\d\.,]+)/i),f=o.match(/(?:Cart[ãa]o\s*de\s*)?Cr[eé]dito\s*[:\s]*([\d\.,]+)/i),h=o.match(/(?:Cart[ãa]o\s*de\s*)?D[eé]bito\s*[:\s]*([\d\.,]+)/i),v=d?T(d[1]):0,b=l?T(l[1]):0,L=i?T(i[1]):0;let F=m?T(m[1]):b-L;const k={valeAlimentacao:u?T(u[1]):0,cartaoCredito:f?T(f[1]):0,cartaoDebito:h?T(h[1]):0},j=[];a.querySelectorAll("tr, .item, .itemNota").forEach(V=>{var ht;const p=V.textContent;if(!/Vl\.\s*Unit|valorUnitario|Qtde?\./i.test(p))return;const y=V.querySelector(".txtTit, .txtTit2, .nomeProd"),x=((ht=y==null?void 0:y.textContent)==null?void 0:ht.trim())||"",_=p.match(/Qtde?\.\s*[:\s]*([\d,\.]+)/i),lt=p.match(/Vl\.\s*Unit\.\s*[:\s]*([\d,\.]+)/i),q=p.match(/Vl\.\s*Total\s*([\d,\.]+)/i),K=p.match(/C[oó]digo\s*[:\s]*(\d+)/i),X=p.match(/UN\s*[:\s]*([A-Za-z]+)/i),dt=_?T(_[1]):1,mt=lt?T(lt[1]):0,Qt=q?T(q[1]):mt*dt;x&&mt>0&&j.push({codigo:(K==null?void 0:K[1])||"",nome:x,marca:$e(x),quantidade:dt,unidade:(X==null?void 0:X[1])||"Un",valorUnitario:mt,valorTotal:Qt})});const $=new Date(s),A=`${$.getFullYear()}-${String($.getMonth()+1).padStart(2,"0")}`;return{nomeMercado:n,dataEmissao:s,mesAno:A,qtdTotalItens:v,valorTotal:b,descontoTotal:L,valorAPagar:F,formasPagamento:k,itens:j}}function $e(t){const e=["BAUDUCCO","BAUD","PANCO","DANONE","NESTLE","QUALITA","SADIA","PERDIGAO","SEARA","CAMIL","TIO JOAO","URBANO","LIZA","SOYA","YPE","PILAO","MELITTA","3 CORACOES","VIGOR","PARMALAT","ITALAC","HEINZ","KRAFT"],a=t.toUpperCase();for(const o of e)if(a.includes(o))return o;return a.split(" ")[0]||"Genérica"}function Ie(){const t=document.getElementById("lista-historico");if(!S.length){t.innerHTML='<div class="empty-state">📭 Nenhuma compra cadastrada ainda.</div>';return}t.innerHTML=S.map(e=>{var a,o,n;return`
    <div class="purchase-card">
  ...
  </table></div>`}window.toggleDetail=function(t){const e=document.getElementById("detail-"+t),a=document.getElementById("chev-"+t);e&&e.classList.toggle("open"),a&&a.classList.toggle("open")};window.confirmarExcluirMercado=async function(t){if(confirm("Excluir esta compra de mercado?"))try{await W(M(w,gt,t)),g("🗑️ Compra excluída.")}catch(e){alert("Erro: "+e.message)}};function xe(){const t=document.getElementById("lista-comparacao"),e={};S.forEach(o=>{(o.itens||[]).forEach(n=>{var r;const s=((r=n.nome)==null?void 0:r.toLowerCase().trim())||"produto";e[s]||(e[s]={nome:n.nome,marca:n.marca,hist:{}}),e[s].hist[o.mesAno]=n.valorUnitario})});const a=Object.values(e);if(!a.length){t.innerHTML='<div class="empty-state">Adicione notas para ver a comparação de preços unitários.</div>';return}t.innerHTML=`<div class="table-responsive"><table class="custom-table">
    <thead><tr><th>Produto</th><th>Marca</th><th>Histórico (Unitário)</th><th>Variação</th></tr></thead>
    <tbody>${a.map(o=>{const n=Object.keys(o.hist).sort();let s=n.map(d=>`${d}: <strong>${c(o.hist[d])}</strong>`).join(" → "),r='<span class="badge cyan">Estável</span>';if(n.length>=2){const d=o.hist[n[n.length-2]],i=o.hist[n[n.length-1]]-d,m=(i/d*100).toFixed(1);i>.01?r=`<span class="badge red">+${m}% ↑</span>`:i<-.01&&(r=`<span class="badge green">${m}% ↓</span>`)}return`<tr><td><strong>${o.nome}</strong></td><td><span class="badge amber">${o.marca||"—"}</span></td><td>${s}</td><td>${r}</td></tr>`}).join("")}</tbody>
  </table></div>`}function Be(){const t=document.getElementById("lista-recorrencia"),e=document.getElementById("lista-marcas"),a={},o={};S.forEach(r=>{(r.itens||[]).forEach(d=>{var u;const l=(u=d.nome)==null?void 0:u.toLowerCase().trim();if(!l)return;a[l]||(a[l]={nome:d.nome,marca:d.marca,qtd:0,notas:0,units:[]}),a[l].qtd+=d.quantidade||1,a[l].notas+=1,a[l].units.push(d.valorUnitario||0);const i=(d.nome||"").split(" ")[0].toUpperCase();o[i]||(o[i]={});const m=d.marca||"Genérica";o[i][m]||(o[i][m]=[]),o[i][m].push(d.valorUnitario||0)})});const n=Object.values(a).filter(r=>r.notas>1).sort((r,d)=>d.notas-r.notas);t.innerHTML=n.length?`<div class="table-responsive"><table class="custom-table">
        <thead><tr><th>Item</th><th>Marca</th><th>Compras</th><th class="num">Qtd Total</th><th class="num">Média Unitária</th></tr></thead>
        <tbody>${n.map(r=>{const d=r.units.reduce((l,i)=>l+i,0)/r.units.length;return`<tr>
      ...
      </table></div>`:'<div class="empty-state">Adicione notas para ver a recorrência de itens.</div>';const s=Object.entries(o).filter(([,r])=>Object.keys(r).length>1).map(([r,d])=>{let l=1/0,i="";const m=Object.entries(d).map(([u,f])=>{const h=f.reduce((v,b)=>v+b,0)/f.length;return h<l&&(l=h,i=u),{marca:u,med:h}});return`<div class="brand-card">
