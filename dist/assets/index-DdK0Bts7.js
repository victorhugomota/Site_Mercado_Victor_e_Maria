import{initializeApp as st}from"https://www.gstatic.com/firebasejs/10.14.1/firebase-app.js";import{getFirestore as rt,onSnapshot as ce,query as it,collection as K,orderBy as lt,doc as F,deleteDoc as Z,setDoc as H,addDoc as he,serverTimestamp as xe}from"https://www.gstatic.com/firebasejs/10.14.1/firebase-firestore.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))o(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const i of s.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&o(i)}).observe(document,{childList:!0,subtree:!0});function a(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function o(n){if(n.ep)return;n.ep=!0;const s=a(n);fetch(n.href,s)}})();const ze=document.createElement("script");ze.src="https://cdn.jsdelivr.net/npm/chart.js@4.4.7/dist/chart.umd.min.js";document.head.appendChild(ze);const Ne=document.createElement("script");Ne.src="https://unpkg.com/html5-qrcode@2.3.8/html5-qrcode.min.js";document.head.appendChild(Ne);const dt={apiKey:"AIzaSyANpFnEIkyN1XCT6qbtmVR9wx7sQHEsyrE",authDomain:"comprasmercado-23913.firebaseapp.com",projectId:"comprasmercado-23913",storageBucket:"comprasmercado-23913.firebasestorage.app",messagingSenderId:"317518149234",appId:"1:317518149234:web:94f38624d68a2b9a6634eb",measurementId:"G-2XP88EK37S"},ct=st(dt),M=rt(ct),Ee="compras",me="entradas",de="faturas",ie="boletos",Pe="reservas",oe="estimativas";let V=[],_=[],G=[],U=[],X=[],Q={valorAtualGuardado:0},Ae=null,ae=null,J=[],ve=0,ge=!1,re=[];function l(t){return Number(t||0).toLocaleString("pt-BR",{style:"currency",currency:"BRL"})}function k(t){if(typeof t=="number")return t;if(!t)return 0;const e=parseFloat(String(t).replace(/R\$\s?/gi,"").replace(/\s/g,"").replace(/\./g,"").replace(",","."));return isNaN(e)?0:e}function fe(t){if(!t)return"—";try{return new Date(t).toLocaleString("pt-BR",{dateStyle:"short",timeStyle:"short"})}catch{return t}}function A(t,e=3500){const a=document.getElementById("toast");a.textContent=t,a.classList.add("show"),setTimeout(()=>a.classList.remove("show"),e)}function q(t,e="var(--accent-amber)"){const a=document.getElementById("status-msg");a&&(a.textContent=t,a.style.color=e)}function mt(t){if(!t)return new Date().toISOString().slice(0,16);try{const e=new Date(t);if(isNaN(e.getTime()))return new Date().toISOString().slice(0,16);const a=o=>String(o).padStart(2,"0");return`${e.getFullYear()}-${a(e.getMonth()+1)}-${a(e.getDate())}T${a(e.getHours())}:${a(e.getMinutes())}`}catch{return new Date().toISOString().slice(0,16)}}function ut(t,e){let a=0;const o=new Date(t,e+1,0).getDate();for(let n=1;n<=o;n++){const s=new Date(t,e,n).getDay();s!==0&&s!==6&&a++}return a}window.goTab=function(t){document.querySelectorAll(".tab-content").forEach(a=>a.classList.remove("active")),document.querySelectorAll(".desktop-nav .nav-item").forEach(a=>a.classList.remove("active")),document.querySelectorAll(".mobile-nav .mob-btn").forEach(a=>a.classList.remove("active"));const e=document.getElementById("tab-"+t);e&&e.classList.add("active"),document.querySelectorAll(`[data-tab="${t}"]`).forEach(a=>a.classList.add("active"))};document.querySelectorAll("[data-tab]").forEach(t=>{t.addEventListener("click",()=>goTab(t.getAttribute("data-tab")))});document.querySelectorAll(".sub-item").forEach(t=>{t.addEventListener("click",()=>{document.querySelectorAll(".sub-item").forEach(a=>a.classList.remove("active")),document.querySelectorAll(".sub-tab-content").forEach(a=>a.style.display="none"),t.classList.add("active");const e=document.getElementById("sub-"+t.getAttribute("data-sub"));e&&(e.style.display="block")})});function ke(){document.getElementById("modal-add-nota").classList.add("active")}function qe(){ge&&we(),document.getElementById("modal-add-nota").classList.remove("active")}var De;(De=document.getElementById("btn-open-modal-home"))==null||De.addEventListener("click",ke);var Oe;(Oe=document.getElementById("btn-mercado-add-nota"))==null||Oe.addEventListener("click",ke);var Le;(Le=document.getElementById("btn-close-modal-add"))==null||Le.addEventListener("click",qe);ce(it(K(M,Ee),lt("dataEmissao","desc")),t=>{V=t.docs.map(e=>({id:e.id,...e.data()})),ee()},t=>console.error("Firestore Mercado:",t));ce(K(M,me),t=>{_=t.docs.map(e=>({id:e.id,...e.data()})),ee()},t=>console.error("Firestore Entradas:",t));ce(K(M,de),t=>{G=t.docs.map(e=>({id:e.id,...e.data()})),ee()},t=>console.error("Firestore Faturas:",t));ce(K(M,ie),t=>{U=t.docs.map(e=>({id:e.id,...e.data()})),ee()},t=>console.error("Firestore Boletos:",t));ce(F(M,Pe,"config"),t=>{t.exists()&&(Q=t.data()),ee()},t=>console.error("Firestore Reservas:",t));ce(K(M,oe),t=>{X=t.docs.map(e=>({id:e.id,...e.data()})),ee()},t=>console.error("Firestore Estimativas:",t));let $=new Date().toISOString().slice(0,7);const Ue=new Set;function ue(){const t=new Set,e=new Date().toISOString().slice(0,7);t.add(e);const a=new Date,o=new Date(a.getFullYear(),a.getMonth()+1,1),n=i=>String(i).padStart(2,"0"),s=`${o.getFullYear()}-${n(o.getMonth()+1)}`;return t.add(s),$&&t.add($),_.forEach(i=>{i.mesAno&&t.add(i.mesAno)}),G.forEach(i=>{i.mesAno&&t.add(i.mesAno)}),U.forEach(i=>{i.mesAno&&t.add(i.mesAno)}),V.forEach(i=>{i.mesAno&&t.add(i.mesAno)}),X.forEach(i=>{i.mesAno&&t.add(i.mesAno)}),Array.from(t).filter(i=>!Ue.has(i)).sort().reverse()}window.excluirMesSelecionadoAtual=function(){window.excluirDadosDoMes($)};window.selecionarMesGlobal=function(t){if(!t)return;$=t;const e=document.getElementById("inp-seletor-mes-global");e&&(e.value=t);const a=document.getElementById("inp-entradas-mes-ano");a&&(a.value=t);const o=document.getElementById("inp-fatura-vencimento");o&&(o.value=`${t}-10`,typeof atualizarMesRefFatura=="function"&&atualizarMesRefFatura());const n=document.getElementById("inp-boleto-vencimento");n&&(n.value=`${t}-10`,typeof atualizarMesRefBoleto=="function"&&atualizarMesRefBoleto()),ee()};window.verMesEIrParaControle=function(t){selecionarMesGlobal(t),typeof goTab=="function"&&goTab("mensal")};function pt(){const t=document.getElementById("seletor-meses-bar"),e=document.getElementById("seletor-meses-bar-salarios"),a=document.getElementById("seletor-meses-bar-estimativa"),o=ue();o.includes($)||($=o[0]||new Date().toISOString().slice(0,7));const n=document.getElementById("inp-seletor-mes-global");n&&n.value!==$&&(n.value=$);const s=document.getElementById("inp-entradas-mes-ano");s&&s.value!==$&&(s.value=$);const i=o.map(d=>{const[c,m]=d.split("-"),p=new Date(parseInt(c),parseInt(m)-1,1).toLocaleString("pt-BR",{month:"short"}).toUpperCase().replace(".",""),y=d===$;return`
    ...
    `}).join("");t&&(t.innerHTML=i),e&&(e.innerHTML=i),a&&(a.innerHTML=i)}window.switchMensalSub=function(t){document.querySelectorAll("[data-mensal-sub]").forEach(o=>o.classList.remove("active")),document.querySelectorAll(".mensal-sub-content").forEach(o=>o.style.display="none");const e=document.querySelector(`[data-mensal-sub="${t}"]`);e&&e.classList.add("active");const a=document.getElementById(t);a&&(a.style.display="block")};function ee(){pt(),ft(),vt(),Ge(),xt(),Bt(),Dt(),Ot(),zt(),Nt(),Pt(),Mt()}function vt(){const t=$,e=_.filter(h=>h.mesAno===t),a=G.filter(h=>h.mesAno===t),o=U.filter(h=>h.mesAno===t),n=V.filter(h=>h.mesAno===t),s=e.reduce((h,w)=>h+(w.valor||0),0),i=a.reduce((h,w)=>h+(w.valorTotal!==void 0?w.valorTotal:w.valor||0),0),d=o.reduce((h,w)=>h+(w.valorTotal!==void 0?w.valorTotal:w.valor||0),0);let c=0;n.forEach(h=>{h.formasPagamento&&(c+=h.formasPagamento.cartaoDebito||0)});const m=s-i-d-c,v=document.getElementById("m-total-entradas");v&&(v.textContent=l(s));const p=document.getElementById("m-total-cartoes");p&&(p.textContent=l(i));const y=document.getElementById("m-total-boletos");y&&(y.textContent=l(d));const r=document.getElementById("m-mercado-debito");r&&(r.textContent=l(c));const u=document.getElementById("m-saldo-liquido");u&&(u.textContent=l(m),u.style.color=m>=0?"#60a5fa":"#fb7185");const[g,I]=t.split("-"),S=new Date(parseInt(g),parseInt(I)-1,1).toLocaleString("pt-BR",{month:"long"}),x=S.charAt(0).toUpperCase()+S.slice(1),T=document.getElementById("m-lbl-saldo-liquido");T&&(T.textContent=`Saldo Líquido (${x}/${g})`),gt(e,a,o,n)}function gt(t,e,a,o){const n=document.getElementById("content-salarios-mes");n&&(n.innerHTML=`
      <div class="card" style="margin-bottom:1.5rem">
        <div class="card-header">
          <span class="card-title">💵 Entradas Registradas em ${$}</span>
          <span class="badge green">Total: ${l(t.reduce((c,m)=>c+(m.valor||0),0))}</span>
        </div>
    ...
    `);const s=document.getElementById("content-cartoes-mes");if(s){const c=e.reduce((v,p)=>v+(p.valorTotal||0),0),m=e.length?We(e,"mes_"+$):"";s.innerHTML=`
      ${m}
      <div class="card" style="margin-bottom:1.5rem">
        <div class="card-header">
    ...
    `}const i=document.getElementById("content-boletos-mes");if(i){const c=a.reduce((m,v)=>m+(v.valorTotal||0),0);i.innerHTML=`
      <div class="card" style="margin-bottom:1.5rem">
        <div class="card-header">
    ...
    `}const d=document.getElementById("content-mercado-mes");if(d){let c=0,m=0,v=0;o.forEach(p=>{p.formasPagamento?(c+=p.formasPagamento.valeAlimentacao||0,m+=p.formasPagamento.cartaoCredito||0,v+=p.formasPagamento.cartaoDebito||0):v+=p.valorAPagar||0}),d.innerHTML=`
      <div class="card" style="margin-bottom:1.5rem">
        <div class="card-header" style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:.5rem">
          ...
          <div style="display:flex;gap:.4rem;align-items:center;flex-wrap:wrap">
            ${c>0?`<span class="badge green">🥗 Alimentação: ${l(c)}</span>`:""}
    ...
    `}}function ft(){const t=ue();let e=0,a=0,o=0,n=0,s=0;t.forEach(r=>{const u=_.filter(x=>x.mesAno===r).reduce((x,T)=>x+(T.valor||0),0),g=G.filter(x=>x.mesAno===r).reduce((x,T)=>x+(T.valorTotal!==void 0?T.valorTotal:T.valor||0),0),I=U.filter(x=>x.mesAno===r).reduce((x,T)=>x+(T.valorTotal!==void 0?T.valorTotal:T.valor||0),0);let C=0;V.filter(x=>x.mesAno===r).forEach(x=>{x.formasPagamento&&(C+=x.formasPagamento.cartaoDebito||0)});const S=u-g-I-C;e+=u,a+=g,o+=I,n+=C,s+=S});let i=0,d=0;const c={};V.forEach(r=>{const u=r.valorAPagar||0;r.formasPagamento&&(i+=r.formasPagamento.valeAlimentacao||0,d+=r.formasPagamento.cartaoCredito||0);const g=r.mesAno||"Outros";c[g]=(c[g]||0)+u});const m=Q&&Q.valorAtualGuardado!==void 0?Q.valorAtualGuardado:3e3,v=s+m;document.getElementById("fin-total-entradas").textContent=l(e);const p=document.getElementById("fin-subtext-entradas");p&&(p.textContent="Soma Total das Entradas da Tabela Mensal"),document.getElementById("fin-total-cartoes").textContent=l(a),document.getElementById("fin-total-boletos").textContent=l(o),document.getElementById("fin-mercado-debito").textContent=l(n),document.getElementById("fin-saldo-liquido").textContent=l(s),document.getElementById("fin-saldo-liquido").style.color=s>=0?"#60a5fa":"#fb7185";const y=document.getElementById("fin-subtext-saldo");y&&(y.innerHTML=`Saldo Líquido + Reserva Guardada (${l(m)}): <strong style="color:#34d399">${l(v)}</strong>`),document.getElementById("dash-alimentacao").textContent=l(i),document.getElementById("dash-credito").textContent=l(d),document.getElementById("dash-debito").textContent=l(n),bt(),Ve(c)}function bt(){const t=document.getElementById("tabela-resumo-mensal");if(!t)return;const e=ue();if(!e.length){t.innerHTML='<div class="empty-state">Nenhum dado cadastrado ainda.</div>';return}const a=e.map(o=>{const n=_.filter(u=>u.mesAno===o).reduce((u,g)=>u+(g.valor||0),0),s=G.filter(u=>u.mesAno===o).reduce((u,g)=>u+(g.valorTotal!==void 0?g.valorTotal:g.valor||0),0),i=U.filter(u=>u.mesAno===o).reduce((u,g)=>u+(g.valorTotal!==void 0?g.valorTotal:g.valor||0),0);let d=0;V.filter(u=>u.mesAno===o).forEach(u=>{u.formasPagamento&&(d+=u.formasPagamento.cartaoDebito||0)});const c=n-s-i-d,[m,v]=o.split("-"),y=new Date(parseInt(m),parseInt(v)-1,1).toLocaleString("pt-BR",{month:"short"}).toUpperCase().replace(".","");return`
  ...
  `}window.excluirDadosDoMes=async function(t){const e=t||$;if(!e)return;const[a,o]=e.split("-"),s=new Date(parseInt(a),parseInt(o)-1,1).toLocaleString("pt-BR",{month:"long"}),i=`${s.charAt(0).toUpperCase()+s.slice(1)} de ${a}`,d=_.filter(r=>r.mesAno===e),c=G.filter(r=>r.mesAno===e),m=U.filter(r=>r.mesAno===e),v=V.filter(r=>r.mesAno===e),p=X.filter(r=>r.id===e),y=`⚠️ TEM CERTEZA QUE DESEJA EXCLUIR O MÊS ${i.toUpperCase()} (${e})?
...
Esta ação é irreversível. Confirmar exclusão do mês?`;if(confirm(y))try{const r=[];d.forEach(g=>r.push(Z(F(M,me,g.id)))),c.forEach(g=>r.push(Z(F(M,de,g.id)))),m.forEach(g=>r.push(Z(F(M,ie,g.id)))),v.forEach(g=>r.push(Z(F(M,Ee,g.id)))),p.forEach(g=>r.push(Z(F(M,oe,g.id)))),r.length>0&&await Promise.all(r),Ue.add(e),A(`🗑️ O mês ${i} e todos os seus dados foram excluídos com sucesso!`),$=ue()[0]||new Date().toISOString().slice(0,7),ee()}catch(r){alert("Erro ao excluir dados do mês: "+r.message)}};function Ve(t){var s;if(typeof Chart>"u")return setTimeout(()=>Ve(t),300);const e=(s=document.getElementById("chart-barras"))==null?void 0:s.getContext("2d");if(!e)return;const a=Object.keys(t).sort(),o=a.map(i=>{const[d,c]=i.split("-");return`${c}/${d}`}),n=a.map(i=>t[i]);Ae&&Ae.destroy(),Ae=new Chart(e,{type:"bar",data:{labels:o.length?o:["Sem compras"],datasets:[{label:"Gasto Mercado R$",data:n.length?n:[0],backgroundColor:"rgba(16,185,129,0.78)",borderColor:"#10b981",borderWidth:2,borderRadius:8}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1},tooltip:{callbacks:{label:i=>` ${l(i.raw)}`}}},scales:{y:{beginAtZero:!0,grid:{color:"rgba(255,255,255,.05)"},ticks:{color:"#94a3b8",callback:i=>"R$"+i}},x:{grid:{display:!1},ticks:{color:"#94a3b8"}}}}})}function je(t){if(!t)return 0;const e=t.match(/L[íi]quido(?:\s*a\s*receber)?\s*[:\s]*R?\$\s*([\d\.,]+)/i)||t.match(/TOTAL\s*L[IÍ]QUIDO\s*[:\s]*R?\$\s*([\d\.,]+)/i)||t.match(/SAL[ÁA]RIO\s*L[IÍ]QUIDO\s*[:\s]*R?\$\s*([\d\.,]+)/i)||t.match(/VALOR\s*L[IÍ]QUIDO\s*[:\s]*R?\$\s*([\d\.,]+)/i);return e?k(e[1]):0}function yt(){const t=document.getElementById("inp-entradas-mes-ano");if(t&&!t.value){const e=new Date,a=e.getFullYear(),o=String(e.getMonth()+1).padStart(2,"0");t.value=`${a}-${o}`}}setTimeout(yt,300);let se="mes";window.toggleFiltroEntradasTabela=function(t){se=t,Ge()};document.getElementById("form-holerite-victor").addEventListener("submit",async t=>{t.preventDefault();const e=$||document.getElementById("inp-entradas-mes-ano").value||new Date().toISOString().slice(0,7),a=document.getElementById("inp-holerite-txt-victor").value;let o=parseFloat(document.getElementById("inp-salario-val-victor").value)||0;if(!o&&a&&(o=je(a)),!o){A("⚠️ Digite ou cole um holerite válido com valor.");return}const n=`salario_victor_${e}`;await H(F(M,me,n),{pessoa:"Victor",tipo:"holerite",descricao:`Salário Líquido Victor (${e})`,valor:o,mesAno:e,data:new Date().toISOString()}),document.getElementById("inp-holerite-txt-victor").value="",document.getElementById("inp-salario-val-victor").value="",A(`✅ Salário do Victor (${e}) salvo com sucesso!`)});document.getElementById("form-holerite-maria").addEventListener("submit",async t=>{t.preventDefault();const e=$||document.getElementById("inp-entradas-mes-ano").value||new Date().toISOString().slice(0,7),a=document.getElementById("inp-holerite-txt-maria").value;let o=parseFloat(document.getElementById("inp-salario-val-maria").value)||0;if(!o&&a&&(o=je(a)),!o){A("⚠️ Digite ou cole um holerite válido com valor.");return}const n=`salario_maria_${e}`;await H(F(M,me,n),{pessoa:"Maria",tipo:"holerite",descricao:`Salário Líquido Maria (${e})`,valor:o,mesAno:e,data:new Date().toISOString()}),document.getElementById("inp-holerite-txt-maria").value="",document.getElementById("inp-salario-val-maria").value="",A(`✅ Salário da Maria (${e}) salvo com sucesso!`)});document.getElementById("form-entrada-manual").addEventListener("submit",async t=>{t.preventDefault();const e=$||document.getElementById("inp-entradas-mes-ano").value||new Date().toISOString().slice(0,7),a=document.getElementById("inp-ent-desc").value.trim(),o=parseFloat(document.getElementById("inp-ent-val").value)||0,n=document.getElementById("inp-ent-pessoa").value;!a||!o||(await he(K(M,me),{pessoa:n,tipo:"manual",descricao:a,valor:o,mesAno:e,data:new Date().toISOString()}),t.target.reset(),A(`🎉 Entrada manual (${e}) registrada!`))});function Ge(){var c,m,v;const t=$||((c=document.getElementById("inp-entradas-mes-ano"))==null?void 0:c.value)||new Date().toISOString().slice(0,7),e=document.getElementById("lbl-entradas-mes-ref");if(e){const[p,y]=t.split("-"),u=new Date(parseInt(p),parseInt(y)-1,1).toLocaleString("pt-BR",{month:"long"}),g=u.charAt(0).toUpperCase()+u.slice(1);e.textContent=`Visualizando e inserindo entradas para: ${g} de ${p}`}const a=((m=_.find(p=>p.pessoa==="Victor"&&p.tipo==="holerite"&&p.mesAno===t))==null?void 0:m.valor)||0,o=((v=_.find(p=>p.pessoa==="Maria"&&p.tipo==="holerite"&&p.mesAno===t))==null?void 0:v.valor)||0,n=_.filter(p=>p.mesAno===t),s=n.reduce((p,y)=>p+(y.valor||0),0);document.getElementById("val-salario-victor").textContent=l(a),document.getElementById("val-salario-maria").textContent=l(o),document.getElementById("val-entradas-combinado").textContent=`${l(s)}`;const i=document.getElementById("lista-entradas-registradas");if(!i)return;const d=se==="mes"?n:_;if(!d.length){i.innerHTML=`
  ...
  `}window.excluirEntrada=async function(t){confirm("Excluir esta entrada?")&&(await Z(F(M,me,t)),A("🗑️ Entrada removida."))};let Ce="Nubank",N=null;function ht(){const t=document.getElementById("inp-fatura-vencimento");if(t&&!t.value){const e=new Date,a=e.getFullYear(),o=String(e.getMonth()+1).padStart(2,"0");t.value=`${a}-${o}-10`,atualizarMesRefFatura()}}setTimeout(ht,300);window.atualizarMesRefFatura=function(){const t=document.getElementById("inp-fatura-vencimento"),e=document.getElementById("lbl-fatura-mes-ref");if(!(!t||!e))if(t.value){const[a,o]=t.value.split("-"),s=new Date(parseInt(a),parseInt(o)-1,1).toLocaleString("pt-BR",{month:"long"});e.textContent=`Fatura ${s.charAt(0).toUpperCase()+s.slice(1)}/${a}`}else e.textContent="Mês da Fatura"};window.selecionarCartaoFatura=function(t){Ce=t,document.querySelectorAll(".btn-card-select").forEach(a=>a.classList.remove("active"));const e=document.querySelector(`.btn-card-select[data-card="${t}"]`);e&&e.classList.add("active"),A(`Cartão selecionado: ${t}`)};window.handleFileFaturaSelect=async function(t){const e=t.target.files[0];if(!e)return;const a=document.getElementById("txt-file-fatura");a&&(a.textContent=`📄 Arquivo: ${e.name}`),A(`⏳ Lendo arquivo da fatura (${e.name})...`);let o="";if(e.type==="application/pdf"||e.name.endsWith(".pdf"))o=await He(e);else try{o=await e.text()}catch{o=""}o?(document.getElementById("inp-fatura-txt").value=o,await Qe(o,Ce)):A("❌ Não foi possível ler o texto do arquivo da fatura.")};async function He(t){try{const e=await t.arrayBuffer();if(typeof pdfjsLib>"u")return A("⚠️ Aguarde a biblioteca de PDF carregar..."),"";pdfjsLib.GlobalWorkerOptions.workerSrc="https://cdnjs.cloudflare.com/ajax/libs/pdf.js/3.11.174/pdf.worker.min.js";let a=pdfjsLib.getDocument({data:e});a.onPassword=(s,i)=>{let d=prompt(`🔒 Este PDF de fatura está protegido por senha.
Digite a senha para abrir (ex: CPF ou Data de Nascimento):`);d?s(d):A("⚠️ Senha não informada. Leitura do PDF cancelada.")};const o=await a.promise;let n="";for(let s=1;s<=o.numPages;s++){const d=await(await o.getPage(s)).getTextContent();let c=null,m="";for(const v of d.items){if(!v.str)continue;const p=v.transform?v.transform[5]:null;c!==null&&Math.abs(p-c)>3?m+=`
`:m.length>0&&!m.endsWith(`
`)&&!m.endsWith(" ")&&(m+=" "),m+=v.str,c=p}n+=m+`
`}return n}catch(e){return e.name==="PasswordException"?A("🔒 O PDF precisa de senha válida para ser aberto."):console.error("Erro ao ler PDF:",e),""}}function Et(t){if(!t)return null;const e=t.match(/Total\s*a\s*Pagar\s*[:\s]*R?\$\s*([\d\.,]+)/i)||t.match(/no\s*valor\s*de\s*R?\$\s*([\d\.,]+)/i)||t.match(/Valor\s*total\s*da\s*fatura\s*[:\s]*R?\$\s*([\d\.,]+)/i)||t.match(/Total\s*da\s*fatura\s*[:\s]*R?\$\s*([\d\.,]+)/i);if(e){const a=k(e[1]);if(a>0)return a}return null}function $t(t){if(!t)return null;const e=t.match(/Vencimento\s*[:\s]*(\d{2}[\/\.-]\d{2}[\/\.-]\d{4})/i)||t.match(/Data\s*de\s*vencimento\s*[:\s]*(\d{2})\s+([A-Za-z]{3})\s+(\d{4})/i)||t.match(/FATURA\s+(\d{2})\s+([A-Za-z]{3})\s+(\d{4})/i);if(e){if(e[2]&&e[3]){const a=e[1],o=e[2].toUpperCase(),n=e[3],i={JAN:"01",FEB:"02",MAR:"03",ABR:"04",APR:"04",MAI:"05",MAY:"05",JUN:"06",JUL:"07",AGO:"08",AUG:"08",SET:"09",SEP:"09",OUT:"10",OCT:"10",NOV:"11",DEZ:"12",DEC:"12"}[o]||"07";return`${n}-${i}-${a.padStart(2,"0")}`}else if(e[1]){const[a,o,n]=e[1].split(/[\/\.-]/);return`${n}-${o.padStart(2,"0")}-${a.padStart(2,"0")}`}}return null}window.importarFaturaManualOuArquivo=async function(){const t=document.getElementById("inp-fatura-txt").value.trim();if(!t){A("⚠️ Selecione o arquivo da fatura (.pdf, .csv) ou cole o texto da fatura.");return}await Qe(t,Ce)};async function Qe(t,e){const a=$t(t);a&&(document.getElementById("inp-fatura-vencimento").value=a,atualizarMesRefFatura());const o=Et(t),n=At(t),s=document.getElementById("inp-fatura-vencimento").value||new Date().toISOString().slice(0,10),i=s.slice(0,7),d=n.reduce((y,r)=>y+r.valor,0),c=o||d||0,m=e?`Cartão ${e}`:"Fatura Cartão";N={cartao:e||"Nubank",descricao:m,dataVencimento:s,mesAno:i,valorTotal:c,qtdItens:n.length,itens:n};const v=document.getElementById("inp-revisao-fatura-desc");v&&(v.value=m);const p=document.getElementById("inp-revisao-fatura-val");p&&(p.value=c?c.toFixed(2):""),_e(),n.length>0?A(`✅ ${n.length} compras encontradas! Fatura total: ${l(c)}.`):A("ℹ️ Fatura pronta para revisão. Confirme o valor total e o cartão abaixo.")}window.atualizarValorTotalRevisaoFatura=function(){var e;if(!N)return;const t=parseFloat((e=document.getElementById("inp-revisao-fatura-val"))==null?void 0:e.value)||0;N.valorTotal=t,document.getElementById("badge-total-preview-fatura").textContent=l(t)};function _e(){if(!N)return;const{valorTotal:t,itens:e,cartao:a,descricao:o}=N;document.getElementById("badge-total-preview-fatura").textContent=l(t);const n=document.getElementById("inp-revisao-fatura-desc");n&&(!n.value||n.value==="Fatura Cartão")&&(n.value=o||`Cartão ${a||"Nubank"}`);const s=document.getElementById("inp-revisao-fatura-val");s&&(!s.value||parseFloat(s.value)===0)&&(s.value=t?t.toFixed(2):"");const i=document.getElementById("lista-preview-fatura-itens");!e||!e.length?i.innerHTML='<div class="empty-state">Nenhum item individual extraído. O valor total acima será considerado.</div>':i.innerHTML=e.map((c,m)=>`
...
`).forEach(n=>{const s=n.trim();if(!s||/EMISS[ÃA]O|TRANSA[ÇC][ÕO]ES|RESUMO|PAGAMENTO DE FATURA|TOTAL DA FATURA|FATURA ANTERIOR|SALDO ANTERIOR|LIMITE DISPON[ÍI]VEL|OPÇÕES DE PAGAMENTO|ALTERNATIVAS DE PAGAMENTO|PAGAMENTO E DEMAIS|PARCELAMENTOS|DESPESAS|HISTÓRICO DE FATURAS|SUPERCRÉDITO|SAQUE À CRÉDITO|COMPRA DATA DESCRIÇÃO/i.test(s))return;const i=/(?:[@\)\(\*•\s]+)?(\d{2}[\/\.-]\d{2}(?:[\/\.-]\d{2,4})?|\d{2}\s+[A-Za-z]{3})\s+(.+?)\s+(?:(\d{2}\/\d{2})\s+)?(-?R?\$\s*[\d\.]+,\d{2}|-?[\d\.]+,\d{2})$/i,d=s.match(i)||s.match(/(?:[@\)\(\*•\s]+)?(\d{2}[\/\.-]\d{2}(?:[\/\.-]\d{2,4})?|\d{2}\s+[A-Za-z]{3})\s+(.+?)\s+(?:(\d{2}\/\d{2})\s+)?(-?R?\$\s*[\d\.]+,\d{2}|-?[\d\.]+,\d{2})/i);if(d){const c=d[1];let m=d[2].trim();const v=d[3],p=d[4];if(p.includes("-")||/DEB AUTOM|PAGAMENTO|PAGTO|CR[ÉE]DITO FATURA/i.test(m))return;const y=k(p);v&&(m+=` (${v})`),m&&y>0&&m.length>2&&!/fatura|limite|pagamento|saldo|alternativas|opções|período|emissão|vencimento/i.test(m)&&e.push({dataCompra:c,descricao:m,valor:y})}}),e.length===0){let n;for(;(n=a.exec(t))!==null;){const s=n[1];let i=n[2].trim();const d=n[3],c=n[4];if(c.includes("-")||/DEB AUTOM|PAGAMENTO|PAGTO|CR[ÉE]DITO FATURA/i.test(i))continue;const m=k(c);d&&(i+=` (${d})`),i&&m>0&&i.length>2&&!/fatura|limite|pagamento|saldo|alternativas|opções|período|emissão|vencimento/i.test(i)&&e.push({dataCompra:s,descricao:i,valor:m})}}return e}window.ultimosLocaisAnalisados={};function Ze(t){if(!t)return"DIVERSOS";let e=t.replace(/\(\d{1,2}\/\d{1,2}\)/gi,"").replace(/\b\d{1,2}\/\d{1,2}\b/gi,"").replace(/\b\d{1,2}x\b/gi,"").trim();return e=e.replace(/\s+/g," "),e.toUpperCase()}function Ye(t){const e={};(Array.isArray(t)?t:[t]).forEach(n=>{!n||!n.itens||!Array.isArray(n.itens)||n.itens.forEach(s=>{if(!s.descricao||!s.valor)return;const i=Ze(s.descricao);e[i]||(e[i]={nome:i,qtd:0,valorTotal:0,compras:[]}),e[i].qtd+=1,e[i].valorTotal+=s.valor||0,e[i].compras.push({dataCompra:s.dataCompra||"—",descricao:s.descricao,valor:s.valor||0,cartao:n.cartao||"Cartão",mesAno:n.mesAno||"—"})})});const o=Object.values(e).filter(n=>n.qtd>=2);return o.sort((n,s)=>s.valorTotal-n.valorTotal),o}function We(t,e="geral"){const a=Ye(t);if(a.forEach(n=>{window.ultimosLocaisAnalisados[`${e}_${n.nome}`]=n}),!a.length)return`
      ...
      <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap:1rem; margin-top:1rem">
        ...
        <div style="background:rgba(15,23,42,0.6); border:1px solid var(--border-color); border-radius:10px; padding:.85rem 1rem">
          ...
          <div style="display:flex; flex-direction:column; gap:.6rem">
            ${n.map((r,u)=>{const g=a>0?(r.valorTotal/a*100).toFixed(1):0;return`
                <div style="display:flex; justify-content:space-between; align-items:center; background:rgba(30,41,59,0.7); border-radius:6px; padding:.5rem .75rem">
                  <div style="display:flex; align-items:center; gap:.5rem">
                    <span style="font-size:1rem; font-weight:700">${u===0?"🥇":u===1?"🥈":u===2?"🥉":`#${u+1}`}</span>
                    <div>
        ...
        <div style="background:rgba(15,23,42,0.6); border:1px solid var(--border-color); border-radius:10px; padding:.85rem 1rem">
          ...
          <div style="display:flex; flex-direction:column; gap:.6rem">
            ${i.map(r=>{const u=a>0?(r.valorTotal/a*100).toFixed(1):0;return`
                <div>
                  <div style="display:flex; justify-content:space-between; align-items:center; font-size:.83rem; margin-bottom:.2rem">
                    ...
                    <strong style="color:#f8fafc">${l(r.valorTotal)} <span style="font-size:.72rem; color:var(--text-muted)">(${u}%)</span></strong>
                  </div>
                  <div class="progress-bar-bg" style="height:6px; border-radius:3px; background:rgba(255,255,255,0.08); overflow:hidden">
                    <div class="progress-bar-fill" style="width:${u}%; height:100%; background:var(--accent-purple); border-radius:3px"></div>
                  </div>
                </div>
              `}).join("")}
          </div>
  ...
  `}function xt(){const t=G.reduce((d,c)=>d+(c.valorTotal!==void 0?c.valorTotal:c.valor||0),0);document.getElementById("badge-total-cartoes").textContent=`${l(t)} total`;const e=document.getElementById("lista-faturas-registradas");if(!G.length){e.innerHTML='<div class="empty-state">Nenhuma fatura cadastrada ainda.</div>';return}const a=It(G),o=We(G,"geral"),n={};G.forEach(d=>{const c=d.mesAno||"Outros";n[c]||(n[c]=[]),n[c].push(d)});const i=Object.keys(n).sort((d,c)=>c.localeCompare(d)).map((d,c)=>{const m=n[d],v=m.reduce((r,u)=>r+(u.valorTotal!==void 0?u.valorTotal:u.valor||0),0);let p=d;if(d!=="Outros"&&d.includes("-")){const[r,u]=d.split("-"),I=new Date(parseInt(r),parseInt(u)-1,1).toLocaleString("pt-BR",{month:"long"});p=`${I.charAt(0).toUpperCase()+I.slice(1)} de ${r}`}const y=c===0;return`
      <div class="card" style="margin-bottom:1.25rem;background:rgba(15,23,42,0.45);border:1px solid var(--border-color)">
        ...
        <div id="fat-group-${d}" class="purchase-details ${y?"open":""}" style="padding:.75rem 1rem;display:${y?"block":"none"}">
          ${m.map(r=>{var h;const u=r.valorTotal!==void 0?r.valorTotal:r.valor||0,g=r.cartao||"Cartão",I=g.toLowerCase().includes("nubank"),C=I?"purple":"red",S=I?"🟣":"🔴",x=r.dataVencimento?fe(r.dataVencimento).split(",")[0]:"—",T=r.mesAno||"—";return`
              <div class="purchase-card" style="margin-bottom:1rem">
                <div class="purchase-header" onclick="toggleDetail('fat-${r.id}')">
                  <div class="purchase-info">
                    <h3><span class="badge ${C}">${S} ${g}</span> — Vencimento: ${x}</h3>
                    <p>📅 Mês Referência: <strong>${T}</strong> &nbsp;•&nbsp; 🛒 ${r.qtdItens||((h=r.itens)==null?void 0:h.length)||1} itens contemplados</p>
                  </div>
                  <div class="purchase-values" style="display:flex;align-items:center;gap:.75rem">
                    <div style="text-align:right">
                      <div class="pv-total" style="color:#fb7185">${l(u)}</div>
    ...
    `}).join("");e.innerHTML=a+o+i}function Je(t){if(t.itens&&t.itens.length>0){const e=Ye([t]),a=`fatura_${t.id}`;e.forEach(n=>{window.ultimosLocaisAnalisados[`${a}_${n.nome}`]=n});let o="";return e.length>0&&(o=`
    ...
    `).join("");const o=document.getElementById("box-revisao-boleto");o.style.display="block",o.scrollIntoView({behavior:"smooth"})}window.removerItemRevisaoBoleto=function(t){if(!P||!P.itens)return;P.itens.splice(t,1);const e=P.itens.reduce((a,o)=>a+o.valor,0);e>0&&(P.valorTotal=e,document.getElementById("inp-revisao-boleto-val").value=e.toFixed(2)),P.qtdItens=P.itens.length,Xe(),A("🗑️ Item removido da revisão do boleto.")};window.confirmarEGravarBoletoDocumento=async function(){if(!P)return;const t=document.getElementById("inp-revisao-boleto-desc").value.trim(),e=parseFloat(document.getElementById("inp-revisao-boleto-val").value)||0,a=document.getElementById("inp-boleto-vencimento").value||new Date().toISOString().slice(0,10);if(!e){A("⚠️ Digite ou confirme o valor total do boleto.");return}P.descricao=t||"Boleto / Conta",P.valorTotal=e,P.dataVencimento=a,P.mesAno=a.slice(0,7);try{await he(K(M,ie),{...P,createdAt:xe()}),document.getElementById("box-revisao-boleto").style.display="none",document.getElementById("inp-boleto-txt").value="";const o=document.getElementById("txt-file-boleto");o&&(o.textContent="Clique para Selecionar o Arquivo do Boleto");const n=l(P.valorTotal);P=null,A(`🎉 Boleto de ${n} salvo com sucesso!`)}catch(o){alert("Erro ao salvar boleto: "+o.message)}};function wt(t){if(!t)return{beneficiario:"",valorTotal:0,vencimento:null,itens:[]};let e="",a=0,o=null;const n=[],s=t.match(/Vencimento\s*[:\s]*(\d{2}[\/\.-]\d{2}[\/\.-]\d{4})/i)||t.match(/Vencimento\s*[:\s]*(\d{2})\s+([A-Za-z]{3})\s+(\d{4})/i)||t.match(/Data\s*de\s*Vencimento\s*[:\s]*(\d{2}[\/\.-]\d{2}[\/\.-]\d{4})/i);if(s){if(s[2]&&s[3]){const m=s[1],v=s[2].toUpperCase();o=`${s[3]}-${{JAN:"01",FEB:"02",MAR:"03",ABR:"04",APR:"04",MAI:"05",MAY:"05",JUN:"06",JUL:"07",AGO:"08",AUG:"08",SET:"09",SEP:"09",OUT:"10",OCT:"10",NOV:"11",DEZ:"12",DEC:"12"}[v]||"07"}-${m.padStart(2,"0")}`}else if(s[1]){const[m,v,p]=s[1].split(/[\/\.-]/);o=`${p}-${v.padStart(2,"0")}-${m.padStart(2,"0")}`}}const i=t.match(/Benefici[áa]rio\s*[:\s]*([^\n\r]+)/i)||t.match(/Nome\s*do\s*Cedente\s*[:\s]*([^\n\r]+)/i)||t.match(/Raz[ãa]o\s*Social\s*[:\s]*([^\n\r]+)/i);i&&(e=i[1].trim().replace(/\s{2,}/g," "));const d=t.match(/Valor\s*do\s*Documento\s*[:\s]*R?\$\s*([\d\.]+,\d{2})/i)||t.match(/\(=\)\s*Valor\s*Cobrado\s*[:\s]*R?\$\s*([\d\.]+,\d{2})/i)||t.match(/Valor\s*Cobrado\s*[:\s]*R?\$\s*([\d\.]+,\d{2})/i)||t.match(/Valor\s*R?\$\s*([\d\.]+,\d{2})/i);return d&&(a=k(d[1])),t.split(`
`).forEach(m=>{const v=m.trim();if(!v||/vencimento|beneficiário|cedente|nosso\s*número|agência|código|autenticação|instruções/i.test(v))return;const p=v.match(/(\d{2}[\/\.-]\d{2}(?:[\/\.-]\d{2,4})?|\b[A-Za-z]{3}\b)?\s*(.+?)\s+R?\$\s*([\d\.]+,\d{2})$/i);if(p){const y=p[1]||"Boleto",r=p[2].trim(),u=k(p[3]);r&&u>0&&r.length>2&&!/valor|total|documento|cobrado/i.test(r)&&n.push({dataBoleto:y,descricao:r,valor:u})}}),{beneficiario:e,valorTotal:a,vencimento:o,itens:n}}function Tt(t){const e=document.getElementById("container-analise-boletos-recorrentes");if(!e)return;if(!t||!t.length){e.innerHTML="";return}const a={};t.forEach(r=>{const u=le(r);a[u]||(a[u]={nome:u,valorTotalAno:0,qtd:0,historicoMeses:{}});const g=r.valorTotal!==void 0?r.valorTotal:r.valor||0;a[u].valorTotalAno+=g,a[u].qtd+=1;const I=r.mesAno||"Outros";a[u].historicoMeses[I]=(a[u].historicoMeses[I]||0)+g});const o=Object.values(a).sort((r,u)=>u.valorTotalAno-r.valorTotalAno),n=Array.from(new Set(t.map(r=>r.mesAno||"Outros"))).sort((r,u)=>u.localeCompare(r)),s=n[0],i=n[1];function d(r){if(!r||!r.includes("-"))return r;const[u,g]=r.split("-"),C=new Date(parseInt(u),parseInt(g)-1,1).toLocaleString("pt-BR",{month:"long"});return`${C.charAt(0).toUpperCase()+C.slice(1)}/${u}`}const c=d(s),m=d(i),v=[];s&&i&&o.forEach(r=>{const u=r.historicoMeses[s],g=r.historicoMeses[i];if(u!==void 0&&g!==void 0){const I=u-g;if(I>5){const C=(I/g*100).toFixed(1);v.push({nome:r.nome,valAtual:u,valAnterior:g,dif:I,pct:C})}}}),v.sort((r,u)=>u.dif-r.dif);const p=t.reduce((r,u)=>r+(u.valorTotal!==void 0?u.valorTotal:u.valor||0),0);let y="";s&&i&&(v.length>0?y=`
        <div style="margin-top:1rem; background:rgba(251,113,133,0.08); border:1px dashed rgba(251,113,133,0.35); border-radius:10px; padding:.85rem 1rem">
          <div style="font-weight:700; font-size:.9rem; color:#fb7185; margin-bottom:.5rem; display:flex; align-items:center; gap:.4rem">
            ⚠️ ALERTAS DE AUMENTO DE PREÇO (${c} vs ${m}):
          </div>
          <div style="display:flex; flex-direction:column; gap:.5rem">
            ${v.map(r=>`
      ...
      `:y=`
        <div style="margin-top:1rem; background:rgba(16,185,129,0.08); border:1px dashed rgba(16,185,129,0.35); border-radius:10px; padding:.85rem 1rem">
          <div style="font-weight:700; font-size:.88rem; color:#34d399">
            🟢 Nenhum boleto recorrente teve aumento de preço entre ${m} e ${c}. Todos os valores mantiveram-se estáveis!
          </div>
        </div>
      `),e.innerHTML=`
    <div class="card" style="margin-bottom:1.5rem; background:linear-gradient(135deg,rgba(30,41,59,.98),rgba(15,23,42,.99)); border-color:#c084fc; box-shadow:0 4px 22px rgba(192,132,252,0.18)">
      ...
      <div style="display:grid; grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); gap:.85rem; margin-top:.75rem">
        ${o.map(r=>{const u=r.qtd>0?r.valorTotalAno/r.qtd:0;let g='<span class="badge gray" style="font-size:.72rem">Único registro</span>';if(s&&i){const I=r.historicoMeses[s],C=r.historicoMeses[i];if(I!==void 0&&C!==void 0){const S=I-C;if(S>0){const x=(S/C*100).toFixed(1);g=`<span class="badge rose" style="font-size:.75rem" title="Subiu ${l(S)} em relação a ${m}">📈 +${l(S)} (+${x}%)</span>`}else if(S<0){const x=(Math.abs(S)/C*100).toFixed(1);g=`<span class="badge green" style="font-size:.75rem" title="Caiu ${l(Math.abs(S))} em relação a ${m}">📉 ${l(S)} (-${x}%)</span>`}else g='<span class="badge purple" style="font-size:.75rem">🟢 R$ 0,00 (Estável)</span>'}}return`
            <div style="background:rgba(15,23,42,0.75); border:1px solid var(--border-color); border-radius:10px; padding:.85rem 1rem; display:flex; justify-content:space-between; align-items:center">
              <div>
                ...
                <div style="font-size:.75rem; color:var(--text-muted)">
                  Média: <strong>${l(u)}/mês</strong> &nbsp;•&nbsp; ${r.qtd} boleto${r.qtd>1?"s":""}
                </div>
  ...
  `}function Bt(){const t=U.reduce((n,s)=>n+(s.valorTotal!==void 0?s.valorTotal:s.valor||0),0);document.getElementById("badge-total-boletos").textContent=`${l(t)} total`,Tt(U);const e=document.getElementById("lista-boletos-registrados");if(!U.length){e.innerHTML='<div class="empty-state">Nenhum boleto cadastrado ainda.</div>';return}const a={};U.forEach(n=>{const s=n.mesAno||"Outros";a[s]||(a[s]=[]),a[s].push(n)});const o=Object.keys(a).sort((n,s)=>s.localeCompare(n));e.innerHTML=o.map((n,s)=>{const i=a[n];i.sort((v,p)=>{const y=v.dataVencimento?new Date(v.dataVencimento).getTime():0;return(p.dataVencimento?new Date(p.dataVencimento).getTime():0)-y});const d=i.reduce((v,p)=>v+(p.valorTotal!==void 0?p.valorTotal:p.valor||0),0);let c=n;if(n!=="Outros"&&n.includes("-")){const[v,p]=n.split("-"),r=new Date(parseInt(v),parseInt(p)-1,1).toLocaleString("pt-BR",{month:"long"});c=`${r.charAt(0).toUpperCase()+r.slice(1)} de ${v}`}const m=s===0;return`
      <div class="card" style="margin-bottom:1.25rem;background:rgba(15,23,42,0.45);border:1px solid var(--border-color)">
        <div class="card-header" style="cursor:pointer;user-select:none;display:flex;justify-content:space-between;align-items:center" onclick="toggleGroupMonth('bol-group-${n}')">
          <span class="card-title" style="font-size:1.05rem">📄 Boletos de ${c}</span>
          <div style="display:flex;align-items:center;gap:.75rem">
        ...
        <div id="bol-group-${n}" class="purchase-details ${m?"open":""}" style="padding:.75rem 1rem;display:${m?"block":"none"}">
          ${i.map(v=>{var g;const p=v.valorTotal!==void 0?v.valorTotal:v.valor||0,y=v.dataVencimento?fe(v.dataVencimento).split(",")[0]:"—",r=v.mesAno||"—",u=le(v);return`
              <div class="purchase-card" style="margin-bottom:1rem">
                <div class="purchase-header" onclick="toggleDetail('bol-${v.id}')">
                  <div class="purchase-info">
                    <h3><span class="badge purple">📄 ${u}</span> — Vencimento: ${y}</h3>
...
Este boleto será removido permanentemente de todos os meses, resumos e relatórios do sistema.`)&&(await Z(F(M,ie,t)),A("🗑️ Boleto removido de todo o sistema com sucesso."))};document.getElementById("form-config-reservas").addEventListener("submit",async t=>{t.preventDefault();const e=parseFloat(document.getElementById("inp-meta-anual").value)||0,a=parseFloat(document.getElementById("inp-saldo-guardado").value)||0;Q.metaAnual=e,Q.valorAtualGuardado=a,await H(F(M,Pe,"config"),{metaAnual:e,valorAtualGuardado:a,dataAtualizacao:new Date().toISOString()}),A("✅ Reservas e configurações de economias salvas!"),ee()});function Mt(){const t=Q&&Q.metaAnual!==void 0?Q.metaAnual:15e3,e=Q&&Q.valorAtualGuardado!==void 0?Q.valorAtualGuardado:3e3,a=document.getElementById("inp-meta-anual");a&&document.activeElement!==a&&(a.value=t);const o=document.getElementById("inp-saldo-guardado");o&&document.activeElement!==o&&(o.value=e);const s=new Date().getMonth()+1,i=Math.max(1,12-s+1),d=Math.max(0,t-e),c=d>0?d/i:0;document.getElementById("val-meta-reserva").textContent=l(c);const m=document.getElementById("subtext-meta-reserva");m&&(m.textContent=`Faltam ${l(d)} p/ Meta Anual de ${l(t)} (${i} mês(es) até o fim do ano)`),document.getElementById("val-real-guardado").textContent=l(e);const v=ue();let p=0,y=0,r=0,u=0;v.forEach(B=>{const f=_.filter(D=>D.mesAno===B).reduce((D,L)=>D+(L.valor||0),0),b=G.filter(D=>D.mesAno===B).reduce((D,L)=>D+(L.valorTotal!==void 0?L.valorTotal:L.valor||0),0),E=U.filter(D=>D.mesAno===B).reduce((D,L)=>D+(L.valorTotal!==void 0?L.valorTotal:L.valor||0),0);let R=0;V.filter(D=>D.mesAno===B).forEach(D=>{D.formasPagamento&&(R+=D.formasPagamento.cartaoDebito||0)}),p+=f,y+=b,r+=E,u+=R});const g=y+r+u,I=p-g,C=Math.max(1,v.length),S=p/C,x=g/C,T=I/C,h=T>0?T:0,w=h*i,O=e+w;document.getElementById("val-recomendacao-reserva").textContent=l(O);const j=document.getElementById("subtext-recomendacao");if(j)if(O>=t)j.innerHTML=`✅ Projeção de <strong style="color:#34d399">${l(O)}</strong> até Dez/2026 supera sua Meta Anual de ${l(t)}!`;else{const B=t-O;j.innerHTML=`⚠️ Sobra média de ${l(h)}/mês. Projeção de ${l(O)} fica <strong style="color:#fb7185">${l(B)}</strong> abaixo da Meta de ${l(t)}.`}const z=document.getElementById("box-analise-reserva-detalhes");if(z)if(p===0)z.innerHTML='<p class="empty-state">Cadastre seus salários e entradas na aba "Salários & Entradas" para gerar o diagnóstico inteligente de economias.</p>';else{const B=t>0?Math.min(100,e/t*100).toFixed(1):0,f=O>=t;let b="";if(f)b=`
        ...
        `;else if(T>0){const E=Math.max(0,c-T);b=`
          <div style="background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.35);border-radius:8px;padding:.85rem 1rem;margin-top:.85rem">
            ...
            <p style="font-size:.85rem;color:#f1f5f9;margin-top:.35rem;line-height:1.45">
              ...
              Para alcançar a sua Meta de <strong>${l(t)}</strong> (faltam ${l(d)}), é necessário guardar <strong style="color:#fb7185">${l(c)}/mês</strong> nos próximos ${i} meses (um incremento de <strong>${l(E)}/mês</strong> em relação à sua média).
            </p>
          </div>
        `}else b=`
          <div style="background:rgba(251,113,133,0.12);border:1px solid rgba(251,113,133,0.35);border-radius:8px;padding:.85rem 1rem;margin-top:.85rem">
            ...
            <p style="font-size:.85rem;color:#f1f5f9;margin-top:.35rem;line-height:1.45">
              ...
              A projeção do sistema prevê apenas a manutenção dos <strong style="color:#34d399">${l(e)}</strong> já guardados. Para atingir sua Meta Anual de <strong>${l(t)}</strong> (faltam <strong>${l(d)}</strong>), você precisará guardar <strong style="color:#fb7185">${l(c)}/mês</strong> nos próximos ${i} mês(es).
            </p>
          </div>
        `;z.innerHTML=`
        ...
        ${b}
      `}St()}function St(){const t=document.getElementById("container-analise-mensal-lista");if(!t)return;const e=ue();if(!e.length){t.innerHTML='<div class="empty-state">Nenhum mês registrado para gerar a análise mensal.</div>';return}const a=e.map(o=>{const s=_.filter(h=>h.mesAno===o).reduce((h,w)=>h+(w.valor||0),0),i=G.filter(h=>h.mesAno===o),d=i.reduce((h,w)=>h+(w.valorTotal!==void 0?w.valorTotal:w.valor||0),0),c=U.filter(h=>h.mesAno===o),m=c.reduce((h,w)=>h+(w.valorTotal!==void 0?w.valorTotal:w.valor||0),0),v=V.filter(h=>h.mesAno===o);let p=0;v.forEach(h=>{h.formasPagamento&&(p+=h.formasPagamento.cartaoDebito||0)});const y=d+m+p,r=s-y,u=r>=0,[g,I]=o.split("-"),S=new Date(parseInt(g),parseInt(I)-1,1).toLocaleString("pt-BR",{month:"long"}),x=S.charAt(0).toUpperCase()+S.slice(1);let T="";if(u){const h=r*.5;T=`
      ...
      `}else{const h=Math.abs(r);let w="Cartão de Crédito",O=d;m>O&&(w="Boletos & Contas",O=m),p>O&&(w="Mercado no Débito",O=p);const j=y>0?(O/y*100).toFixed(1):0;let z="",B=0;i.forEach(f=>{const b=f.valorTotal!==void 0?f.valorTotal:f.valor||0;b>B&&(B=b,z=`Fatura do ${f.cartao||"Cartão"}`)}),c.forEach(f=>{const b=f.valorTotal!==void 0?f.valorTotal:f.valor||0;b>B&&(B=b,z=`Boleto ${f.descricao||"de Conta"}`)}),T=`
      ...
      `}return`
      <div class="card" style="margin-bottom:1.25rem; border-color:${u?"rgba(52,211,153,0.3)":"rgba(251,113,133,0.4)"}">
        <div class="card-header" style="flex-wrap:wrap; gap:.5rem">
          <div style="display:flex; align-items:center; gap:.5rem">
            <span class="card-title" style="font-size:1rem; color:#f8fafc">📅 ${x} de ${g}</span>
            <span class="badge ${u?"green":"red"}">${u?"🟢 Superávit":"🔴 Déficit"}</span>
          </div>
        ...
        <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(160px, 1fr)); gap:.75rem; margin-top:.5rem">
          ...
          <div style="background:rgba(15,23,42,0.8); padding:.6rem .8rem; border-radius:8px; border:1px solid ${u?"#34d399":"#fb7185"}">
            <div style="font-size:.75rem; color:var(--text-muted)">Saldo Líquido no Mês</div>
            <div style="font-weight:800; font-size:1.05rem; color:${u?"#60a5fa":"#fb7185"}">${l(r)}</div>
          </div>
        </div>
  ...
  `}const be=[{id:"est_1",nome:"Corte de Cabelo Victor",quantidade:2,valorUnitario:70},{id:"est_2",nome:"Compra Programada Tunico",quantidade:1,valorUnitario:150},{id:"est_3",nome:"Sobrancelha Maria",quantidade:1,valorUnitario:50},{id:"est_4",nome:"Unha Maria",quantidade:1,valorUnitario:90},{id:"est_5",nome:"Banho Tunico",quantidade:1,valorUnitario:65},{id:"est_6",nome:"Saída Simples",quantidade:2,valorUnitario:100},{id:"est_7",nome:"Saída Premiun",quantidade:1,valorUnitario:150},{id:"est_8",nome:"Saída Premiun Plus",quantidade:1,valorUnitario:200},{id:"est_9",nome:"Mercado Pontual",quantidade:4,valorUnitario:70},{id:"est_10",nome:"Farmacia",quantidade:2,valorUnitario:35},{id:"est_11",nome:"Padaria 3D",quantidade:10,valorUnitario:10}];window.abrirModalAddEstimativa=function(t=null){const e=document.getElementById("modal-add-estimativa");if(e){if(document.getElementById("inp-est-id").value=t||"",t){document.getElementById("titulo-modal-estimativa").textContent="✏️ Editar Gastos Previsto";const a=X.find(n=>n.id===$),o=((a==null?void 0:a.itens)||[]).find(n=>n.id===t);o&&(document.getElementById("inp-est-nome").value=o.nome||"",document.getElementById("inp-est-qtd").value=o.quantidade||1,document.getElementById("inp-est-val").value=o.valorUnitario||0)}else document.getElementById("titulo-modal-estimativa").textContent="➕ Adicionar Gastos Previsto",document.getElementById("inp-est-nome").value="",document.getElementById("inp-est-qtd").value=1,document.getElementById("inp-est-val").value="";e.classList.add("active")}};window.fecharModalAddEstimativa=function(){var t;(t=document.getElementById("modal-add-estimativa"))==null||t.classList.remove("active")};var Re;(Re=document.getElementById("form-item-estimativa"))==null||Re.addEventListener("submit",async t=>{t.preventDefault();const e=document.getElementById("inp-est-id").value,a=document.getElementById("inp-est-nome").value.trim(),o=parseFloat(document.getElementById("inp-est-qtd").value)||1,n=parseFloat(document.getElementById("inp-est-val").value)||0;if(!a){alert("Preencha a descrição do gasto.");return}const s=X.find(d=>d.id===$);let i=s?[...s.itens||[]]:[...be];e?i=i.map(d=>d.id===e?{...d,nome:a,quantidade:o,valorUnitario:n}:d):i.push({id:"est_"+Date.now(),nome:a,quantidade:o,valorUnitario:n}),await H(F(M,oe,$),{mesAno:$,itens:i,ultimaAtualizacao:new Date().toISOString()}),fecharModalAddEstimativa(),A("✅ Estimativa atualizada!")});window.atualizarQtdItemEstimativa=async function(t,e){const a=X.find(s=>s.id===$);if(!a)return;const o=Math.max(1,parseInt(e)||1),n=(a.itens||[]).map(s=>s.id===t?{...s,quantidade:o}:s);await H(F(M,oe,$),{mesAno:$,itens:n,ultimaAtualizacao:new Date().toISOString()})};window.atualizarValorItemEstimativa=async function(t,e){const a=X.find(s=>s.id===$);if(!a)return;const o=Math.max(0,parseFloat(e)||0),n=(a.itens||[]).map(s=>s.id===t?{...s,valorUnitario:o}:s);await H(F(M,oe,$),{mesAno:$,itens:n,ultimaAtualizacao:new Date().toISOString()})};window.excluirItemEstimativa=async function(t){if(!confirm("Remover este item da estimativa do mês?"))return;const e=X.find(o=>o.id===$);if(!e)return;const a=(e.itens||[]).filter(o=>o.id!==t);await H(F(M,oe,$),{mesAno:$,itens:a,ultimaAtualizacao:new Date().toISOString()}),A("🗑️ Item removido da estimativa.")};window.resetarItensEstimativaPadrao=async function(){confirm(`Deseja carregar/resetar os 11 itens padrão de previsão para ${$}?`)&&(await H(F(M,oe,$),{mesAno:$,itens:be,ultimaAtualizacao:new Date().toISOString()}),A("🔄 Itens padrão de estimativa carregados!"))};function Dt(){const t=document.getElementById("container-lista-estimativa");if(!t)return;const e=X.find(r=>r.id===$);let a=[];e&&Array.isArray(e.itens)?a=e.itens:(a=be,H(F(M,oe,$),{mesAno:$,itens:be,ultimaAtualizacao:new Date().toISOString()}).catch(r=>console.error("Auto init estimativa error:",r)));let o=0;a.forEach(r=>{o+=(r.quantidade||0)*(r.valorUnitario||0)});const n=document.getElementById("val-total-estimativa-mes");n&&(n.textContent=l(o));const[s,i]=$.split("-"),c=new Date(parseInt(s),parseInt(i)-1,1).toLocaleString("pt-BR",{month:"long"}),m=c.charAt(0).toUpperCase()+c.slice(1),v=document.getElementById("subtext-estimativa-mes");v&&(v.textContent=`Total previsto para ${m} de ${s} (${a.length} itens cadastrados)`);const p=document.getElementById("badge-count-estimativa");if(p&&(p.textContent=`${a.length} itens previstos`),!a.length){t.innerHTML=`
    ...
    <div class="table-responsive">
      <table class="custom-table">
        ...
        <tbody>
          ${a.map(r=>{const u=(r.quantidade||0)*(r.valorUnitario||0);return`
              <tr>
                <td>
                ...
                <td class="num">
                  <strong style="color:#a5b4fc">${l(u)}</strong>
                </td>
  ...
  `;t.innerHTML=y}function Ot(){const t=document.getElementById("lista-mensal-container");if(!t)return;const e=new Date,a=new Date(e.getFullYear(),e.getMonth()+1,1),o=a.toLocaleString("pt-BR",{month:"long"}),n=a.getFullYear(),s=`${o.charAt(0).toUpperCase()+o.slice(1)} de ${n}`,i=ut(a.getFullYear(),a.getMonth()),d=31.8,c=20,m=i*d,v=i*c,p={};let y=0;V.forEach(f=>{const b=f.valorAPagar||0;y+=b;const E=f.mesAno||"Outros";p[E]=(p[E]||0)+b});const r=Math.max(1,Object.keys(p).length),u=y/r,g={};V.forEach(f=>{(f.itens||[]).forEach(b=>{const E=(b.nome||"").toLowerCase().trim();E&&(g[E]||(g[E]={nome:b.nome,marca:b.marca||"Geral",qtdTotal:0,frequenciaNotas:0,valoresUnitarios:[]}),g[E].qtdTotal+=b.quantidade||1,g[E].frequenciaNotas+=1,b.valorUnitario&&g[E].valoresUnitarios.push(b.valorUnitario))})});const I=Object.values(g).map(f=>{const b=f.valoresUnitarios.length>0?f.valoresUnitarios.reduce((W,te)=>W+te,0)/f.valoresUnitarios.length:0,E=f.qtdTotal/r,R=r/Math.max(1,f.frequenciaNotas),D=f.frequenciaNotas/r;let L=0;D>=.35||E>=.7?L=Math.ceil(E):L=Math.round(E),L<1&&f.frequenciaNotas>=r&&(L=1);const Y=L*b;return{nome:f.nome,marca:f.marca,frequenciaNotas:f.frequenciaNotas,intervaloMeses:R,qtdMensalTaxa:E,totalEstimadoUnidades:L,valorUnitario:b,subtotalCalculado:Y}}).filter(f=>f.totalEstimadoUnidades>0);I.sort((f,b)=>b.frequenciaNotas-f.frequenciaNotas);const C=I.reduce((f,b)=>f+b.subtotalCalculado,0),S=u>0?u*1.05:C;let x=1;C>S&&u>0&&(x=S/C);const T=I.map(f=>({...f,subtotalFinal:f.subtotalCalculado*x})),h=u>0?Math.min(C,S):C;let w=h;const O=Math.min(w,m);w-=O;const j=Math.min(w,v);w-=j;const z=w>0?w:0;let B=`
    <div class="card" style="margin-bottom:1.5rem; background: linear-gradient(135deg, rgba(30,41,59,0.9), rgba(15,23,42,0.95)); border: 1px solid #3b82f6;">
      ...
      <div style="margin-top:1.25rem; padding-top:1rem; border-top:1px solid var(--border-color); display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:0.5rem;">
        <div>
          ...
          <p style="font-size:0.75rem; color:#60a5fa;">Média Histórica de Gastos: ${l(u)}</p>
        </div>
  ...
  `;window.dadosListaMensalCache={mesAnoStr:s,diasUteis:i,totalGeralEstimado:h,cobertoAlim:O,cobertoCred:j,cobertoDeb:z,alimDisponivel:m,credDisponivel:v,lista:T},T.length===0?B+='<div class="empty-state">Adicione notas fiscais para que o sistema gere automaticamente sua lista mensal de compras.</div></div>':B+=`
      <div class="table-responsive">
        <table class="custom-table">
          <thead>
            <tr>
  ...
  `;d.document.open(),d.document.write(c),d.document.close()};document.getElementById("btn-start-cam").addEventListener("click",tt);document.getElementById("btn-switch-cam").addEventListener("click",Lt);document.getElementById("btn-stop-cam").addEventListener("click",we);async function tt(){if(typeof Html5Qrcode>"u")return q("Carregando biblioteca de câmera, aguarde..."),setTimeout(tt,600);try{ae||(ae=new Html5Qrcode("qr-reader")),J=await Html5Qrcode.getCameras();let t;if(J&&J.length>0){const e=J.findIndex(a=>/back|traseira|rear|environment/i.test(a.label));ve=e>=0?e:0,t=J[ve].id}else t={facingMode:"environment"};await ae.start(t,{fps:10,qrbox:{width:240,height:240}},at,()=>{}),ge=!0,document.getElementById("btn-start-cam").style.display="none",document.getElementById("btn-switch-cam").style.display=J.length>1?"inline-flex":"none",document.getElementById("btn-stop-cam").style.display="inline-flex"}catch(t){q("❌ Não foi possível acessar a câmera. Verifique as permissões do navegador."),console.error(t)}}async function Lt(){if(!(!ae||!ge))try{await ae.stop(),J.length>1&&(ve=(ve+1)%J.length,await ae.start(J[ve].id,{fps:10,qrbox:{width:240,height:240}},at,()=>{}))}catch(t){console.error("switchCam:",t)}}async function we(){if(ae&&ge)try{await ae.stop()}catch{}ge=!1,document.getElementById("btn-start-cam").style.display="inline-flex",document.getElementById("btn-switch-cam").style.display="none",document.getElementById("btn-stop-cam").style.display="none"}function Te(t){if(!t)return"";const e=String(t).trim(),a=e.match(/chNFe=([0-9\s%20]{44,65})/i);if(a){const i=decodeURIComponent(a[1]).replace(/\D/g,"");if(i.length===44)return i}const o=e.match(/[?&]p=([0-9]{44})/i)||e.match(/[?&]p=([0-9]{44})\|/i);if(o)return o[1];const n=e.match(/\b\d{44}\b/);if(n)return n[0];const s=e.replace(/\D/g,"");return s.length===44?s:s.length>44?s.slice(0,44):""}function $e(t){return t?t.replace(/\D/g,"").slice(0,44).replace(/(\d{4})(?=\d)/g,"$1 ").trim():""}async function at(t){we();const e=Te(t),a=e?$e(e):t,o=document.getElementById("inp-nfce-chave");if(o&&(o.value=a),e){q(`✅ QR Code lido com sucesso! NFC-e: ${a}`);const n=`https://www.nfce.fazenda.sp.gov.br/NFCeConsultaPublica/Paginas/ConsultaPublica.aspx?chNFe=${a}`;await ye(n,e)}else q("✅ QR Code lido! Consultando..."),await ye(t)}document.getElementById("btn-carregar-dados").addEventListener("click",async()=>{var a;const t=(((a=document.getElementById("inp-nfce-chave"))==null?void 0:a.value)||"").trim();if(!t){q("⚠️ Digite o número da NFC-e (44 dígitos) ou escaneie o QR Code.");return}if(t.includes("<")&&t.includes(">")||t.length>200&&/Vl\.\s*Unit|Qtde|Emiss/i.test(t)){q("⏳ Processando conteúdo copiado..."),await Be(t);return}const e=Te(t);if(e&&e.length===44){const o=$e(e);document.getElementById("inp-nfce-chave").value=o;const n=`https://www.nfce.fazenda.sp.gov.br/NFCeConsultaPublica/Paginas/ConsultaPublica.aspx?chNFe=${o}`;q(`⏳ Consultando NFC-e na SEFAZ: ${o}...`),await ye(n,e);return}if(t.startsWith("http://")||t.startsWith("https://")){q("⏳ Consultando link da nota..."),await ye(t);return}q("⚠️ Número da NFC-e inválido. A chave deve conter 44 dígitos numéricos.","#fb7185")});var Fe;(Fe=document.getElementById("inp-nfce-chave"))==null||Fe.addEventListener("input",t=>{const e=t.target.value;if(e.startsWith("http")||e.includes("<")||e.includes("="))return;const a=e.replace(/\D/g,"").slice(0,44);a.length>0&&a.length<=44&&(t.target.value=$e(a))});document.getElementById("btn-preencher-manual").addEventListener("click",()=>{ot({nomeMercado:"",dataEmissao:new Date().toISOString(),valorTotal:0,descontoTotal:0,valorAPagar:0,qtdTotalItens:0,formasPagamento:{valeAlimentacao:0,cartaoCredito:0,cartaoDebito:0},itens:[]}),q("✍️ Preencha os dados da compra abaixo e clique em Salvar Nota Fiscal.","var(--accent-cyan)")});function ot(t){var s,i,d;document.getElementById("inp-mercado").value=t.nomeMercado||"",document.getElementById("inp-data").value=mt(t.dataEmissao),document.getElementById("inp-vtotal").value=t.valorTotal!==void 0?t.valorTotal:0,document.getElementById("inp-desconto").value=t.descontoTotal!==void 0?t.descontoTotal:0,document.getElementById("inp-pagar").value=t.valorAPagar!==void 0?t.valorAPagar:0,document.getElementById("inp-qtd").value=t.qtdTotalItens!==void 0?t.qtdTotalItens:0,document.getElementById("inp-alim").value=((s=t.formasPagamento)==null?void 0:s.valeAlimentacao)||0,document.getElementById("inp-cred").value=((i=t.formasPagamento)==null?void 0:i.cartaoCredito)||0,document.getElementById("inp-deb").value=((d=t.formasPagamento)==null?void 0:d.cartaoDebito)||0,re=t.itens||[];const e=document.getElementById("form-nfce");e.style.display="block";const a=document.getElementById("preview-itens-box"),o=document.getElementById("count-preview-itens"),n=document.getElementById("lista-preview-itens");re.length>0?(a.style.display="block",o.textContent=re.length,n.innerHTML=re.map(c=>`
    ...
    `).join("")):a.style.display="none",e.scrollIntoView({behavior:"smooth"})}document.getElementById("form-nfce").addEventListener("submit",async t=>{t.preventDefault();const e=document.getElementById("inp-mercado").value.trim()||"Mercado",a=document.getElementById("inp-data").value||new Date().toISOString(),o=parseFloat(document.getElementById("inp-vtotal").value)||0,n=parseFloat(document.getElementById("inp-desconto").value)||0,s=parseFloat(document.getElementById("inp-pagar").value)||0,i=parseInt(document.getElementById("inp-qtd").value)||0,d=parseFloat(document.getElementById("inp-alim").value)||0,c=parseFloat(document.getElementById("inp-cred").value)||0,m=parseFloat(document.getElementById("inp-deb").value)||0,v=new Date(a).toISOString().slice(0,16),p=V.find(u=>{const g=new Date(u.dataEmissao).toISOString().slice(0,16),I=Math.abs((u.valorAPagar||0)-s)<.05,C=(u.nomeMercado||"").toLowerCase().trim()===e.toLowerCase().trim();return g===v&&I&&C});if(p){q(`⚠️ Esta nota fiscal já existe no sistema (Cadastrada em ${fe(p.dataEmissao)} no valor de ${l(p.valorAPagar)}). Nota não adicionada!`,"#fb7185"),A("⚠️ Nota fiscal já cadastrada! Operação cancelada.");return}const y=new Date(a),r=`${y.getFullYear()}-${String(y.getMonth()+1).padStart(2,"0")}`;q("⏳ Salvando nota fiscal no banco...");try{await he(K(M,Ee),{nomeMercado:e,dataEmissao:a,mesAno:r,qtdTotalItens:i||re.length,valorTotal:o,descontoTotal:n,valorAPagar:s,formasPagamento:{valeAlimentacao:d,cartaoCredito:c,cartaoDebito:m},itens:re,createdAt:xe()}),q("✅ Nota salva com sucesso!","#34d399"),document.getElementById("form-nfce").style.display="none",document.getElementById("form-nfce").reset();const u=document.getElementById("inp-nfce-chave");u&&(u.value=""),re=[],qe(),goTab("dashboard"),A("🎉 Nota fiscal registrada no Firebase!")}catch(u){q("❌ Erro ao salvar: "+u.message,"#fb7185")}});async function ye(t,e){q("⏳ Consultando dados da nota na SEFAZ...");const a=e||Te(t),o=a?$e(a):"",n=a?`https://www.nfce.fazenda.sp.gov.br/NFCeConsultaPublica/Paginas/ConsultaPublica.aspx?chNFe=${o}`:t,s=a?`https://www.nfce.fazenda.sp.gov.br/NFCeConsultaPublica/Paginas/ConsultaPublica.aspx?chNFe=${a}`:t,i=[n,s];i.includes(t)||i.push(t);const d=[c=>`https://api.allorigins.win/raw?url=${encodeURIComponent(c)}`,c=>`https://corsproxy.io/?${encodeURIComponent(c)}`,c=>`https://api.codetabs.com/v1/proxy?quest=${encodeURIComponent(c)}`];for(const c of i)for(const m of d)try{const v=await fetch(m(c),{signal:AbortSignal.timeout(6e3)});if(v.ok){const p=await v.text();if(p&&p.length>200&&(/Vl\.\s*Unit|valorUnitario|Qtde|txtTit|itemNota/i.test(p)||/Valor\s*total/i.test(p))){await Be(p);return}}}catch{}Rt(n,o||a)}function Rt(t,e){const a=document.getElementById("modal-cors-url-display");a&&(a.textContent=t);const o=document.getElementById("modal-link");o&&(o.href=t);const n=document.getElementById("btn-modal-copiar-chave");n&&(n.onclick=()=>{e&&(navigator.clipboard.writeText(e),A("📋 Número da NFC-e copiado para a área de transferência!"))});const s=document.getElementById("modal-cors-textarea");s&&(s.value="");const i=document.getElementById("btn-modal-processar-colado");i&&(i.onclick=async()=>{var c,m;const d=(m=(c=document.getElementById("modal-cors-textarea"))==null?void 0:c.value)==null?void 0:m.trim();if(!d){A("⚠️ Cole o texto da página da SEFAZ no campo antes de processar.");return}document.getElementById("modal-cors").classList.remove("active"),await Be(d)}),document.getElementById("modal-cors").classList.add("active"),q("⚠️ A SEFAZ exige consulta externa. Clique no botão para abrir, copie o conteúdo e cole na caixa de texto.","var(--accent-amber)")}async function Be(t){const e=Ft(t);ot(e),q("✅ Nota lida com sucesso! Confira os valores abaixo e altere se necessário antes de Salvar.","#34d399")}function Ft(t){var O,j,z;const a=new DOMParser().parseFromString(t,"text/html"),o=((O=a.body)==null?void 0:O.textContent)||t;let n=((z=(j=a.querySelector(".txtTopo, .nomeEmit, h1, #lblNomeFantasia, #lblRazaoSocial"))==null?void 0:j.textContent)==null?void 0:z.trim())||"";if(!n){const B=o.match(/(?:Raz[ãa]o\s*Social|Nome\s*Fantasia|Emitente)\s*[:\-]?\s*([^\n\r]+)/i);B&&(n=B[1].trim())}n||(n="Mercado");let s=new Date().toISOString();const i=o.match(/Emiss[ãa]o\s*[:\-]?\s*(\d{2}\/\d{2}\/\d{4})\s+(\d{2}:\d{2}:\d{2})?/i)||o.match(/(\d{2}\/\d{2}\/\d{4})\s+(\d{2}:\d{2}:\d{2})/);if(i){const[B,f,b]=i[1].split("/");s=`${b}-${f}-${B}T${i[2]||"12:00:00"}`}const d=o.match(/Qtd\.?\s*total\s*de\s*itens\s*[:\s]*([\d,\.]+)/i),c=o.match(/Valor\s*total\s*R\$\s*[:\s]*([\d\.,]+)/i),m=o.match(/Descontos?\s*R\$\s*[:\s]*([\d\.,]+)/i),v=o.match(/Valor\s*a\s*pagar\s*R\$\s*[:\s]*([\d\.,]+)/i)||o.match(/VALOR\s*PAGO\s*R\$\s*[:\s]*([\d\.,]+)/i),p=o.match(/(?:Vale\s*)?Alimenta[çc][ãa]o\s*[:\s]*([\d\.,]+)/i),y=o.match(/(?:Cart[ãa]o\s*de\s*)?Cr[eé]dito\s*[:\s]*([\d\.,]+)/i),r=o.match(/(?:Cart[ãa]o\s*de\s*)?D[eé]bito\s*[:\s]*([\d\.,]+)/i),u=d?k(d[1]):0,g=c?k(c[1]):0,I=m?k(m[1]):0;let C=v?k(v[1]):g-I;const S={valeAlimentacao:p?k(p[1]):0,cartaoCredito:y?k(y[1]):0,cartaoDebito:r?k(r[1]):0},x=[];if(a.querySelectorAll("tr, .item, .itemNota").forEach(B=>{var Me;const f=B.textContent;if(!/Vl\.\s*Unit|valorUnitario|Qtde?\./i.test(f))return;const b=B.querySelector(".txtTit, .txtTit2, .nomeProd"),E=((Me=b==null?void 0:b.textContent)==null?void 0:Me.trim())||"",R=f.match(/Qtde?\.\s*[:\s]*([\d,\.]+)/i),D=f.match(/Vl\.\s*Unit\.\s*[:\s]*([\d,\.]+)/i),L=f.match(/Vl\.\s*Total\s*([\d,\.]+)/i),Y=f.match(/C[oó]digo\s*[:\s]*(\d+)/i),W=f.match(/UN\s*[:\s]*([A-Za-z]+)/i),te=R?k(R[1]):1,ne=D?k(D[1]):0,pe=L?k(L[1]):ne*te;E&&ne>0&&x.push({codigo:(Y==null?void 0:Y[1])||"",nome:E,marca:Se(E),quantidade:te,unidade:(W==null?void 0:W[1])||"Un",valorUnitario:ne,valorTotal:pe})}),x.length===0){const B=o.split(/\r?\n/).map(f=>f.trim()).filter(Boolean);for(let f=0;f<B.length;f++){const b=B[f];if(/Qtde?\.?|Vl\.\s*Unit/i.test(b)){let E="";f>0&&B[f-1].length>2&&!/Qtde?|Vl\.|Total|Emiss|CNPJ/i.test(B[f-1])?E=B[f-1]:E=b.split(/Qtde?|Vl\./i)[0].trim();const R=b.match(/Qtde?\.\s*[:\s]*([\d,\.]+)/i),D=b.match(/Vl\.\s*Unit\.\s*[:\s]*([\d,\.]+)/i),L=b.match(/Vl\.\s*Total\s*([\d,\.]+)/i),Y=b.match(/C[oó]digo\s*[:\s]*(\d+)/i)||(f>0?B[f-1].match(/C[oó]digo\s*[:\s]*(\d+)/i):null),W=b.match(/UN\s*[:\s]*([A-Za-z]+)/i),te=R?k(R[1]):1,ne=D?k(D[1]):0,pe=L?k(L[1]):ne*te;E&&(ne>0||pe>0)&&x.push({codigo:(Y==null?void 0:Y[1])||"",nome:E.replace(/^\d+[\s\-\.]*/,"").trim(),marca:Se(E),quantidade:te,unidade:(W==null?void 0:W[1])||"Un",valorUnitario:ne||pe/te,valorTotal:pe})}}}const h=new Date(s),w=`${h.getFullYear()}-${String(h.getMonth()+1).padStart(2,"0")}`;return{nomeMercado:n,dataEmissao:s,mesAno:w,qtdTotalItens:u,valorTotal:g,descontoTotal:I,valorAPagar:C,formasPagamento:S,itens:x}}function Se(t){const e=["BAUDUCCO","BAUD","PANCO","DANONE","NESTLE","QUALITA","SADIA","PERDIGAO","SEARA","CAMIL","TIO JOAO","URBANO","LIZA","SOYA","YPE","PILAO","MELITTA","3 CORACOES","VIGOR","PARMALAT","ITALAC","HEINZ","KRAFT"],a=t.toUpperCase();for(const o of e)if(a.includes(o))return o;return a.split(" ")[0]||"Genérica"}function zt(){const t=document.getElementById("lista-historico");if(!V.length){t.innerHTML='<div class="empty-state">📭 Nenhuma compra cadastrada ainda.</div>';return}t.innerHTML=V.map(e=>{var a,o,n;return`
    ...
    <tbody>${a.map(o=>{const n=Object.keys(o.hist).sort();let s=n.map(d=>`${d}: <strong>${l(o.hist[d])}</strong>`).join(" → "),i='<span class="badge cyan">Estável</span>';if(n.length>=2){const d=o.hist[n[n.length-2]],m=o.hist[n[n.length-1]]-d,v=(m/d*100).toFixed(1);m>.01?i=`<span class="badge red">+${v}% ↑</span>`:m<-.01&&(i=`<span class="badge green">${v}% ↓</span>`)}return`<tr><td><strong>${o.nome}</strong></td><td><span class="badge amber">${o.marca||"—"}</span></td><td>${s}</td><td>${i}</td></tr>`}).join("")}</tbody>
  </table></div>`}function Pt(){const t=document.getElementById("lista-recorrencia"),e=document.getElementById("lista-marcas"),a={},o={};V.forEach(i=>{(i.itens||[]).forEach(d=>{var p;const c=(p=d.nome)==null?void 0:p.toLowerCase().trim();if(!c)return;a[c]||(a[c]={nome:d.nome,marca:d.marca,qtd:0,notas:0,units:[]}),a[c].qtd+=d.quantidade||1,a[c].notas+=1,a[c].units.push(d.valorUnitario||0);const m=(d.nome||"").split(" ")[0].toUpperCase();o[m]||(o[m]={});const v=d.marca||"Genérica";o[m][v]||(o[m][v]=[]),o[m][v].push(d.valorUnitario||0)})});const n=Object.values(a).filter(i=>i.notas>1).sort((i,d)=>d.notas-i.notas);t.innerHTML=n.length?`<div class="table-responsive"><table class="custom-table">
        <thead><tr><th>Item</th><th>Marca</th><th>Compras</th><th class="num">Qtd Total</th><th class="num">Média Unitária</th></tr></thead>
        <tbody>${n.map(i=>{const d=i.units.reduce((c,m)=>c+m,0)/i.units.length;return`<tr>
      ...
      </table></div>`:'<div class="empty-state">Adicione notas para ver a recorrência de itens.</div>';const s=Object.entries(o).filter(([,i])=>Object.keys(i).length>1).map(([i,d])=>{let c=1/0,m="";const v=Object.entries(d).map(([p,y])=>{const r=y.reduce((u,g)=>u+g,0)/y.length;return r<c&&(c=r,m=p),{marca:p,med:r}});return`<div class="brand-card">
      <div class="brand-card-header">
        <span class="card-title">${i}</span>
        <span class="badge green">🏆 Menor preço: ${m} (${l(c)}/un)</span>
      </div>
