      ...
      <div class="card" style="margin-bottom:1.5rem">
        ...
        ${e.length?e.map(m=>`
              <div class="purchase-card" style="margin-bottom:1rem">
                <div class="purchase-header" onclick="toggleDetail('fat-m-${m.id}')">
                  ...
                  <div class="purchase-values" style="display:flex;align-items:center;gap:.75rem">
                    <div style="text-align:right">
                      ...
                      <div class="pv-sub">Clique para ver itens <span class="chevron" id="chev-fat-m-${m.id}">▼</span></div>
                    </div>
                ...
                <div id="detail-fat-m-${m.id}" class="purchase-details">
      ...
      <div class="card" style="margin-bottom:1.5rem">
        ...
        ${o.length?o.map(i=>`
              <div class="purchase-card" style="margin-bottom:1rem">
                <div class="purchase-header" onclick="toggleDetail('bol-m-${i.id}')">
                  ...
                  <div class="purchase-values" style="display:flex;align-items:center;gap:.75rem">
                    <div style="text-align:right">
                      ...
                      <div class="pv-sub">Clique para ver detalhes <span class="chevron" id="chev-bol-m-${i.id}">▼</span></div>
                    </div>
                ...
                <div id="detail-bol-m-${i.id}" class="purchase-details">
                  <div class="details-toolbar">
